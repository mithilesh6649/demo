...
class PagesClientSeedernew extends Seeder
{
    /**
   ...
   public function run()
    {
        ...
        \DB::table('pages')->insert([
            [
                ...
                <div class="countent_from_admin_separator" style="display:none">&nbsp;</div>
                <a href="https://genahealthx.com/services#section1"
                ...
                <a href="https://genahealthx.com/app-download"
                class="btn btn-primary-gradient py-sm-3 px-4 px-sm-5 rounded-pill me-3 animated slideInLeft">Explore
                the App</a>
                <div class="countent_from_admin_separator" style="display:none">&nbsp;</div>
            ...
            [
                ...
                <a href="https://genahealthx.com/services" class="btn btn-primary-gradient mt-3 py-sm-3 px-4 px-sm-5 rounded-pill me-3 animated slideInLeft">Select a plan</a>
