                    ...
                    <div class="order_details">
                        <div class="card-main pt-3">
                            ...
                            <div class="card-body main_body form p-3">
                                ...
                                @endif
                                <form id="addRecipeForm" method="post" action="{{ route('recipe.save') }}"
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                                <div class="form-group">
                                                    <label>Recipe Category<span class="text-danger">
                                                    *</span></label>
                                                    <select class="form-control catselect" id="select"
                                                    name="recipe_category_id">
                                                    <option value="">Select Recipe Category</option>
                                                    @foreach ($allActiveCategories as $allActiveCategory)
                                                    <option value="{{ $allActiveCategory->id }}">
                                                        {{ $allActiveCategory->title }}
                                                    </option>
                                                    @endforeach
                                                </select>
                                                <label id="mkd"></label>
                                    ...
                                    <div class="col-md-12 col-lg-12 col-xl-12 col-12 mb-3">
                                        ...
                                        *</span></label>
                                        <textarea name="description" rows="1" style="width: 100%;border:1px solid #ced4da;"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                    <div class="form-group"> <label>Timing ( in min )<span
                                        class="text-danger">
                                    *</span></label>
                                    <input type="number" name="timing" class="form-control"
                                    id="timing" maxlength="100">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                <div class="form-group"> <label>Kilocalorie<span class="text-danger">
                                *</span></label>
                                <input type="number" name="kilocalorie" class="form-control"
                                id="kilocalorie" maxlength="100">
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                            <div class="form-group"> <label>Serving ( Each person)<span
                                class="text-danger">
                            *</span></label>
                            <input type="number" name="serving" class="form-control"
                            id="serving" maxlength="100">
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                        <div class="form-group"> <label>Tags<span class="text-danger">
                        *</span></label>
                    ...
                    <div class="row">
                        <div class="col-10">
                            <div class="form-group">
                                ...
                                autocomplete="nope"
                                dyanmic_msg="Ingredients  is required">
                            </div>
                        </div>
                        <div class="col-md-2">
                ...
                <div class="row">
                    <div class="col-10">
                        <div class="form-group">
                            ...
                            autocomplete="nope"
                            dyanmic_msg="Instructions  is required">
                        </div>
                    </div>
                    <div class="col-md-2">
   ...
   error.appendTo($('#mkd'));
    ...
    error.insertAfter(element);
     ...
     //empty_input_field_check
            ...
            var container = document.getElementById('addRecipeForm');
