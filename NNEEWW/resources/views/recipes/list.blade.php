                    ...
                    <div class="order_details">
                        <div class="card-main pt-3">
                            <div class="order_heading alert d-flex align-items-center justify-content-between mb-4">
                                ...
                                href="{{ route('recipe.add') }}">Add Recipe  </a>
                                @endcan
                                ...
                                <table style="width:100%" id="pages-list" class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            @if (Gate::check('view_recipe') || Gate::check('edit_recipe') || Gate::check('delete_recipe'))
                                            <th>Actions</th>
                                           @endif
                                        </tr>
                                    </thead>
                                    <tbody>
                                        @foreach ($recipes as $RecipeCategory)
                                            <tr>
                                                <td class="display-none"></td>
                                                  <td>{{@$RecipeCategory->RecipeCategory->title}}</td>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="action-button" title="View"
                                                        href="{{ route('recipe.view', ['id' => $RecipeCategory->id]) }}"><i
                                                            class="text-success fa fa-eye"></i></a>
                                                     @endcan
                                                        
                                                   @can('edit_recipe')
                                                       
                                                   <a href="{{ route('recipe.edit', ['id' => $RecipeCategory->id]) }}"
