                ...
                <div class="order_details">
                    <div class="card-main pt-3">
                        <div class="order_heading alert d-flex align-items-center justify-content-between mb-4">
                            <h3 class="mb-0">Edit Recipe Category</h3>
                        ...
                        <div class="card-body main_body form p-3">
                            ...
                            action="{{ route('recipe.update') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="card-body">
                                ...
                                <div class="information_fields mb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                            <div class="form-group">
                                                <label>Recipe Category <span class="text-danger"> *</span></label>
                                                <select   class="form-control catselect" id="select" name="recipe_category_id">
                                    ...
                                    <div class="col-md-12 col-lg-12 col-xl-12 col-12 mb-3">
                                        <div class="form-group"> <label>Description <span class="text-danger"> *</span></label>
                                            <textarea   name="description" rows="1" style="width: 100%;border:1px solid #ced4da;height: auto;">{{$data->description ?? '--'}}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                        <div class="form-group"> <label>Timing ( in min )<span class="text-danger"> *</span></label>
                                            <input type="number" name="timing" class="form-control"
                                            id="timing" maxlength="100" value="{{$data->time ?? '--'}}"  >
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                        <div class="form-group"> <label>Kilocalorie <span class="text-danger"> *</span></label>
                                            <input type="number" name="kilocalorie" class="form-control"
                                            id="kilocalorie" maxlength="100" value="{{$data->kilocalorie ?? '--'}}" > 
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                        <div class="form-group"> <label>Serving ( each person)<span class="text-danger"> *</span></label>
                                            <input type="number" name="serving" class="form-control"
                                            id="serving" maxlength="100" value="{{$data->serving ?? '--'}}"  >
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                        <div class="form-group"> <label>Tags<span class="text-danger"> *</span></label>
                                            <input type="tag" name="tags" class="form-control"
                                            id="tags"   value="{{$data->tags}}" >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-6 col-6">
                                        <div class="form-group">
                                            ...
                                            <div class="upload-img" style="position:relative; margin-top:10px;">
                                                <a href="javascript:;"
                                                class="remove-pro-img d-none {{ $data->image != null ? '' : 'd-none' }} "
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                <div class="form-group">
                                    <label>Ingredients<span class="text-danger">
                                    *</span></label>
                                        ...
                                        <div class="row">
                                            <div class="col-10">
                                                <div class="form-group">
                                                    ...
                                                    class="form-control empty_input_field_check"
                                                    id="ingredients" maxlength="100"
                                                    autocomplete="nope"
                                                    dyanmic_msg="Ingredients  is required" value="{{$k ?? ''}}">
                                                </div>
                                            </div>
                                            <div class="col-md-2">
                                    ...
                                    <div class="alert alert-warning ingredients_warning  d-none" role="alert"
                                    style="width: fit-content">
                                    Ingredients is required !
                                </div>

                                <button type="button" class="btn btn-danger"
                                id="ingredients_btn">Add Ingredients</button>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                            <div class="form-group">
                                <label>Instructions (Step By Step )<span class="text-danger">
                                *</span></label>
                                <div id="instructions-parent">
                                    @foreach(json_decode($data->instructions)  as $data) 
                                    <div class="row">
                                        <div class="col-10">
                                            <div class="form-group">
                                                ...
                                                autocomplete="nope"
                                                dyanmic_msg="Instructions  is required" value="{{$data ?? ''}}">
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                ...
                                <div class="alert alert-warning instructions_warning  d-none" role="alert"
                                style="width: fit-content">
                                Instructions is required !
                            </div>

                            <button type="button" class="btn btn-warning"
                            id="instructions_btn">Add Instructions</button>
                        </div>
                    </div>
 ...
 <script>
    ...
    // }
            ...
            messages: {
                ...
                kilocalorie: {
                    required: "Kilocalorie is required"
                },
                serving: {
  ...
  if(element.attr("name") == "recipe_category_id") {
   ...
   error.appendTo($('#mkd'));
    ...
    error.insertAfter(element);
     ...
     //alert(form); 
     //empty_input_field_check

             var ingredientsLength = $('input[name ="ingredients[]"]').length;
             if (ingredientsLength == 0) {
                $('.ingredients_warning').removeClass('d-none');
                setTimeout(() => {
                    $('.ingredients_warning').addClass('d-none');
                    $('#ingredients_btn').trigger('click');
                }, 800);
                return false;
            }


            var instructionsLength = $('input[name ="instructions[]"]').length;
            if (instructionsLength == 0) {
                $('.instructions_warning').removeClass('d-none');
                setTimeout(() => {
                    $('.instructions_warning').addClass('d-none');
                    $('#instructions_btn').trigger('click');
                }, 800);
                return false;
            }

            var empty_input_field_check = $('.empty_input_field_check');
            $(empty_input_field_check).each(function() {
                var dymanic_error_msg = $(this).attr('dyanmic_msg');
                if ($(this).val().trim() == '') {
                    $(this).next().remove();
                    $("<span class='text-danger compare'>" + dymanic_error_msg + "</span>")
                    .insertAfter(this);
                }
            });
            ...
            var container = document.getElementById('EditRecipeForm');
...
<script type="text/javascript">
    ...
    //Remove Input Field
    $(document).on('click', '.deleteInstructionsAddtional,.deleteIngredientsAddtional', function() {
