...
@section('title', ' Diet Subscription Features Details')
                ...
                <div class="order_details">
                    <div class="card-main pt-3">
                        <div class="order_heading alert d-flex align-items-center justify-content-between mb-4">
                            <h3 class="mb-0">  Diet Subscription Features Details</h3>
                                     ...
                                     <input type="hidden" name="feature_id" value="{{ $data->id }}">
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-12 mb-1 ">
                                            <div class="form-group ">
                                                ...
                                                <select disabled class="form-control" id="featur_type" name="type">
                                        ...
                                        <div class="col-md-12 {{$data->type == 3 ? '':'d-none' }}" id="checkbox_div">
                                            <div class="d-flex align-items-center col-md-12 mb-1">
                                                <input readonly type="checkbox" name="is_test" class="w-auto mr-2"
                                        ...
                                        <div class="col-md-12  {{$data->is_genetic_test == 1 ? '':'d-none' }}" id="plan_duration_div">
                                            <div class="row">
                                                <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                                    <div class="form-group"> <label>Genetic Test </label>
                                            ...
                                            <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                                ...
                                                maxlength="2"  value="{{$data->other_test_count }}"  readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-12 mb-3">
                                            ...
                                            <textarea readonly id="description"  @if($data->is_genetic_test) name="description" @else  @endif>{{$data->name  }}</textarea>
                                        </div>
                                    </div>
