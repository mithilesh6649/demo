...
@section('title', 'Add Diet Subscription Features')
                ...
                <div class="order_details">
                    <div class="card-main pt-3">
                        <div class="order_heading alert d-flex align-items-center justify-content-between mb-4">
                            <h3 class="mb-0">Add Diet Subscription Features</h3>
                        ...
                        <div class="card-body main_body form p-3">
                            ...
                            action="{{ route('diet.subscription.feature.save') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                @if ($errors->any())
                                ...
                                <div class="information_fields mb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 d-none" id="checkbox_div">
                                        ...
                                        <div class="col-md-12 d-none" id="plan_duration_div">
                                            <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12 col-xl-12 col-12 mb-3" id="title_box">
