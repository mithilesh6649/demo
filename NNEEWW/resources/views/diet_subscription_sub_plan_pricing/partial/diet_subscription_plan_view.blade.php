   ...
   <div class="information_fields mb-0">
    ...
    <input type="hidden"  name="id" value="{{$data->id}}">
         ...
         <div class="form-group ">
            <label for="status">Select Diet Subscription Plan </label>
            <select disabled class="form-control" id="select" name="diet_plan_subscription_id">
      ...
      <div class="col-sm-6  ">
         <div class="form-group">
            ...
            <input readonly type="text" name="amount" class="form-control"
      ...
      <div class="col-md-12 col-lg-12 col-xl-12 col-12 mb-3">
         ...
         <div class="d-flex align-items-center">
            <label class="mb-0">Is Discount</label><input disabled type="checkbox"
