...
@section('title', 'Edit Faq Mobile Content')
                                    ...
                                    <form id="editContentForm" method="post" action="{{ route('mobile_pages_faq_update') }}">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <textarea id="content" name="content">{{ $Faq->answer }}</textarea>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card-footer">
                                            <button type="submit" id="update_mobile_page" class="btn btn-primary">Update</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
