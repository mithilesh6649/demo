                        ...
                        <div class="order_details">
                            <div class="card-main pt-3">
                                ...
                                <div class="card-body main_body form p-3">
                                    ...
                                    @endif
                                    <form id="editUserForm" method="post" action="{{ route('media-section.update') }}"
                                                ...
                                                <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-12">
                                                    <div class="profile-image-show mt-3">
                                                        <a href="javascript:;"
                                                            ...
                                                            id="{{ $data->id ?? '' }}" style="display:block">
                                                        ...
                                                        <img src="{{ $data->image }}"
                                                            class="{{ $data->image != null ? '' : 'd-none' }}" width="80%"
                                                            id="profileImage">

                                                        <div class="thumb_nails {{ $data->image != null ? 'd-none' : '' }}">
                                                            <svg width="60" height="55" viewBox="0 0 512 470" fill="none"
                                                                xmlns="http://www.w3.org/2000/svg">
                                                            ...
                                                            <h4>Add Media Image({{ $data->image_width }} X
                                                                {{ $data->image_height }}) in Pixel</h4>
                                                        </div>

                                                        <input type="file" accept="image/*" name="image" id="profile_picture"
...
@section('css')
    ...
    <style>
        ...
        .profile-image-show {
            ...
            border-radius: 20px;
            border: 1px dashed #59bb09 !important;
            width: 100%;
            height: 400px;
            padding: 10px;
        }
    ...
    <script type="text/javascript">
        $('#profile_picture').on('change', function() {
            ...
            if (files.size > 2010000) {
                ...
                setTimeout(function() {
                    let image_pre = document.getElementById('profileImage');
                    ...
                    if (width != {{ $data->image_width }} || height != {{ $data->image_height }}) {
                        swal({
                                ...
                                text: "Please upload an image  {{ $data->image_width }} X{{ $data->image_height }}   pixels dimension !",
                                type: "warning",
                                // showCancelButton: true,
