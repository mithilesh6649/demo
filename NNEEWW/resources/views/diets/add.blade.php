                    ...
                    <div class="order_details">
                        <div class="card-main pt-3">
                            ...
                            <div class="card-body main_body form p-3">
                                ...
                                @endif
                                <form id="addSpecializationForm" method="post" action="{{ route('diet.save') }}"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-xl-6 col-6 mb-3 ">
                                                    <div class="form-group ">
                                                        <label for="status">Diet Category<span class="text-danger">
                                                                *</span></label>
                                                        <select class="form-control" id="select" name="diet_category_id">
                                                            <option value="">Select Diet Category</option>

                                                            @foreach ($All_Active_Diets as $All_Active_Diet)
                                                                <option value="{{ $All_Active_Diet->id }}">{{ $All_Active_Diet->title }}
                                                                </option>
                                                            @endforeach
                                                ...
                                                <div class="col-md-12 col-lg-12 col-xl-12 col-12 mb-3">
                                                    <div class="form-group"> <label>Amount<span class="text-danger">
                                                                *</span></label>
                                                        <input type="nubmer" name="amount" class="form-control"
