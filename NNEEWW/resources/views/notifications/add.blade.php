        ...
        <div class="card order_outer rounded_circle">
            <div class="card-body rounded_circle table p-0 mb-0">
                <div class="order_details">
                    <div class="card-main pt-3">
                        ...
                        <div class="card-body main_body form p-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="information_fields mb-0">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                        <div class="form-group"> <label>Message<span class="text-danger">
                                        *</span></label>
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6 col-6 mb-3 ">
                            <div class="form-group ">
                                ...
                                <select class="form-control" id="select" name="notification_type">
                   ...
                   <!--       <div class="col-md-6 col-lg-6 col-xl-6 col-6 mb-3 ">
                            <div class="form-group ">
                                <label for="notification_type_id">Notification for<span class="text-danger"> *</span></label>
                                <select class="form-control" id="select" name="notification_type_id">
                ...
                <label class="mb-3 mt-3 d-block">Notification applied on 
                       <a class="btn info_btn" data-toggle="tooltip" data-placement="right" title="Select Users">
                     ...
                     <div class="col-md-12 col-lg-12 col-xl-12 col-12 mb-3 ">
                       {{-- start discount input  --}}
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                         <label class="mb-0">User</label><input type="checkbox" name="is_user" class="w-auto ml-2" id="is_user" >
                                                         <label class="mb-0 ml-4">Nutritionist</label><input type="checkbox" class="w-auto ml-2" name="is_nutritionist" id="is_nutritionist">
                                                    </div>
                     ...
                     <div class="col-md-12 col-lg-12 col-xl-12 col-12 mb-3 UserPanel d-none">
                            <div class="">
                                  <div class="column" style="">
                        <select id="demo3"  name="users[]"  multiple="multiple" style="">
                  ...
                  <div class="col-md-12 col-lg-12 col-xl-12 col-12 mb-3 nutritionistPanel d-none">
                            <div class="">
                                  <div class="column" style="">
                            <select id="demo2"  name="nutritionists[]"  multiple="multiple" style="">
