                ...
                <div class="order_details">
                    <div class="card-main pt-3">
                        ...
                        <div class="card-body main_body form p-3">
                            ...
                            @endif
                            <form id="EditSpecializationForm" method="post" action="{{ route('update_notification') }}"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                                ...
                                                *</span></label>
                                                ...
                                                maxlength="100" value="{{$data->title ?? '--'}}"> 
                                            </div>
                                        </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-6 col-6">
                        <div class="form-group">
                            ...
                            <div class="upload-img" style="position:relative; margin-top:10px;">
                                <a href="javascript:;" class="remove-pro-img {{ $data->notification_image != null ? '' : 'd-none' }} "  style="display:block;position: absolute;right:-10px;top:-6px;">
                                ...
                                <img src="{{ $data->notification_image }}" id="thumbnail_preview"
                                class="{{ $data->notification_image != null ? '' : 'd-none' }}"
