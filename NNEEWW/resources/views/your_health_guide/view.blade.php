                    ...
                    <div class="order_details">
                        <div class="card-main pt-3">
                            <div class="order_heading alert d-flex align-items-center justify-content-between mb-4">
                                <h3 class="mb-0">  Health Guide Message Details</h3>
                            ...
                            <div class="card-body main_body form p-3">
                                ...
                                <form id="EditSpecializationForm" method="post"
                                    action="{{ route('update_health_guide_essage') }}" enctype="multipart/form-data">
                                    @csrf

                                    <input type="hidden" name="healt_guide_id" value="{{ $data->id }}">
                                        ...
                                        <div class="information_fields mb-0">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 col-lg-12 col-xl-12 col-12 mb-3">
                                                    <div class="form-group"> <label>Message :- {{ $data->name}} 
                                                        </label>
                                                        <input type="text" name="title" class="form-control"
                                                            id="title" maxlength="100" value="{{ $data->value ?? '' }}" readonly>
                                                    </div>
                                                </div>
