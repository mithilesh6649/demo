...
@section('title', 'Super Admin | Meal Template')
                    ...
                    <div class="order_details">
                        <div class="card-main pt-3">
                            <div class="order_heading alert d-flex align-items-center justify-content-between mb-4">
                                <h3 class="mb-0">Meal Template</h3>
                            ...
                            <div class="">
                                <table style="width:100%" id="pages-list" class="table table-bordered table-hover">
                                    ...
                                    <tbody>
                                        @foreach ($mealPlanTemplates as $mealPlanTemplate)
                                        
                                            <tr>
                                             
                                             <td>{{@$mealPlanTemplate->title}}</td>
                                             <td>
                                                 @foreach ($mealPlanTemplate->mealPlanTemplateTag as $tags) 
                                                  <span class="badge badge-pill badge-warning">{{@$tags->healthComplaint->name}}</span>  
                                                 @endforeach
                                             </td>

                                              <td>

                                               {{$mealPlanTemplate->nutritionist == null ? 'System template':$mealPlanTemplate->nutritionist->name}} </td>
