                          ...
                          <div class="col num12" style="min-width: 320px; display: table-cell; vertical-align: top; width: 600px;">
                            <div class="col_cont" style="width:100% !important;">
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                  <div align="center" class="img-container fixedwidth" style="padding-right: 15px;padding-left: 15px;">
                                      <div style="font-size:1px;line-height:30px"> </div>
                                      <a href="https://admin.doroosi.net/" style="outline:none" tabindex="-1" target="_blank"><img align="center" alt="Your Store Logo" border="0" class="fixedwidth" src="https://admin.doroosi.net/images/logo-email.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; padding: 20px 0; width: 100%; max-width: 120px; display: block;" title="Your Store Logo" width="120"/></a>
                                      <div style="font-size:1px;line-height:30px"> </div>
                                  </div>
                                </div>
                            </div>
                            ...
                            <div class="col_cont" style="width:100% !important;">
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:30px; padding-right: 0px; padding-left: 0px;">
                                  <div style="color:#343d49;font-family:Rubik, Trebuchet MS, Helvetica, sans-serif;line-height:1.5;padding-top:0px;padding-right:10px;padding-bottom:05px;padding-left:10px;">
                                      <div class="txtTinyMce-wrapper" style="line-height: 1.5; font-size: 12px; color: #343d49; font-family: Rubik, Trebuchet MS, Helvetica, sans-serif; mso-line-height-alt: 18px;">
                                        <p style="font-size: 14px; line-height: 1.5; word-break: break-word; text-align: left; mso-line-height-alt: 21px; margin: 0;"><br/>{{ __('adminlte::adminlte.not_clickable_message') }}</p>
                                      </div>
                                  </div>
                                  <div style="font-size:16px;font-family:Rubik, Trebuchet MS, Helvetica, sans-serif"><p style="font-size: 14px; line-height: 1.5; word-break: break-word; text-align: left; mso-line-height-alt: 21px; margin: 0;"><a href="{{ $ticketLink }}" style="font-size: 14px; color: #3869d4; padding-bottom: 50px;">{{ $ticketLink }}</a></p></div>
                                </div>
                            </div>
                          </div>
                      </div>
                            ...
                            <div class="col_cont" style="width:100% !important;">
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:10px; padding-bottom:10px; padding-right: 0px; padding-left: 0px;">
                                  <div style="color:#343d49;font-family:Rubik, Trebuchet MS, Helvetica, sans-serif;line-height:1.5;padding-top:0px;padding-right:10px;padding-bottom:00px;padding-left:10px;">
                                    <div class="txtTinyMce-wrapper" style="line-height: 1.5; font-size: 12px; color: #343d49; font-family: Rubik, Trebuchet MS, Helvetica, sans-serif; mso-line-height-alt: 18px;">
                                      <p style="font-size: 12px; line-height: 1.5; word-break: break-word; text-align: left; mso-line-height-alt: 18px; margin: 0;"><span style="font-size: 12px;">{{ __('adminlte::adminlte.copyright') }}</span></p>
                                    </div>
                                  </div>
                                </div>
                            </div>
