                            ...
                            <div class="col_cont" style="width:100% !important;">
                                <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:5px; padding-bottom:5px; padding-right: 0px; padding-left: 0px;">
                                  <div align="left" class="img-container fixedwidth" style="padding-right: 15px;padding-left: 15px;">
                                      ...
                                      <a href="https://admin.doroosi.net/" style="outline:none" tabindex="-1" target="_blank"><img align="left" alt="Your Store Logo" border="0" class="fixedwidth" src="https://admin.doroosi.net/images/logo-email.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; padding: 20px 0; width: 100%; max-width: 120px; display: block;" title="Your Store Logo" width="120"/></a>
                                      <div style="font-size:1px;line-height:30px"> </div>
                                  </div>
                                </div>
                            </div>
