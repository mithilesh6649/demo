...
@section('title', 'Super Admin |Add Social Link')
                    ...
                    <div class="order_details">
                        <div class="card-main pt-3">
                            <div class="order_heading alert d-flex align-items-center justify-content-between mb-4">
                                <h3 class="mb-0">Add Social Link</h3>
                            ...
                            <div class="card-body main_body form p-3">
                                <form class="form_wrap" id="addSocialMediaForm" method="post"
                                    action="{{ route('save.social_media') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
