                    ...
                    <div class="order_details">
                        <div class="card-main pt-3">
                            <div class="order_heading alert d-flex align-items-center justify-content-between mb-4">
                                <h3 class="mb-0">Edit Social Link</h3>
                            ...
                            <div class="card-body main_body form p-3">
                                <form class="form_wrap" id="editSocialMediaForm" method="post"
                                    action="{{ route('update.social_media') }}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="row">
                                            ...
                                            <div class="form-group ">
                                                ...
                                                <select class="form-control" name="status" id="status">
                                                    @foreach ($status as $status_data)
                                                        <option @if ($status_data->value == $social_link->status) selected @endif
                                        ...
                                        <input type="hidden" name="social_login_id" value="{{ $social_link->id }}">
                                                    ...
                                                    <div class="card-body main_body form p-0">
                                                        <div class="upload_img row row_justify justify-content-center">
                                                            ...
                                                            <div class="new_image img_upload_one"
                                                                style="display: {{ $social_link->image ? 'none' : 'block' }}"
                                                                style="display:none;">
            ...
            $('#editSocialMediaForm').validate({
                ...
                messages: {
                    ...
                    profile_url: {
                        ...
                        url: "Please enter correct Profile URL"
                    },
                    Media_image: {
        ...
        $(document).on('click', '.remove_image', function() {
            ...
            swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{ route('delete.social_media_image') }}",
                        data: {
                            "_token": "{{ csrf_token() }}",
