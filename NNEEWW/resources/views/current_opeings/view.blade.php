                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-lg-6 col-xl-6 col-6 mb-3">
                                            <div class="form-group"> <label> Job Title </label>
                                                ...
                                                id="job_title" maxlength="100" value="{{$data->job_title ?? ''}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-6 col-xl-6 col-6 mb-3">
                                            <div class="form-group"> <label> Department</label>
                                                ...
                                                id="department" maxlength="100" value="{{$data->department ?? ''}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-6 col-xl-6 col-6 mb-3">
                                            <div class="form-group"> <label>Location</label>
                                                ...
                                                id="location" maxlength="100" value="{{$data->location ?? ''}}" readonly>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-lg-6 col-xl-6 col-6 mb-3 ">
                                            <div class="form-group ">
                                                ...
                                                <select disabled class="form-control" id="select" name="employee_type">
