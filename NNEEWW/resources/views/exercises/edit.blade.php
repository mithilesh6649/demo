                ...
                <div class="order_details">
                    <div class="card-main pt-3">
                        <div class="order_heading alert d-flex align-items-center justify-content-between mb-4">
                            <h3 class="mb-0">Edit Exercise</h3>
                            ...
                            <div class="card-body">
                                ...
                                <div class="information_fields mb-0">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-6 col-6 mb-3">
                                        ...
                                        *</span></label>
                                        ...
                                        id="calories_burnt" maxlength="100" value="{{$data->calories_burnt ?? '--'}}">
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6 col-lg-6 col-xl-6 col-6 mb-3">
                                    ...
                                    *</span></label>
                                    ...
                                    id="duration_in_minutes" maxlength="100"  value="{{$data->duration_in_minutes ?? '--'}}">  
                                </div>
                            </div>
