                            ...
                            <div class="tab_wrapper">
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                        ...
                                        <form id="addbanner" method="post" autocomplete="off" class="dropzone"
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select name="page_name" id="page_name" class="form-control">
                                                                ...
                                                                @forelse ($pages_name as $page_name)
                                                                    <option value="{{ $page_name->value }}"
                                                                        {{ in_array($page_name->value, $existing_pages) ? 'disabled ' : '' }}>
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-12  ">
                                                        <div class="form-group mt-3">
                                                            ...
                                                            <div id="dropzoneDragArea"
                                                                class="dz-default dz-message dropzoneDragArea my-0">
