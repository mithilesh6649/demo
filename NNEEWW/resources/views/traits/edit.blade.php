                        ...
                        <div class="card-main pt-3">
                            ...
                            <div class="card-body main_body form p-3">
                                ...
                                <form id="EditSpecializationForm" method="post"
                                    action="{{ route('trait.update') }}" enctype="multipart/form-data">
                                    @csrf
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-xl-6 col-6 mb-3 ">
                                                    <div class="form-group ">
                                                        <label for="status">Trait Category<span class="text-danger">
                                                                *</span></label>
                                                        <select class="form-control" id="select" name="trait_category_id">
                                                            <option value="">Select Trait Category</option>

                                                            @foreach ($all_active_traits_categories as $all_active_traits_category)
                                                                <option {{$data->trait_category_id == $all_active_traits_category->id ? 'selected':'' }} value="{{ $all_active_traits_category->id }}">{{ $all_active_traits_category->title }}
                                                                </option>
                                                            @endforeach
