                ...
                <div class="order_details">
                    <div class="card-main pt-3">
                        ...
                        <div class="card-body main_body form p-3">
                            ...
                            action="{{ route('additional_trait_discount_update') }}" enctype="multipart/form-data">
                            @csrf
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                <div class="form-group"> <label>  Any One Test Related Discount<span class="text-danger"> *</span>
                                </label>
                                  <select style="pointer-events:none;" name="test_count" class="form-control" >
                             ...
                             @elseif($data->slug=='any_two')

                                   
                                       <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                <div class="form-group"> <label>  Any Two Test Related Discount<span class="text-danger"> *</span>
                                </label>
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                <div class="form-group"> <label>@if($data->slug=='additional_traits') All Traits Related Discount  @else Amount @endif<span class="text-danger"> *</span>
                                </label>
                                <input type="number" name="price" class="form-control"
                                id="price" maxlength="100" value="{{ $data->price ?? '' }}">
                            </div>
                        </div> 
