                ...
                <div class="order_details">
                    <div class="card-main pt-3">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                <div class="form-group"> <label>  Any One Test Related Discount
                                </label>
                             ...
                             @elseif($data->slug=='any_two')
                                       ...
                                       <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                <div class="form-group"> <label>  Any Two Test Related Discount
                                </label>
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                <div class="form-group"> <label>@if($data->slug=='additional_traits') All Traits Related Discount  @else Amount @endif
                                </label>
