...
@section('title', 'Edit Job Industry')
    ...
    <div class="col-md-12">
        <div class="card">
          <div class="card-header alert d-flex justify-content-between align-items-center">
            <h3>{{ __('adminlte::adminlte.edit_job_industry') }}</h3>
          ...
          <div class="card-body">
            ...
            @endif
            <form id="editJobIndustryForm" method="post" action="{{ route('update_job_industry') }}">
              @csrf
              <div class="card-body">
                @if ($errors->any())
                ...
                <input type="hidden" name="id" class="form-control" id="industry_id" value="{{ $jobIndustry[0]->id }}">
                <div class="information_fields">
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for="name">{{ __('adminlte::adminlte.name') }}<span class="text-danger"> *</span></label>
                        <input type="text" name="name" class="form-control" id="name" value="{{ $jobIndustry[0]->name }}" maxlength="100">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select name="status" class="form-control" id="status">
                          <option value="1" {{ ( $jobIndustry[0]->status == 1) ? 'selected' : '' }}>{{ __('adminlte::adminlte.active') }}</option>
                          <option value="0" {{ ( $jobIndustry[0]->status == 0) ? 'selected' : '' }}>{{ __('adminlte::adminlte.inactive') }}</option>
                        </select>
                    ...
                    <!-- <div class="col-sm-12">
                      <div class="form-group">
                        ...
                        <textarea id="description" name="description" maxlength="1000">{{ $jobIndustry[0]->description }}</textarea>
