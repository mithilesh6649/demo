    ...
    <div class="col-md-12">
      <div class="card">
         <div class="card-header alert d-flex justify-content-between align-items-center">
          <h3>{{ __('adminlte::adminlte.job_industry_information') }}</h3>
            ...
            <div class="row">
              ...
              <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-6">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="{{ $jobIndustry[0]->created_at ? date('d/m/y', strtotime($jobIndustry[0]->created_at)) : '' }}" readonly>
                </div>
              </div>
              ...
              <!-- <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-6">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="{{ $jobIndustry[0]->deleted_at ? date('d/m/y', strtotime($jobIndustry[0]->deleted_at)) : '' }}" readonly>
                </div>
              </div> -->
            </div>
            ...
            <div class="row">
              ...
              <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-6">
                <div class="form-group">
                  ...
                  <input class="form-control" placeholder="{{ $jobIndustry[0]->updated_at ? date('d/m/y', strtotime($jobIndustry[0]->updated_at)) : '' }}" readonly>
                </div>
              </div>
            </div>
