    ...
    <div class="col-md-12">
        <div class="card">
          <div class="card-header alert d-flex justify-content-between align-items-center">
            <h3>{{ __('adminlte::adminlte.add_county') }}</h3>
          ...
          <div class="card-body">
            ...
            <form id="addCountyForm" method="post" action="{{ route('save_county') }}">
              @csrf
              <div class="card-body">
                @if ($errors->any())
                  ...
                  <div class="row">
                    ...
                    <div class="col-6">
                      <div class="form-group">
                        ...
                        <input type="text" name="country" class="form-control" id="country" maxlength="100">
