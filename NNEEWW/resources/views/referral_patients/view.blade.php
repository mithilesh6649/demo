...
@section('title', 'Clinicians Details')
        ...
        <div class="order_details">
          <div class="card-main pt-3">
            <div class="order_heading alert d-flex align-items-center justify-content-between mb-4">
              <h3 class="mb-0">Clinicians Details</h3>
                ...
                <div class="row">
                  <div class="col-6 mb-3">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="{{ $data->first_name ?? '' }}    " readonly>
                    </div>
                  </div>
                   ...
                   <div class="col-6 mb-3">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="{{ $data->last_name ?? '' }}    " readonly>
                    </div>
                  </div>
                ...
                <div class="row">
                   ...
                   <div class="form-group">
                       ...
                       <input type="hidden" name="country_code" class="form-control" id="country_code"
                           value="{{ $data->country_code ?? '' }}" readonly />
                   </div>
               </div>
                  ...
                  <div class="col-6 mb-3">
                     <div class="form-group">
                      <label>City</label>
                      <input class="form-control" placeholder="{{ $data->city ?? '--' }}" readonly>
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input class="form-control" placeholder="{{ date('d/m/Y', strtotime($data->created_at)) }}" readonly>
                    </div>
                  </div>
                     ...
                     <div class="form-group">
                      <label>Diseases</label>
                       ...
                       <ul>
                           @if(isset($data->diseases['disease_id']))
                          
                           @forelse ($data->diseases['disease_id'] as $disease)
                            <li>{{ \App\Models\HealthComplaint::getDiseasesName($disease) }}</li>
                        @empty
                            <p>No users</p>
                        @endforelse

                        @else
                           <li> Diseases not found !</li>
                        @endif 
                      </ul>
...
@section('js')
    ...
    <script>
        ...
        $(function() {
            var code = "+" +
                "{{ $data->country_code ?? 49 }}{{ $data->contact }}"; // Assigning value from model.
            $('#txtPhone').val(code);
