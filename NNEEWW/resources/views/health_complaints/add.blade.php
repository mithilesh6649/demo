...
@section('title', 'Add Health Complaints')
                    ...
                    <div class="order_details">
                        <div class="card-main pt-3">
                            <div class="order_heading alert d-flex align-items-center justify-content-between mb-4">
                                <h3 class="mb-0">Add Health Complaint</h3>
                            ...
                            <div class="card-body main_body form p-3">
                                ...
                                @endif
                                <form id="addCurrentOfferForm" method="post" action="{{ route('save_project_features') }}"
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <select class="form-control" id="select" name="type">
                                                            ...
                                                            @foreach ($health_complaints as $health_complaint)
                                                                <option value="{{ $health_complaint->value }}">{{ $health_complaint->name }}
                                                                </option>
                                                            @endforeach
