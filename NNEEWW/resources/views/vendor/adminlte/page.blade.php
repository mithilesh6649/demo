                ...
                <div class="{{ config('adminlte.classes_content') ?: $def_container_class }} p-0">
                    ...
                    @if(session()->has('error'))
                        <div class="alert alert-danger alert-dismissable" role="alert">
                            {{ session()->get('error') }}
                            <a href="javascript:void(0)" id="close_button" data-dismiss="alert" aria-label="Close" class="float-right text-white close">X</a>
                        </div>
                    @endif
...
@section('adminlte_js')
   ...
   <!--  <script type="text/javascript">
    ...
    <script type="text/javascript">
      ...
      // sessionStorage.setItem("loginData",'Ashutosh');
      // alert(sessionStorage.loginData);
