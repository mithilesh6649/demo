...
@section('title', 'Super Admin | Specializations')
                    ...
                    <div class="order_details">
                        <div class="card-main pt-3">
                            <div class="order_heading alert d-flex align-items-center justify-content-between mb-4">
                                ...
                                href="{{ route('add_specialization') }}">Add Specialization</a>
                                @endcan
                                ...
                                <table style="width:100%" id="pages-list" class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            @if (Gate::check('view_specialization') || Gate::check('edit_specialization') || Gate::check('delete_specialization'))
                                            <th>Actions</th>
                                           @endif
                                        </tr>
                                    </thead>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="action-button" title="View"
                                                        href="{{ route('view_specialization', ['id' => $AllSpecialization->id]) }}"><i
                                                            class="text-success fa fa-eye"></i></a>
                                                     @endcan
                                                        
                                                   @can('edit_specialization')
                                                       
                                                   <a href="{{ route('edit_specialization', ['id' => $AllSpecialization->id]) }}"
