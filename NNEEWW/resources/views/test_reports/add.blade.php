                ...
                <div class="order_details">
                    <div class="card-main pt-3">
                        ...
                        <div class="card-body main_body form p-3">
                            ...
                            @endif
                            <form id="addExerciseForm" method="post" action="{{ route('save_exercise') }}"
                            ...
                            <div class="card-body">
                                ...
                                <div class="information_fields mb-0">
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-6 col-6 mb-3">
                                        <div class="form-group"> <label>Calories burn<span class="text-danger">
                                        *</span></label>
                                        <input type="number" name="calories_burnt" class="form-control"
                                        id="calories_burnt" maxlength="100">
                                    </div>
                                </div>

                                <div class="col-md-6 col-lg-6 col-xl-6 col-6 mb-3">
                                    <div class="form-group"> <label>Duration (min)<span class="text-danger">
                                    *</span></label>
                                    <input type="number" name="duration_in_minutes" class="form-control"
                                    id="duration_in_minutes" maxlength="100">
                                </div>
                            </div>
