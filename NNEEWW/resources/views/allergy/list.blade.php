...
@section('title', 'Super Admin | Allergy')
                    ...
                    <div class="order_details">
                        <div class="card-main pt-3">
                            <div class="order_heading alert d-flex align-items-center justify-content-between mb-4">
                                <h3 class="mb-0"> Allergy</h3>

                                @can('add_allergies')
                                    <a class="btn btn-sm btn-success add-advance-options" href="{{ route('add_allergy') }}">Add
                                        Allergy</a>
                                @endcan
                                ...
                                <table style="width:100%" id="pages-list" class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                            ...
                                            @if (Gate::check('view_allergies') || Gate::check('edit_allergies') || Gate::check('delete_allergies'))
                                                <th>Actions</th>
                                            @endif
                                                    ...
                                                    <td>
                                                        ...
                                                        @can('view_allergies')
                                                            <a class="action-button" title="View"
                                                                href="{{ route('view_allergy', ['id' => $Disease->id]) }}"><i
                                                                    class="text-success fa fa-eye"></i></a>
                                                        @endcan

                                                        @can('edit_allergies')
                                                            <a href="{{ route('edit_allergy', ['id' => $Disease->id]) }}"
                                                                title="Edit"><i class="text-warning fa fa-edit"></i></a>
                                                        @endcan

                                                        @can('delete_allergies')
