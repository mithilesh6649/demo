        ...
        <!--filter  -->
         <div class="col-12">
            ...
            <div class="card">
               <div class="student_chart">
                   <figure class="highcharts-figure">
                        ...
                        <p class="highcharts-description" style="text-align:center">Students Statistics <span class="active_year">{{date('Y')}}</span></p>
                    </figure>
               </div>
           </div>
           ...
           <div class="card">
               <div class="student_chart">
                   <figure class="highcharts-figure">
                        ...
                        <p class="highcharts-description" style="text-align:center">Students Enrollment Statistics <span class="active_year">{{date('Y')}}</span></p>
                    </figure>
               </div>
           </div>
           ...
           <div class="card" style="display:none">
               <div class="student_chart">
                   <figure class="highcharts-figure">
                        <div id="container_bar_2"></div>
                        <p class="highcharts-description" style="text-align:center">Students Enrollment Statistics(Paid/Unpaid) <span class="active_year">{{date('Y')}}</span></p>
                    </figure>
               </div>
           </div>
...
<script type="text/javascript">
    ...
    var schoolChart = Highcharts.chart('chart_school_types', {
        chart: {
            type: 'pie',
            options3d: {
                enabled: true,
    ...
    $(document).ready(function(){
        ...
        var arr = JSON.parse("{{$school_data}}".replace(/&quot;/g,'"'));
...
<script type="text/javascript">
    ...
    Highcharts.chart('container', {
        ...
        series: [{
            ...
            name: 'Students',
            data: [
                ['Male ('+{{$male_student_count}}+')', {{$male_student_count}}],
                ['Female ('+{{$female_student_count}}+')', {{$female_student_count}}],
            ]
        }]
    });
</script>
...
Highcharts.chart('container_bar', {
    ...
    title: {
        text: 'Students Enrollment Statistics'
    },
    subtitle: {
        text: ''
    },
...
<script type="text/javascript">
    ...
    dp.on('changeYear', function (e) { 
        ...
        setTimeout(function(){ 
            ...
            $.ajax({
                url: "{{ route('reports.filter_students_report') }}",
                method: "POST",
                data: {
                  year: year
                },
                   ...
                   Highcharts.setOptions({
                    ...
                    Highcharts.chart('container', {
                        ...
                        series: [{
                            ...
                            name: 'Students',
                            data: [
                                ['Male ('+response.male_student_count+')', response.male_student_count],
                                ['Female ('+response.female_student_count+')', response.female_student_count],
                            ]
                        }]
                    });
                  // pie chart

                  // monthly students data
                  Highcharts.setOptions({
                        colors: ['#058DC7', '#50B432', '#ED561B', '#24CBE5', '#64E572', '#FF9655', '#6AF9C4']
                    });
                    Highcharts.chart('container_bar', {
...
<!-- testing stacked clumn -->
<script type="text/javascript">
    Highcharts.setOptions({
        colors: ['rgb(80, 180, 50', 'orange']
    });


    Highcharts.chart('container_bar_2', {
    chart: {
        type: 'column'
    },
    title: {
        text: 'Students Enrollment Statistics(Paid/Unpaid)'
    },
    xAxis: {
