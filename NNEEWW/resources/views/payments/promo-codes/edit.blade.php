    ...
    <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            @endif
            <form id="addSchoolForm" method="post" action="{{route('promo_codes.update')}}">
              @csrf
              <div class="card-body">
                @if ($errors->any())
                ...
                <div class="row">
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="name" class="form-control" id="name" maxlength="100" value="{{$promo_code->name}}">
                      @if($errors->has('name'))
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="description" class="form-control" id="description" maxlength="100" value="{{$promo_code->description}}">
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="percentage_off" class="form-control" id="percentage_off" maxlength="100" value="{{$promo_code->percentage_off}}">
                  ...
                  <div class="col-12">
                    <div class="form-group">
                      ...
                      <select name="status" class="form-control" id="status">
                        ...
                        <option value="1" @if($promo_code->status==1) selected @endif>Active</option>
                        <option value="0" @if($promo_code->status==0) selected @endif>Inactive</option>
...
@section('js')
  <script>
    $(document).ready(function() {
      ...
      }, "Please specify an integer or a float value less than or equal to 100.");
