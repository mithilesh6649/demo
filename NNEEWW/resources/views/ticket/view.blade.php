                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                           <div class="form-group"> <label>Author Name
                              ...
                              <input readonly type="text" name="ticket_owner_name" class="form-control"
                                 id="ticket_owner_name" maxlength="100"
                                 value="{{ @$ticket->user->name ?? '' }}">
                           </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-6 col-6">
                           <div class="form-group ">
                              <label for="ticket_assigned_to">Assign To Nutiritionist </label>
                              <select class="form-control" id="ticket_assigned_to" name="ticket_assigned_to">
                                 <option>Select Nutiritionist</option>
                                 @foreach ($nutiritionists as $nutiritionist)
                                 <option
                                 {{ $ticket->ticket_assigned_to == $nutiritionist->id ? 'selected' : '' }}
                                 value="{{ @$nutiritionist->id }}">{{ @$nutiritionist->name }}
                                 </option>
                                 @endforeach
                              </select>
                           </div>
                        ...
                        <div class="col-md-12 col-lg-12 col-xl-12 col-12">
                           <div class="form-group ">
                              <label for="ticket_assigned_to">Comments : -</label>
                              <ul>
                                 <li>Admin : Hii</li>
                                 <li>User : Bye</li>
                              </ul>
