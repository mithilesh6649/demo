            ...
            <form id="addPageForm" method="post", action="{{ route('contact_us.send_reply') }}">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="subject" name="subject" class="form-control" id="subject" maxlength="100" value="{{$contact_us->subject}}">
                  @if($errors->has('title'))
                ...
                <div class="form-group">
                  ...
                  <textarea id="message" name="message">{{$contact_us->message}}</textarea>
                </div>
