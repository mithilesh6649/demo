...
@section('title', ' Super Admin | Add Nutritionist')
                ...
                <div class="order_details">
                    <div class="card-main pt-3">
                        <div class="order_heading alert d-flex align-items-center justify-content-between mb-4">
                            <h3 class="mb-0">Add Nutritionist</h3>
                        ...
                        <div class="card-body main_body form p-3">
                            ...
                            @endif
                            <form id="AddNutritionist" method="post" action="{{ route('save_nutritionist') }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                *</span></label>
                                <input type="text"
                                class="form-control date_controls timepickercustom"
                                name="close_time" id="close_time" autocomplete="off">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6 col-6">
                            ...
                            <div class="col-md-6  ">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="experience"   class="form-control diet_input_plan" id=""  >
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 ">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="address"   class="form-control diet_input_plan"  id="address"  >
                                </div>
                            </div>
                            ...
                            <div class="col-md-6  ">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="city"   class="form-control diet_input_plan"  id="city"   readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6  ">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="state"   class="form-control diet_input_plan"  id="state"   readonly>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 ">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="country"   class="form-control diet_input_plan"  id="country"   readonly>
                                </div>
                            </div>
...
<style>
    ...
    .profile-image-show {
        ...
        border-radius: 20px;
        border: 1px dashed #52b40a !important;
        width: 200px;
        height: 200px;
        margin: 0px 0 20px;
        /*overflow: hidden;*/
