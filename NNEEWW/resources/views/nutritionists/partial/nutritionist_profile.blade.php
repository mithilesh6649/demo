                             <form id="editUserForm" method="post" action="{{ route('update_nutritionist') }}"
                               ...
                               <div class="row">
                                   <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-12">
                                       <div class="profile-image-show mt-3">
                                           <a href="javascript:;"
                                           class="remove-pro-img d-none {{ @$Nutritionist->NutritionistMetadata->image != null ? '' : 'd-none' }}"
                                           id="{{ @$Nutritionist->NutritionistMetadata->id ?? '' }}"
                                           style="display:block">
                                   ...
                                   <img src="{{ @$Nutritionist->NutritionistMetadata->image }}"
                                   class="{{ @$Nutritionist->NutritionistMetadata->image != null ? '' : 'd-none' }}"
                                   width="80%" id="profileImage">

                                   <div
                                   class="thumb_nails {{ @$Nutritionist->NutritionistMetadata->image != null ? 'd-none' : '' }}">
                                       ...
                                       <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                                           <div class="form-group">
                                               ...
                                               value="{{ $Nutritionist->title ?? '--' }}" readonly>
                                       ...
                                       <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                                           <div class="form-group">
                                               ...
                                               value="{{ $Nutritionist->name ?? '--' }}" readonly>
                                       ...
                                       <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                                           <div class="form-group">
                                               ...
                                               id="txtPhone" value="{{ $Nutritionist->phone_number ?? '' }}"
                                               readonly />
                                               <input type="hidden" name="country_code" class="form-control"
                                               id="country_code"
                                               value="{{ $Nutritionist->country_code ?? '' }}" readonly />
                                           </div>
                                       </div>
                                       ...
                                       <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                                           <div class="form-group">
                                               ...
                                               value="{{ $Nutritionist->email ?? '' }}" readonly>
...
<!-- 
                                ...
                                <label for="lab_name">Working Days </label>
                                <input @if(in_array(0, $WorkingHourIds)) checked @else @endif type="checkbox" name="days[]" value="0">Sunday
                                <input  @if(in_array(1, $WorkingHourIds)) checked @else @endif type="checkbox" name="days[]" value="1">Monday
                                <input  @if(in_array(2, $WorkingHourIds)) checked @else @endif type="checkbox" name="days[]" value="2">Tuesday
                                <input  @if(in_array(3, $WorkingHourIds)) checked @else @endif  type="checkbox" name="days[]" value="3">Wednesday
                                <input  @if(in_array(4, $WorkingHourIds)) checked @else @endif  type="checkbox" name="days[]" value="4">Thursday
                                <input  @if(in_array(5, $WorkingHourIds)) checked @else @endif  type="checkbox" name="days[]" value="5">Friday
                                <input  @if(in_array(6, $WorkingHourIds)) checked @else @endif  type="checkbox" name="days[]" value="6">Saturday
...
<div class="col-md-12">
                            <!-- <div class="form-group"> -->
                                <div class="working_days">
                                    <label for="lab_name">Working Days
                                        <span class="text-danger">*</span>
                                    </label>
                                    <ul>
                                        <li>
                                            <div class="custom_check">
                                                <input type="checkbox" name="days[]" value="0" @if(in_array(0, $WorkingHourIds)) checked @else @endif >
                                                <span></span>
                                            </div>
                                            <label>Sunday</label>
                                        </li>
                                        <li>
                                            <div class="custom_check">
                                                <input type="checkbox" name="days[]" value="1" @if(in_array(1, $WorkingHourIds)) checked @else @endif>
                                                <span></span>
                                            </div>
                                            <label>Monday</label>
                                        </li> 
                                        <li>
                                            <div class="custom_check">
                                                <input type="checkbox" name="days[]"  value="2" @if(in_array(2, $WorkingHourIds)) checked @else @endif>
                                                <span></span>
                                            </div>
                                            <label>Tuesday</label>
                                        </li>
                                        <li>
                                            <div class="custom_check">
                                                <input type="checkbox" name="days[]" value="3" @if(in_array(3, $WorkingHourIds)) checked @else @endif>
                                                <span></span>
                                            </div>
                                        ...
                                        <li>
                                            <div class="custom_check">
                                                <input type="checkbox" name="days[]" value="4" @if(in_array(4, $WorkingHourIds)) checked @else @endif>
                                                <span></span>
                                            </div>
                                        ...
                                        <li>
                                            <div class="custom_check">
                                                <input type="checkbox" name="days[]" value="5" @if(in_array(5, $WorkingHourIds)) checked @else @endif>
                                                <span></span>
                                            </div>
                                            <label>Friday</label>
                                        </li>
                                        <li>
                                            <div class="custom_check">
                                                <input type="checkbox" name="days[]" value="6" @if(in_array(6, $WorkingHourIds)) checked @else @endif>
                                                <span></span>
                                            </div>
                            ...
                            <label id="days_error_msg"></label>
                                       ...
                                       <div class="col-md-6">
                                           <div class="form-group">
                                               ...
                                               name="open_time" autocomplete="off"
                                               value="{{ @$Nutritionist->NutritionistMetadata->open_time ?? '' }}"
                                               readonly>
                                           </div>
                                       </div>
                                       ...
                                       <div class="col-md-6">
                                           <div class="form-group">
                                               ...
                                               <input type="text"
                                               class="form-control date_controls timepickercustom"
                                               name="close_time" autocomplete="off"
                                               value="{{ @$Nutritionist->NutritionistMetadata->close_time ?? '' }}"
                                               readonly>
                                           </div>
                                       </div>
                                       ...
                                       <div class="col-md-6 col-lg-6 col-xl-6 col-6">
                                        <div class="form-group" style="pointer-events:none;">
                                            ...
                                            <select  id="specialization_id"  name="specialization_id[]"  multiple="multiple" style="">

                                                @forelse ($specializations as $specialization)
                                                <option   @if(in_array($specialization->id,$NutritionistSpecializationMapIds)) selected @endif   value="{{ $specialization->id }}">
                                        ...
                                        <div class="col-md-6  ">
                                            <div class="form-group">
                                                <label class="label_sheet">Experience ( Years) </label>
                                                <input readonly type="number" name="experience"  value="{{@$Nutritionist->work_experience ?? '--'}}"  class="form-control diet_input_plan" id=""  >
                                            </div>
                                        </div>

                                        <div class="col-md-6">
                                           <div class="form-group">
                                               <label for="charges">Charges($/hr) </label>
                                               <input type="number" class="form-control" name="charges"
                                               autocomplete="off"
                                               value="{{ @$Nutritionist->NutritionistMetadata->charges ?? '' }}"
                                               readonly>
                                           </div>
                                       </div>
                                       ...
                                       <div class="col-md-6">
                                           <div class="form-group">
                                               <label for="lab_name">Working area </label>
                                               <input type="text" class="form-control" name="working_area"
                                               autocomplete="off"
                                               value="{{ @$Nutritionist->NutritionistMetadata->working_area ?? '' }}"
                                               readonly>
                                           </div>
                                       </div>
                                       ...
                                       <div class="col-md-6 ">
                                        <div class="form-group">
                                            <label class="label_sheet">Address </label>
                                            <input type="text" name="address"  value="{{ @$Nutritionist->NutritionistMetadata->address ?? '' }}"   class="form-control diet_input_plan"  id="address"  readonly >
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6  ">
                                        <div class="form-group">
                                            <label class="label_sheet">City </label>
                                            <input type="text" name="city"  value="{{ @$Nutritionist->NutritionistMetadata->city ?? '' }}"   class="form-control diet_input_plan"  id="city"   readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6  ">
                                        <div class="form-group">
                                            <label class="label_sheet">State  </label>
                                            <input type="text" name="state"  value="{{ @$Nutritionist->NutritionistMetadata->state ?? '' }}"  class="form-control diet_input_plan"  id="state"   readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 ">
                                        <div class="form-group">
                                            <label class="label_sheet">Country </label>
                                            <input type="text" name="country"   value="{{ @$Nutritionist->NutritionistMetadata->country ?? '' }}"  class="form-control diet_input_plan"  id="country"   readonly>
                                        </div>
                                    </div>

                                    <input type="hidden" name="lat" class="form-control" id="lat" 
                                    readonly  value="{{ @$Nutritionist->NutritionistMetadata->latitude ?? '' }}">
                                    <input type="hidden" name="lng" class="form-control" id="lng"  
                                    readonly  value="{{ @$Nutritionist->NutritionistMetadata->longitude ?? '' }}">
                                    ...
                                    <div class="col-md-12 col-lg-12 col-xl-12 col-12">
                                       ...
                                       <div class="form-group">
                                           ...
                                           <select disabled name="status" class="form-control" id="status">
                                               ...
                                               <option
                                               @if ($Nutritionist->UserAction == null) '' @else selected @endif
                                   ...
                                   <div class="col-md-12">
                                       <div class="form-group">
                                           ...
                                           <textarea name="description" class="form-control" rows="4" readonly>{{ @$Nutritionist->NutritionistMetadata->description ?? '' }}</textarea>
                                       </div>
                                   </div>
