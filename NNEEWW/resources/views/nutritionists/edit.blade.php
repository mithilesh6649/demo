                ...
                <div class="order_details">
                    <div class="card-main pt-3">
                        <div class="order_heading alert d-flex align-items-center justify-content-between mb-4">
                            <h3 class="mb-0"> Edit Nutritionist </h3>
                        ...
                        <div class="card-body main_body form p-3">
                            ...
                            {{-- <div class="container">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#menus1">Appoinments</a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <form id="EditNutritionist" method="post" action="{{ route('update_nutritionist') }}"
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-12">
                                        <div class="profile-image-show mt-3">
                                            <a href="javascript:;"
                                            class="remove-pro-img {{ @$Nutritionist->NutritionistMetadata->image != null ? '' : 'd-none' }}"
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                        <div class="form-group">
                            ...
                            maxlength="4" value="{{ $Nutritionist->title ?? '' }}">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                        <div class="form-group">
                            ...
                            id="country_code"
                            value="{{ $Nutritionist->country_code ?? '' }}" />
                        </div>
                    </div>
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-6 col-12 ">
                        <div class="form-group mt-3">
                            ...
                            <div style="position:relative;">
                                ...
                                placeholder=" " id="password_confirmation" value="">
                                <div style="position:absolute;top:18px;right:15px;">
                                    <i class="fas fa-eye view_con_pass"
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                *</span></label>
                                ...
                                name="open_time" id="open_time" autocomplete="off"
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6 col-6">
                            <div class="form-group">
                                <label for="specialization_id">Specializations<span
                                    class="text-danger">
                                *</span></label>
                                ...
                                <label id="specialization_error_msg" style="font-weight: 400 !important;"></label>
                            </div>

                            <div class="col-md-6  ">
                                <div class="form-group">
                                    <label class="label_sheet">Experience ( Years)<span class="text-danger"> *</span></label>
                                    <input type="number" name="experience"  value="{{@$Nutritionist->work_experience ?? '--'}}"  class="form-control diet_input_plan" id=""  >
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 ">
                                <div class="form-group">
                                    <label class="label_sheet">Address<span class="text-danger"> *</span></label>
                                    <input type="text" name="address"  value="{{ @$Nutritionist->NutritionistMetadata->address ?? '' }}"   class="form-control diet_input_plan"  id="address"  >
                                </div>
                            </div>
                            ...
                            <div class="col-md-6  ">
                                <div class="form-group">
                                    <label class="label_sheet">City<span class="text-danger"> *</span></label>
                            ...
                            <div class="col-md-6  ">
                                <div class="form-group">
                                    <label class="label_sheet">State<span class="text-danger"> *</span></label>
                            ...
                            <div class="col-md-6 ">
                                <div class="form-group">
                                    <label class="label_sheet">Country<span class="text-danger"> *</span></label>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control" rows="4">{{ @$Nutritionist->NutritionistMetadata->description ?? '' }}</textarea>
                                </div>
                            </div>
    ...
    $(document).ready(function() {
            ...
            rules: {
                ...
                email: {
                    ...
                    email: true,
                        // remote: {
                        //     type: "get",
                        //     url: "{{ route('check_nutritionist_email') }}",
                        //     data: {
                        //         "email": function() {
                        //             return $("#email").val();
                        //         },
                ...
                phone_number: {
                    ...
                    maxlength: 15,
                        ...
                        // remote: {
                        //     type: "get",
                        //     url: "{{ route('check_nutritionist_number') }}",
                        //     data: {
                        //         "number": function() {
                        //             return $("#txtPhone").val();
                        //         },
      ...
      errorPlacement: function(error, element) {
          if(element.attr("name") == "days[]"){
            error.appendTo($('#days_error_msg'));
        }else if(element.attr("name") == "specialization_id[]"){
          error.appendTo($('#specialization_error_msg'));
      }
      else{
...
}, "Opening & Closing time can't be equal");
...
<script type="text/javascript">
    ...
    $(".remove-pro-img").click(function(evt) {
        ...
        if (typeof attr !== 'undefined' && attr !== false) {
                // alert();
                // $.ajax({
                //     url:"{{ route('delete_nutritionist_profile') }}", 
                //     method: "POST",
                //     data: {
                //         'manager_id': attr,
                //         "_token": "{{ csrf_token() }}"
            ...
            swal({
                title: "Are you sure?",
                text: "Are you sure you want to  this delete image ?",
                type: "warning",
                showCancelButton: true,
            }, function(willDelete) {
                if (willDelete) {
