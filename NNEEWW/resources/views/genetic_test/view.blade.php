                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-xl-6 col-6 mb-3 ">
                                                    <div class="form-group ">
                                                        ...
                                                        <select disabled class="form-control" id="select" name="type">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                                    <div class="form-group"> <label>Amount </label>
                                                        <input readonly type="number" name="amount" class="form-control"
                                                ...
                                                <div class="col-md-6 mb-3">
                                                    <div class="form-group">
                                                        <label class="pb-2"> </i>Additional Information</label>
                                                        <div class="content_group"
                                                            style="background-color: #fff; border: 1px solid #ced4da; padding: 15px; border-radius: 5px;max-height: 100%;min-height: 60px;    border-radius: 10px;">
                                                            {!! $data->add_info !!}<div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-6 col-lg-6 col-xl-6 col-6">
                                                    <div class="list mb-3">
                                                        ...
                                                        <div class="list-img ">
                                                            <img src="{{ $data->image }}"
                                                                class="offer_image_box show-modal " current_image='pic_one'
                                                                style="height:130px;">
                                                        </div>
