                    ...
                    <div class="order_details">
                        <div class="card-main pt-3">
                            ...
                            <div class="card-body main_body form p-3">
                                ...
                                @endif
                                <form id="addCurrentOfferForm" method="post" action="{{ route('update_genetic_test') }}"
                                    enctype="multipart/form-data">
                                    @csrf

                                    <input type="hidden" name="genetic_test_id" value="{{ $data->id }}">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-xl-6 col-6 mb-3 ">
                                                    <div class="form-group ">
                                                        <label for="type">Test Type <span class="text-danger"> *</span>
                                                        </label>
                                                        <select class="form-control" id="select" name="type">
                                                            <option value="">Select Test Type</option>

                                                            @foreach ($genetic_test_type as $genetic_test_type)
                                                                <option
                                                                    {{ $genetic_test_type->value == $data->type ? 'selected' : '' }}
                                                                    value="{{ $genetic_test_type->value }}">
                                                                    {{ $genetic_test_type->name }}</option>
                                                            @endforeach
                                                ...
                                                <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                                    <div class="form-group"> <label>Amount<span class="text-danger">
                                                                *</span></label>
