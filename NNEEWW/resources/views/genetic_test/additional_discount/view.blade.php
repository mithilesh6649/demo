...
@section('title', 'Additional Test Discount Details')
                ...
                <div class="order_details">
                    <div class="card-main pt-3">
                        <div class="order_heading alert d-flex align-items-center justify-content-between mb-4">
                            <h3 class="mb-0">Additional Test Discount Details</h3>
                        ...
                        <div class="card-body main_body form p-3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="information_fields mb-0">
                                    <div class="row">
                                       ...
                                       <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                        <div class="form-group"> <label>  Any Test Related Discount 
                                        </label>
                                        <select disabled name="test_count" class="form-control" >
                               ...
                               <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                <div class="form-group"> <label>  All Test Related Discount 
                                </label>
                                <select disabled name="all_test_count" class="form-control" >
                      ...
                      <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                        <div class="form-group"> <label>@if($data->slug=='additional_traits') Additional Traits Amount  @else Amount @endif 
                        </label>
