                ...
                <div class="order_details">
                    <div class="card-main pt-3">
                        <div class="order_heading alert d-flex align-items-center justify-content-between mb-4">
                            <h3 class="mb-0">Additional Test Discount</h3>
                        ...
                        <div class="">
                            <table style="width:100%" id="pages-list" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    @foreach ($genetic_test_pricing as $genetic_test_price)

                                    <tr>
                                        <td class="display-none"></td>
                                        <td> 
                                        @if($genetic_test_price->slug =="any_two_pricing")
                                          Any Test Related Discount
                                        @elseif ($genetic_test_price->slug =="all_six_pricing")
                                          All Test Related Discount
                                        @else
                                            Additional Traits Related Discount
                                        @endif 
                                       ...
                                       <td> 
                                        @can('view_additional_test_discount')
                                             <a class="action-button" title="View"
                                                                href="{{ route('additional_test_discount_view', ['id' => $genetic_test_price->id]) }}"><i
                                                                    class="text-success fa fa-eye"></i></a>
                                            @endcan
                                            @can('edit_additional_test_discount')                        
                                               <a href="{{ route('additional_test_discount_edit', ['id' => $genetic_test_price->id]) }}"
