                    ...
                    <div class="order_details">
                        <div class="card-main pt-3">
                            <div class="order_heading alert d-flex align-items-center justify-content-between mb-4">
                                <h3 class="mb-0">Edit Consultation</h3>
                            ...
                            <div class="card-body main_body form p-3">
                                ...
                                <form id="EditSpecializationForm" method="post"
                                    action="{{ route('consultation.update') }}" enctype="multipart/form-data">
                                    @csrf

                                    <input type="hidden" name="consultation_id" value="{{ $data->id }}">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                                    <div class="form-group"> <label>Title <span class="text-danger"> *</span>
                                                        ...
                                                        <input type="text" name="name" class="form-control"
                                                            id="name" maxlength="100" value="{{ $data->type ?? '' }}">
                                                    </div>
                                                </div> 
 
                                                  <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                                    <div class="form-group"> <label>Description <span class="text-danger"> *</span>
                                                        </label>
                                                        <input type="text" name="description" class="form-control"
                                                            id="description" maxlength="100" value="{{ $data->description ?? '' }}">
                                                    </div>
                                                </div> 
                                            ...
                                            <div class="col-md-12 col-lg-12 col-xl-12 col-12 mb-3">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <label class="mb-0">Is Paid</label><input type="checkbox"
                                                        class="w-auto ml-2" name="is_paid" id="is_paid" {{$data->free != 1 ? 'checked':''}}>
                                                </div>


                                                 <div id="discountInput" class="{{$data->free != 1 ? '':'d-none'}}" 
                                            >
                                            <div class="row">
                                                <div class="col-sm-6">
                                                    <div class="form-group">
