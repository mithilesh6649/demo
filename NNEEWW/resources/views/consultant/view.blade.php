                ...
                <div class="order_details">
                    <div class="card-main pt-3">
                        <div class="order_heading alert d-flex align-items-center justify-content-between mb-4">
                            <h3 class="mb-0">Consultation Details</h3>
                                ...
                                <div class="information_fields mb-0">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                            ...
                                            id="name" maxlength="100" value="{{ $data->type ?? '' }}" readonly> 
                                        </div>
                                    </div> 
                                    ...
                                    <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                        ...
                                        <input type="text" name="name" class="form-control"
                                        id="name" maxlength="100" value="{{ $data->description ?? '' }}" readonly>
                                    </div>
                                </div> 
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form-group">
                                                    ...
                                                    <input readonly type="number"  name="discount" max="100"
