                ...
                <div class="order_details">
                    <div class="card-main pt-3">
                        ...
                        <div class="card-body main_body form p-3">
                            ...
                            @endif
                            <form id="addSpecializationForm" method="post" action="{{ route('food.save') }}"
                            enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="is_edamam_food_added" class="form-control"
                            id="is_edamam_food_added"  value="0" maxlength="100">
                            ...
                            <div class="card-body">
                                ...
                                @endif
                                <div class="row">
                                 <div class="col-md-4 text-success font-weight-bold">Food Details</div>
                             </div>
                             <hr>
                             <div class="information_fields mb-0">
                                ...
                                <div class="col-md-4 col-lg-4 col-xl-4 col-4 mb-3">
                                    ...
                                    *</span></label>
                                    ...
                                    id="brand_description" maxlength="100">
                                </div>
                            </div>
   ...
   <div class="form-group">
      ...
      *</span></label>
      <div class="food_value_unit_box">
         ...
         id="serving_type" maxlength="19" placeholder="Ex-Cup,Tablespoon">
...
<div class="col-md-12 text-success font-weight-bold">Macro Nutrients  <hr> </div>
...
<div class="col-md-2 col-lg-2 col-xl-2 col-2 mb-3">
    ...
    *</span></label>
    <div class="food_value_unit_box">
        ...
        <input type="number" name="total_fat" class="form-control"
        id="total_fat" maxlength="100">
...
<div class="col-md-2 col-lg-2 col-xl-2 col-2 mb-3">
    ...
    *</span></label>
    <div class="food_value_unit_box">
        <input type="number" name="total_carbohydrate" class="form-control"
        id="total_carbohydrate" maxlength="100">
...
<div class="col-md-12 text-success font-weight-bold"> Micro Nutrients  <hr> </div>

{{--


<div class="col-md-2 col-lg-2 col-xl-2 col-2 mb-3">
    <div class="form-group"> <label>Serving size in gram<span class="text-danger">
    *</span></label>
    <div class="food_value_unit_box">
        <input type="number" name="serving_size_in_gram" class="form-control"
        id="serving_size_in_gram" maxlength="100">
     <!--    <select class="form-control" name="calories_unit">
             <option class="text-center" value=""> Select Unit</option>
            @foreach($foodUnits as $foodUnit)
            <option class="text-center">{{$foodUnit->value}}</option>
...
<div class="col-md-2 col-lg-2 col-xl-2 col-2 mb-3">
    <div class="form-group"> <label>Serving container<span class="text-danger">
    *</span></label>
    <div class="food_value_unit_box">
        <input type="number" name="serving_container" class="form-control"
        id="serving_container" maxlength="100">
      <!--   <select class="form-control" name="calories_unit">
             <option class="text-center" value=""> Select Unit</option>
            @foreach($foodUnits as $foodUnit)
            <option class="text-center">{{$foodUnit->value}}</option>
...
<div class="col-md-2 col-lg-2 col-xl-2 col-2 mb-3">
    ...
    *</span></label>
    <div class="food_value_unit_box">
        <input type="number" name="saturated_fat" class="form-control"
        id="saturated_fat" maxlength="100">
...
<div class="col-md-2 col-lg-2 col-xl-2 col-2 mb-3">
    ...
    *</span></label>
    <div class="food_value_unit_box">
        <input type="number" name="polyunsaturated_fat" class="form-control"
        id="polyunsaturated_fat" maxlength="100">
...
<div class="col-md-2 col-lg-2 col-xl-2 col-2 mb-3">
    ...
    *</span></label>
    <div class="food_value_unit_box">
        <input type="number" name="monounsaturated_fat" class="form-control"
        id="monounsaturated_fat" maxlength="100">
...
<div class="col-md-2 col-lg-2 col-xl-2 col-2 mb-3">
    ...
    *</span></label>
    <div class="food_value_unit_box">
        <input type="number" name="added_sugar" class="form-control"
        id="added_sugar" maxlength="100">
...
<div class="col-md-2 col-lg-2 col-xl-2 col-2 mb-3">
    ...
    *</span></label>
    <div class="food_value_unit_box">
        <input type="number" name="sugar_alcohol" class="form-control"
        id="sugar_alcohol" maxlength="100">
...
<div class="col-md-2 col-lg-2 col-xl-2 col-2 mb-3">
    ...
    *</span></label>
    <div class="food_value_unit_box">
        <input type="number" name="vitamin_a" class="form-control"
        id="vitamin_a" maxlength="100">
...
<div class="col-md-2 col-lg-2 col-xl-2 col-2 mb-3">
    ...
    *</span></label>
    <div class="food_value_unit_box">
        <input type="number" name="vitamin_b_6" class="form-control"
        id="vitamin_b_6" maxlength="100">
...
<div class="col-md-2 col-lg-2 col-xl-2 col-2 mb-3">
    ...
    *</span></label>
    <div class="food_value_unit_box">
        <input type="number" name="vitamin_b_12" class="form-control"
        id="vitamin_b_12" maxlength="100">
...
<div class="col-md-2 col-lg-2 col-xl-2 col-2 mb-3">
    ...
    *</span></label>
    <div class="food_value_unit_box">
        <input type="number" name="vitamin_c" class="form-control"
        id="vitamin_c" maxlength="100">
...
<div class="col-md-2 col-lg-2 col-xl-2 col-2 mb-3">
    ...
    *</span></label>
    <div class="food_value_unit_box">
        <input type="number" name="vitamin_d" class="form-control"
        id="vitamin_d" maxlength="100">
