                    ...
                    <div class="order_details">
                        <div class="card-main pt-3">
                            <div class="order_heading alert d-flex align-items-center justify-content-between mb-4">
                                <h3 class="mb-0"> Testimonial Details</h3>
                                        ...
                                        <div class="information_fields mb-0">
                                            ...
                                            <div class="col-md-6 col-lg-6 col-xl-6 col-6 mb-3">
                                                    <div class="form-group"> <label>Rating </label>
                                                        <input type="text" name="name" class="form-control"
                                                            id="name" maxlength="100" value="{{ $data->rating ?? '' }}"
                                                            readonly>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-lg-6 col-xl-6 col-6 mb-3 ">
                                                   ...
                                                   <div class="col-md-6 col-lg-6 col-xl-6 col-6">
                                                    <div class="list mb-3">
                                                        <label>Weight Loss Before Image (500 x 300)</label>
                                                   ...
                                                   <div class="col-md-6 col-lg-6 col-xl-6 col-6">
                                                    <div class="list mb-3">
                                                        <label>Weight Loss After Image (500 x 300)</label>
