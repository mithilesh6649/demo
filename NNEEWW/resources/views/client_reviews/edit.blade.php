                    ...
                    <div class="order_details">
                        <div class="card-main pt-3">
                            ...
                            <div class="card-body main_body form p-3">
                                ...
                                @endif
                                <form id="addCurrentOfferForm" method="post" action="{{ route('client.review.update') }}"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="rating">Rating<span class="text-danger">
                                                                *</span></label>
                                                        <input autocomplete="off" type="number" name="rating"
                                                            class="form-control" id="rating" maxlength="100"
                                                            placeholder=" " value="{{ $data->rating ?? '' }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="descripiton">Description<span class="text-danger">
                                                                *</span></label>
                                                        <textarea name="descripiton" rows="1" style="width: 100%;border:1px solid #ced4da;">{{ $data->description ?? '' }}</textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6 col-lg-6 col-xl-6 col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="upload-img" style="position:relative;">
                                                            <!--    <a href="javascript:;" class="remove-pro-img {{ $data->image == null ? '' : 'd-none' }} "  style="display:block;position: absolute;right:-10px;top:16px;">
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <select class="form-control" id="select" name="status">
                                                            ...
                                                            @endforeach
                                                                 ...
                                                                 <div class="col-md-6 col-lg-6 col-xl-6 col-6">
                                                    <div class="form-group">
                                                        <label>Weight Loss Before Image (500 x 300)  
                                                        </label>
                                                        <span class="position-relative">
                                                            <input type="file" name="thumbnail_before"
                                                                class="thumbnail_pic_before input-file" onchange="readURL2(this);"
                                                                accept=".png, .jpg, .jpeg" class="form-control">
                                                        </span>
                                                        <div class="upload-img" style="position:relative;">
                                         
                                                            <img src="{{ $data->before_image }}" id="thumbnail_preview_before"
                                                                class="{{ $data->before_image != null ? '' : 'd-none' }}"
                                                                style="width:300;height:130px;">
                                                        </div>
                                                    </div>
                                                </div>
                                                             ...
                                                             <div class="col-md-6 col-lg-6 col-xl-6 col-6">
                                                    <div class="form-group">
                                                        <label>Weight Loss After Image (500 x 300)  
                                                        </label>
                                                        <span class="position-relative">
                                                            <input type="file" name="thumbnail_after"
                                                                class="thumbnail_pic_after input-file" onchange="readURL3(this);"
                                                                accept=".png, .jpg, .jpeg" class="form-control">
                                                        </span>
                                                        <div class="upload-img" style="position:relative;">
                                         
                                                            <img src="{{ $data->after_image }}" id="thumbnail_preview_after"
                                                                class="{{ $data->after_image != null ? '' : 'd-none' }}"
                                                                style="width:300;height:130px;">
                                                        </div>
                                                    </div>
                                                </div>  
...
@section('js')
                ...
                messages: {
                    ...
                    descripiton: {
                        required: "Descripiton  is required",
                         minlength:'Please enter at least 15 characters'
                    },
                    thumbnail: {
    ...
    <!-- show image on change -->
    <!-- show  before image on change -->
       
        <script type="text/javascript">
        var img_src = $('#thumbnail_preview_before').attr('src');
        ...
        function readURL2(input) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function(e) {
                    $('#thumbnail_preview_before').removeClass("d-none");
                    //   $(".remove-pro-img").removeClass("d-none");
                    $('#thumbnail_preview_before').attr('src', e.target.result);
                    let image_pre = document.getElementById('thumbnail_preview_before');
                    var width = image_pre.naturalWidth;
                    var height = image_pre.naturalHeight;
                    console.log(width);
                    console.log(height);
    ...
    <!-- show before image on change -->
        ...
        <!-- show  after image on change -->
       
        <script type="text/javascript">
        var img_src = $('#thumbnail_preview_after').attr('src');
        ...
        function readURL3(input) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function(e) {
                    $('#thumbnail_preview_after').removeClass("d-none");
                    //   $(".remove-pro-img").removeClass("d-none");
                    $('#thumbnail_preview_after').attr('src', e.target.result);
                    let image_pre = document.getElementById('thumbnail_preview_after');
                    var width = image_pre.naturalWidth;
                    var height = image_pre.naturalHeight;
                    console.log(width);
                    console.log(height);
