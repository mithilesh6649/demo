                    ...
                    <div class="order_details">
                        <div class="card-main pt-3">
                            ...
                            <div class="card-body main_body form p-3">
                                ...
                                @endif
                                <form id="addCurrentOfferForm" method="post" action="{{ route('client.review.save') }}"
                                               ...
                                               <div class="col-md-6 col-lg-6 col-xl-6 col-6 mb-3">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-xl-6 col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="upload-img" style="position:relative;">
                                                            <a href="javascript:;" class="remove-pro-img-before d-none "
                                                                style="display:block;position: absolute;right:-10px;top:-6px;">
                                                                <svg width="25" height="25" viewBox="0 0 257 256"
                                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <g clip-path="url(#clip0_2088_553)">
                                                            ...
                                                            <img src="" id="thumbnail_preview_before"
                                                                style="width:300;height:130px;display:none;">
                                                        </div>
                                                    </div>
                                                </div>
                                                  ...
                                                  <div class="col-md-6 col-lg-6 col-xl-6 col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="upload-img" style="position:relative;">
                                                            <a href="javascript:;" class="remove-pro-img-after d-none "
                                                                style="display:block;position: absolute;right:-10px;top:-6px;">
                                                                <svg width="25" height="25" viewBox="0 0 257 256"
                                                                    fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                    <g clip-path="url(#clip0_2088_553)">
                                                            ...
                                                            <img src="" id="thumbnail_preview_after"
                                                                style="width:300;height:130px;display:none;">
                                                        </div>
                                                    </div>
                                                </div>  
    ...
    <!-- Before -->
        ...
        function readURL2(input) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function(e) {
                    $('#thumbnail_preview_before').css('display', 'block');
                    $(".remove-pro-img-before").removeClass("d-none");
        ...
        $(".remove-pro-img-before").click(function(evt) {

            $(".remove-pro-img-before").addClass("d-none");
            $("#thumbnail_preview_before").css('display', 'none');

            $(".thumbnail_pic_before").val(null);
     ...
     <!-- After -->
        ...
        function readURL3(input) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function(e) {
                    $('#thumbnail_preview_after').css('display', 'block');
                    $(".remove-pro-img-after").removeClass("d-none");
        ...
        $(".remove-pro-img-after").click(function(evt) {

            $(".remove-pro-img-after").addClass("d-none");
            $("#thumbnail_preview_after").css('display', 'none');

            $(".thumbnail_pic_after").val(null);
