                        ...
                        <div class="card-main pt-3">
                            <div class="order_heading alert d-flex align-items-center justify-content-between mb-4">
                                <div class="d-flex align-items-center">
                                    <h3 class="mb-0"> Laboratory Edit</h3>
                                </div>
                            ...
                            <div class="card-body main_body form p-3">
                                ...
                                <form id="addLaboratoryForm" autocomplete="off" method="post",
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                                ...
                                                <div class="form-group">
                                                    <label for="lab_name">First Name <span class="text-danger"> *</span></label>
                                                    <input type="text" name="first_name" class="form-control"
                                                        id="first_name" maxlength="100"
                                                        value="{{ $LaboratoryData->first_name ?? '' }}"  >
                                                </div>
                                            </div>
                                             ...
                                             <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="last_name" class="form-control"
                                                            id="last_name" maxlength="100"  value="{{ $LaboratoryData->last_name ?? '' }}"  >
                                                    </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                *</span></label>
                                                ...
                                                id="email" maxlength="100" value="{{ @$LaboratoryData->LaboratoryMetadata->email ?? '--'}}">
                                            </div>
                                    ...
                                    <div class="col-6">
                                    <div class="form-group">
                                    <label for="password">Phone Number<span class="text-danger">
                                                *</span></label>

                                    <input type="tel" name="phone_number" class="form-control" id="txtPhone"
                                    value="{{@$LaboratoryData->LaboratoryMetadata->phone_number ?? '' }}"  >
                                    <input type="hidden" name="country_code" class="form-control" id="country_code"
                                    value="{{ @$LaboratoryData->LaboratoryMetadata->country_code ?? '' }}"   />
                                    </div>
                                    </div>
                                             ...
                                             <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="descripiton">Description<span class="text-danger">
                                                            *</span></label>
                                                    <textarea name="descripiton" rows="1" style="width: 100%;border:1px solid #ced4da;">{{ @$LaboratoryData->description ?? '' }}</textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                *</span></label>
                                                ...
                                                id="country" maxlength="100" value="{{ @$LaboratoryData->LaboratoryMetadata->country ?? '' }}" readonly>
                                            </div>
                                        </div>
                                            ...
                                            {{-- <div class="col-md-6 col-lg-6 col-xl-6 col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" name="thumbnail" class="thumbnail_pic"
                                            ...
                                            <div class="col-md-6 col-lg-6 col-xl-6 col-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="upload-img" style="position:relative;">
                                                        <!--    <a href="javascript:;" class="remove-pro-img {{ @$LaboratoryData->LaboratoryMetadata->image == null ? '' : 'd-none' }} "  style="display:block;position: absolute;right:-10px;top:16px;">
                                                        ...
                                                        <img src="{{ @$LaboratoryData->LaboratoryMetadata->image }}"
                                                            ...
                                                            class="{{ @$LaboratoryData->LaboratoryMetadata->image != null ? '' : 'd-none' }}"
                                            ...
                                            {{-- 
                                                <div>
                                                    <input type="checkbox" name="" id="addDiscount"> <label>Add
                                                        Discount</label>
                                                    <input type="checkbox" name="is_partner"> <label>Is Partner</label>
                                                </div> --}}
                                            ...
                                            <div class="d-flex align-items-center">
                                                <label class="mb-0">Add Discount</label>
                                                <input type="checkbox" name="" class="w-auto ml-2"
                                                    id="addDiscount"
                                    ...
                                    <div class="card-footer text-left mb-0">
                                        <button type="text" class="btn btn-primary common_btn">Update</button>
                                    </div>
                                </form>
