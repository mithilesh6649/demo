    ...
    <div class="col-md-12">
        <div class="card order_outer rounded_circle">
                ...
                <div class="order_details">
                    <div class="card-main pt-3">
                        ...
                        <div class="card-body main_body form p-3">
                            ...
                            <form id="EditUserForm" method="post" action="{{ route('update_user') }}" enctype="multipart/form-data">
                                @csrf
                                <span class="badge badge-danger p-2 mb-2 "> USER ID :  GHX-{{ @$User->id ?? '--'}} </span>
                                <div class="">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-12">
                                        <div class="profile-image-show mt-3">
                                            <a href="javascript:;"
                                            class="remove-pro-img {{  @$User->HealthStatus->image != null ? '' : 'd-none' }}"
                                            id="{{ @$User->HealthStatus->id ?? '' }}"
                                            style="display:block">
                                    ...
                                    class="{{ @$User->HealthStatus->image != null ? '' : 'd-none' }}"
                                    width="80%" id="profileImage">

                                    <div
                                    class="thumb_nails {{ @$User->HealthStatus->image != null ? 'd-none' : '' }}">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            id="txtPhone" value="{{ $User->phone_number ?? '' }}" />
                     ...
                     <div class="col-sm-6">
                           <div class="form-group">
                               ...
                               <input readonly type="text" name="Goal" class="form-control" id="Goal"
                               maxlength="100" placeholder="{{ @$goal->name ?? '--' }}">
                               @else
                               @endif
                               @endforeach
                               @else
                               <input readonly type="text" name="Goal2" class="form-control" id="Goal"
                               maxlength="100" placeholder="{{ @$goal->name ?? '--' }}">
                               @endif
                        ...
                        <div class="col-sm-6">
                           <div class="form-group">
                               ...
                               @endforeach
                               @else
                               <input readonly type="text" name="d" class="form-control" id="nasme"
                               maxlength="100" placeholder="{{ @$health_activity->name ?? '--' }}">
                               @endif
                    ...
                    <div class="col-6">
                        ...
                        <div class="col-sm-6">
                           <div class="form-group">
                               ...
                               <input readonly type="text" name="age" class="form-control" id="age"
                       ...
                       <div class="col-sm-6">
                           <div class="form-group">
                               ...
                               <input readonly type="text" name="Height" class="form-control" id="Height"
                               maxlength="100"
                       ...
                       <div class="col-sm-6">
                           <div class="form-group">
                               ...
                               <input readonly type="text" name="Weight" class="form-control" id="Weight"
                               maxlength="100"
                         ...
                         <div class="col-sm-6">
                           <div class="form-group">
                               ...
                               <input readonly type="text" name=" " class="form-control" id="bmi"
                         ...
                         <div class="col-sm-6">
                           <div class="form-group">
                               <label for="bmi">Target Weight</label>
                               <input readonly type="text" name=" " class="form-control" id="bmi"
                               maxlength="100" placeholder="{{ @$User->HealthStatus->target_weight ?? '--' }}  ">
                       ...
                       <div class="col-sm-6">
                           <div class="form-group">
                               <label for="Weekly">Weekly Goal</label>


                               @if (@$User->HealthStatus->weekly_goals)
                               @foreach ($weekly_goals as $goal)
                               @if ($goal->id == @$User->HealthStatus->weekly_goals)
                               <input readonly type="text" name="Weekly" class="form-control" id="name"
                               maxlength="100" placeholder="{{ @$goal->name ?? '--' }}">
                               @else
                               @endif
                               @endforeach
                               @else
                               <input readonly type="text" name="Weekly" class="form-control" id="Weeklys"
                               maxlength="100" placeholder="{{ @$goal->name ?? '--' }}">
                               @endif
                       ...
                       <div class="col-md-12">
                           <div class="form-group">
                               ...
                               <textarea name="address" class="form-control" rows="4"  >{{ @$User->HealthStatus->address ?? '--' }}</textarea>
                           </div>
                       </div>
                       ...
                       <div class="col-md-12">
                           <div class="form-group">
                               ...
                               <textarea name="bio" class="form-control" rows="4"  >{{ @$User->HealthStatus->bio ?? '--' }}</textarea>
                           </div>
                       </div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control" id="status">
                                ...
                                <option
                                @if ($User->UserAction == null) '' @else selected @endif
            ...
            <div class="card-footer">
                ...
                class="btn btn-primary">{{ __('adminlte::adminlte.update') }}</button>
            </div>
