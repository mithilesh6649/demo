                        ...
                        <table style="width:100%" id="deleted-users-list" class="table table-bordered table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th>First Name</th>
                                    <th>Last Name</th>
                                    @can('restore_user', 'delete_user_permanent')
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $deletedJobseekers[$i]->last_name ? $deletedJobseekers[$i]->last_name : '' }}
                                    </td>
                                    <td>
                                        @can('restore_user')
                                            <a class="action-button restore-button" title="Restore" href="javascript:void(0)"
                                                data-id="{{ $deletedJobseekers[$i]->id }}"><i
                                                    class="text-success fa fa-undo"></i></a>
                                        @endcan
                                        @can('delete_user_permanent')
                                            <a class="action-button remove-button" title="Permanent Delete"
                                                href="javascript:void(0)" data-id="{{ $deletedJobseekers[$i]->id }}"><i
