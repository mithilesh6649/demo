                    ...
                    <div class="order_details">
                        <div class="card-main pt-3">
                            ...
                            <div class="card-body main_body form p-3">
                                ...
                                @endif
                                <form id="addCurrentOfferForm" method="post" action="{{ route('blogs.update') }}"
                                        ...
                                        <div class="information_fields mb-0">
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <label for="description">Content<span class="text-danger">
                                                            *</span></label>
                                                ...
                                                <div class="col-md-6 col-lg-6 col-xl-6 col-6">
                                                    <div class="form-group">
                                                        <label>Image (900 x 600) <span class="text-danger"> *</span>
                                                        </label>
                                             ...
                                             <div class="col-md-6 col-lg-6 col-xl-6 col-6 mb-3 ">
                                                    ...
                                                    <div class="col-md-6 col-lg-6 col-xl-6 col-6 mb-3">
                            <div class="form-group"> <label>Author Name </label>
                            <input type="text" name="author_name" class="form-control"
                            id="name" maxlength="100" value="{{$data->author_name}}">
                        </div>
                    </div>
                      ...
                      <div class="col-md-6 col-lg-6 col-xl-6 col-6 mb-3">
                            ...
                            id="name" maxlength="100" value="{{$data->reviewer_name}}">
                        </div>
                    </div>
                            ...
                            <div class="d-flex align-items-center">
                                                    <input {{$data->is_show == 1 ? 'checked':''}} type="checkbox" name="is_show"
                                                        class="w-auto ml-2 mr-2" id="addDiscount"><label class="mb-0"> Image Show as a banner </label>
...
@section('js')
    ...
    CKEDITOR.replace('description', {
       // extraPlugins:'image2,dialog,widget',
        ...
        function readURL(input) {
            if (input.files && input.files[0]) {
                ...
                reader.onload = function(e) {
                    ...
                    //   text: "Please upload an image with 900 x 600   pixels dimension !",
                    //   type: "warning",
                    ...
                    // },
                    // function(){
                    //     //swal("Deleted!", "'Please upload an image with 900 x 600   pixels dimension'", "success");  
