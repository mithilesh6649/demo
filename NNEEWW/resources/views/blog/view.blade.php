                ...
                <div class="card-body rounded_circle table p-0 mb-0">
                    <div class="order_details">
                        <div class="card-main pt-3">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    <div class="form-group">
                                                        <label class="pb-2"> </i>Content</label>
                            ...
                            id="name" maxlength="100" value="{{$data->author_name}}" readonly>
                        </div>
                    </div>
                      ...
                      <div class="col-md-6 col-lg-6 col-xl-6 col-6 mb-3">
                            ...
                            id="name" maxlength="100" value="{{$data->reviewer_name}}" readonly>
                        </div>
                    </div>


                            <div class="d-flex align-items-center" style="pointer-events: none;">
                                                    <input readonly {{$data->is_show == 1 ? 'checked':''}} type="checkbox" name="is_show"
