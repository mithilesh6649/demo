                        ...
                        <div class="order_details">
                            <div class="card-main pt-3">
                                <div class="order_heading alert d-flex align-items-center justify-content-between mb-4">
                                    <h3 class="mb-0">{{ __('adminlte::adminlte.edit_admin') }}</h3>
                                ...
                                <div class="card-body main_body form p-3">
                                    ...
                                    @endif
                                    <form id="updateAdminForm" method="post" action="{{ route('update_admin') }}" enctype="multipart/form-data">
                                        @csrf
                                        ...
                                        <div class="profile-image-show mt-3">
                                            <a href="javascript:;"
                                            class="remove-pro-img {{ @$admin->image != null ? '' : 'd-none' }}"
                                            id="{{ @$admin->id ?? '' }}"
                                            style="display:block">
                                    ...
                                    <img src="{{ @$admin->image }}"
                                    class="{{ @$admin->image != null ? '' : 'd-none' }}"
                                    width="80%" id="profileImage">

                                    <div
                                    class="thumb_nails {{ @$admin->image != null ? 'd-none' : '' }}">
                            ...
                            class="{{ @$admin->image != null ? 'd-none' : '' }}">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="full_name">{{ __('adminlte::adminlte.name') }}<span
                                                                class="text-danger"> *</span></label>
                                                        <input type="text" name="full_name" class="form-control" id="full_name"
                                                            value="{{ ucfirst($admin->full_name) }}" maxlength="100"
                                                            autocomplete="nope">
                                                        @if ($errors->has('name'))
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="email">{{ __('adminlte::adminlte.email') }}<span
                                                                class="text-danger"> *</span></label>
                                                        <input type="text" name="email" class="form-control" id="email"
                                                            value="{{ $admin->email }}" maxlength="100">
                                                        @if ($errors->has('email'))
                                                   ...
                                                   <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="qualification" class="form-control" id="qualification"
                                                            maxlength="100"  value="{{ $admin->qualification ?? '' }}" autocomplete="nope">
                                                ...
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        <label for="role_id">{{ __('adminlte::adminlte.role') }}<span
                                                                class="text-danger"> *</span></label>
                                                        <select name="role_id" class="form-control" id="role_id">

                                                            <?php for ($i=0; $i < count($roles); $i++) { ?>
                                                            <option value="{{ $roles[$i]->id }}"
                                                                @if ($roles[$i]->id == $admin->role_id) selected @endif>
                                                                {{ $roles[$i]->name }}</option>
                                                            <?php } ?>
                                                        </select>
                                             ...
                                             <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        @if ($errors->has('status'))
                                                            <div class="error">{{ $errors->last('status') }}</div>
                                                        @endif
                                                    </div>
                                                </div>
    ...
    $(".remove-pro-img").click(function(evt) {
        ...
        if (typeof attr !== 'undefined' && attr !== false) {
            ...
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        url: "{{ route('delete_admin_profile') }}",
                        method: "POST",
                        data: {
                            'admin_id': attr,
                            "_token": "{{ csrf_token() }}"
