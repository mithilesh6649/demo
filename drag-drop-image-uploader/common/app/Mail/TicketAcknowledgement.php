...
class TicketAcknowledgement extends Mailable {
	...
	*/
	public function build() {
		$subject = $this->userType == 'sender' ? config('adminlte.ticket_acknowledgement_subject', 'Vocation Wizard Ticket Updates') : config('adminlte.ticket_acknowledgement_subject_receiver', 'Vocation Wizard Ticket Updates');
