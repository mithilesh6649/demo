      ...
      <div class="card">
        <div class="card-main">
          <div class="card-header alert d-flex justify-content-between align-items-center mx-0 pt-0">
            <h3>Deleted Sales & Petty Report</h3>
          </div>
        ...
        $('#select_branch').on('change',function(){
          var date_range = $('input[name="date_range"]').val('');
            var branch_id = $(this).val();
              $.ajax({
              url:"{{route('sales.petty.report.deleted.filter')}}",
              method:"POST",
              data:{
                    'branch_id':branch_id,
                    'with':'only_branch_id'
        ...
        $('.reset-button').on('click',function(e){
            ...
            e.preventDefault();
             ...
             $('#select_branch').val(0);
                   ...
                   $.ajax({
              url:"{{route('sales.petty.report.deleted.reset')}}",
              method:"POST",
              data:{
                    'branch_id':branch_id,
                    },
...
//Restore Users.........    
   ...
   $(document).on('click','.restore-button',function(){
      ...
      swal({
        ...
        if (willDelete) {
          $.ajax({
            url: "{{route('sales.petty.report.restore')}}",
            type: 'post',
            data: {
...
//Permanent Delete
   ...
   $(document).on('click','.delete-button',function(){
      ...
      swal({
        ...
        if (willDelete) {
          $.ajax({
            url: "{{route('sales.petty.report.delete.permanently')}}",
            type: 'post',
            data: {
