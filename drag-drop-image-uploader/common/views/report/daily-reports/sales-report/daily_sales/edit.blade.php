...
@section('title', 'Branch | Edit Daily Sales Reports')
                            ...
                            <div class="order_details">
                                <div class="card-main pt-3 m-0">
                                    <div class="card-header alert d-flex justify-content-between align-items-center mx-0 pt-0">
                                        <h3 class="mb-0">Edit Daily Sales Reports</h3>
                                        ...
                                        <form id="addReportForm" method="post"
                                            ...
                                            <table class="table border Responsive-table m-0">
                                                ...
                                                <tbody class="t_body">
                                                    ...
                                                    <tr>
                                                        <th>RV NO: <span class="manual_system"> </span>
                                                            <input type="text" step="any" name="rv_number"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input type="number" step="any" name="dine_in_restaurent"
                                                     ...
                                                     <tr>
                                                        ...
                                                        <a href="javascript:;"
                                                            ...
                                                            <input type="hidden" step="any" name="Complimentary"
                                                                class="Complimentary_inserted_values" id="Complimentary_inserted_values" value="{{ implode(',',@$complimentary) }}">

                                                        <input type="hidden" step="any" name="Complimentary_name" value="{{ implode(',',@$complimentary_name) }}">

                                                        <input type="hidden" step="any" name="Complimentary_contact" value="{{ implode(',',@$complimentary_contact) }}">
                                                        
                                                        <input type="hidden" step="any" name="Complimentary_invoice" value="{{ implode(',',@$complimentary_invoice) }}">
                                                        
                                                        <input type="hidden" step="any" name="Complimentary_amount" value="{{ implode(',',@$complimentary) }}" >
                                                        
                                                        <input type="hidden" step="any" name="Complimentary_ref" value="{{ implode(',',@$complimentary_ref) }}">
                                                    </td>
                                                        <td>
                                                        ...
                                                        <td class="last_number sale_content_box">
                                                           ...
                                                           {{ number_format($daily_report_sales->complimentary, 3, '.', '') }} </p>
                                                            <input type="hidden" step="any"
                                                                ...
                                                                maxlength="100" aria-invalid="false" value="{{$daily_report_sales->complimentary}}">
                                                        </td>
                                                    </tr>
                                        ...
                                        ?>
                                                    ...
                                                    <tr>
                                                       <td> <a href="javascript:;"
                                                        ...
                                                        <td class="last_number sale_content_box">
                                                            ...
                                                            {{ number_format(@$cheque_total, 3, '.', '') }}</p>
                                                            <input type="hidden" class="cheques_input_value gross_sum"
                                                    ...
                                                    <tr>
                                                       <td> <a href="javascript:;"
                                                        ...
                                                        <td class="last_number sale_content_box">
                                                            ...
                                                            {{ number_format(@$e_gift_card_total, 3, '.', '') }}</p>
                                                            <input type="hidden" class="cheques_input_value gross_sum"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="last_number sale_content_box">
                                                            ...
                                                            {{ number_format(@$cash_equivalent_c_total, 3, '.', '') }}</p>
                                                            <input type="hidden" class="cheques_input_value gross_sum"
                                                        ...
                                                        <td >
                                                            ...
                                                            <a href="javascript:;"
                                                                class="btn btn-success open_remarks_modal btn_ok m-0"><i
                                                                    class="fa fa-plus add_input"
                                                                    aria-hidden="true"></i>Remarks <span class="font-weight-bold text-white remark_counts_btn"> ( {{count($remarks_list)}} )</span></a>
                                 ...
                                 <div class="wrapper">
                                 <canvas id="signature-pad_2" class="signature-pad" width=400 height=200></canvas>
                                 </div>
                                 </div>
    ...
    <div class="modal fade" id="cheque_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" class="add_cheque_amounts">
                    <div class="model-back">
                        <div id="add_multiple_cheque" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                            @php  $i=0;@endphp
                            @forelse($cheque as $cheque_list)
                                 <span id="cheque_data_{{$i}}" class="card-list d-flex align-items-center mt-1"><input type="number" step="any" class="cheque_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="cheque_input_value_{{$i}}" data-id="{{$i}}" value="{{ number_format($cheque_list, 3, '.', '') }}"><a href="javascript:;" class="cheque_delete_icon delete_input_icon" id="{{$i}}"><i class="text-danger fa fa-trash-alt choice_remove_btn ml-2" style="font-size:16px;cursor:pointer"></i></a></span>

                            @php $i++; @endphp
                            @empty
                               <span id="cheque_data_0" class="card-list d-flex align-items-center mt-1"><input type="number" step="any" class="cheque_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="cheque_input_value_0" data-id="0"><a href="javascript:;" class="cheque_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt choice_remove_btn ml-2" style="font-size:16px;cursor:pointer"></i></a></span>
                            @endforelse

                        </div>

                        <div class="modal-footer d-flex align-items-center justify-content-center pb-0 px-0" style="margin-top: 16px;">
                            <div id="amex_add_btn" class="left_btn m-0">
                                <a href="javascript:;" class="btn btn-success add_cheque_total btn_ok_save">Save</a>
                            </div>
                            <div class="right_btn ml-2 my-0 mr-0">
                                <a href="javascript:;" class="add_card_input" id="add_cheque">
                                    Add
                                </a>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="printed_gift_card_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" class="add_printed_gift_card_amounts">
                    <div class="model-back">
                        <div id="add_multiple_printed_gift_card" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                         ...
                         @forelse($printed_gift_card as $printed_gift_list)
                            ...
                            <span id="printed_gift_card_data_{{$i}}" class="card-list d-flex align-items-center mt-1"><input type="number" step="any" class="printed_gift_card_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="printed_gift_card_input_value_{{$i}}" value="{{number_format($printed_gift_list, 3, '.', '') }}" data-id="{{$i}}"><a href="javascript:;" class="printed_gift_card_delete_icon delete_input_icon" id="{{$i}}"><i class="text-danger fa fa-trash-alt printed_gift_card_remove_btn ml-2" style="font-size:16px;cursor:pointer"></i></a></span>
                            @php $i++;@endphp
                           @empty
                            <span id="printed_gift_card_data_0" class="card-list d-flex align-items-center mt-1"><input type="number" step="any" class="printed_gift_card_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="printed_gift_card_input_value_0" data-id="0"><a href="javascript:;" class="printed_gift_card_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt printed_gift_card_remove_btn ml-2" style="font-size:16px;cursor:pointer"></i></a></span>
                           @endforelse
                        </div>

                        <div class="modal-footer d-flex align-items-center justify-content-center pb-0 px-0" style="margin-top: 16px;">
                            <div id="printed_add_btn" class="left_btn m-0">
                                <a href="javascript:;" class="btn btn-success add_printed_gift_card_total btn_ok_save">Save</a>
                            </div>
                            <div class="right_btn ml-2 my-0 mr-0">
                                <a href="javascript:;" class="add_card_input" id="add_printed_gift_card">
                                    Add
                                </a>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="E_gift_card_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" class="add_E_gift_card_amounts">
                    <div class="model-back">
                        <div id="add_multiple_E_gift_card" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                         ...
                         @forelse($e_gift_card as $e_gift_list)
                            ...
                            <span id="E_gift_card_data_{{$i}}" class="card-list d-flex align-items-center mt-1"><input type="number" value="{{number_format($e_gift_list, 3, '.', '')}}" step="any" class="E_gift_card_input_value input_card gross_sum margin-unset"  maxlength="100" aria-invalid="false" id="E_gift_card_input_value_{{$i}}" data-id="{{$i}}"><a href="javascript:;" class="E_gift_card_delete_icon delete_input_icon" id="{{$i}}"><i class="text-danger fa fa-trash-alt E_gift_card_remove_btn ml-2" style="font-size:16px;cursor:pointer"></i></a></span>
                           @php $i++; @endphp
                          @empty
                            <span id="E_gift_card_data_0" class="card-list d-flex align-items-center mt-1"><input type="number" step="any" class="E_gift_card_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="E_gift_card_input_value_0" data-id="0"><a href="javascript:;" class="E_gift_card_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt E_gift_card_remove_btn ml-2" style="font-size:16px;cursor:pointer"></i></a></span>
                          @endforelse
                        </div>

                        <div class="modal-footer d-flex align-items-center justify-content-center pb-0 px-0" style="margin-top: 16px;">
                            <div id="E_add_btn" class="left_btn m-0">
                                <a href="javascript:;" class="btn btn-success add_E_gift_card_total btn_ok_save">Save</a>
                            </div>
                            <div class="right_btn ml-2 my-0 mr-0">
                                <a href="javascript:;" class="add_card_input" id="add_E_gift_card">
                                    Add
                                </a>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="Coupon_gift_card_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" class="add_Coupon_gift_card_amounts">
                    <div class="model-back">
                        <div id="add_multiple_Coupon_gift_card" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                            ...
                            <span id="Coupon_gift_card_data_{{$i}}" class="card-list d-flex align-items-center mt-1"><input type="number" step="any" value="{{number_format($gift_coupon_list, 3, '.', '')}}" class="Coupon_gift_card_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="Coupon_gift_card_input_value_{{$i}}" data-id="{{$i}}"><a href="javascript:;" class="Coupon_gift_card_delete_icon delete_input_icon" id="{{$i}}"><i class="text-danger fa fa-trash-alt Coupon_gift_card_remove_btn ml-2" style="font-size:16px;cursor:pointer"></i></a></span>
                            @php $i++;@endphp
                          @empty
                             <span id="Coupon_gift_card_data_0" class="card-list d-flex align-items-center mt-1"><input type="number" step="any" class="Coupon_gift_card_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="Coupon_gift_card_input_value_0" data-id="0"><a href="javascript:;" class="Coupon_gift_card_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt Coupon_gift_card_remove_btn ml-2" style="font-size:16px;cursor:pointer"></i></a></span>
                          @endforelse
                        </div>

                        <div class="modal-footer d-flex align-items-center justify-content-center pb-0 px-0" style="margin-top: 16px;">
                            <div id="Coupon_add_btn" class="left_btn m-0">
                                <a href="javascript:;" class="btn btn-success add_Coupon_gift_card_total btn_ok_save">Save</a>
                            </div>
                            <div class="right_btn ml-2 my-0 mr-0">
                                <a href="javascript:;" class="add_card_input" id="add_Coupon_gift_card">
                                    Add
                                </a>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="cash_card_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" class="add_cash_card_amounts">
                    <div class="model-back">
                        <div id="add_multiple_cash_card" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                            ...
                            @forelse($cash_equivalent_c as $cash_equivalent_lsit)
                               ...
                               <span id="cash_card_data_{{$i}}" class="card-list d-flex align-items-center mt-1"><input type="number" step="any"  value="{{number_format($cash_equivalent_lsit, 3, '.', '')}}" class="cash_card_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="cash_card_input_value_{{$i}}" data-id="{{$i}}"><a href="javascript:;" class="cash_card_delete_icon delete_input_icon" id="{{$i}}"><i class="text-danger fa fa-trash-alt cash_card_remove_btn ml-2" style="font-size:16px;cursor:pointer"></i></a></span>
                             @php $i++;@endphp
                            @empty
                               <span id="cash_card_data_0" class="card-list d-flex align-items-center mt-1"><input type="number" step="any" class="cash_card_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="cash_card_input_value_0" data-id="0"><a href="javascript:;" class="cash_card_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt cash_card_remove_btn ml-2" style="font-size:16px;cursor:pointer"></i></a></span>
                            @endforelse

                        </div>

                        <div class="modal-footer d-flex align-items-center justify-content-center pb-0 px-0" style="margin-top: 16px;">
                            <div id="cash_add_btn" class="left_btn m-0">
                                <a href="javascript:;" class="btn btn-success add_cash_card_total btn_ok_save">Save</a>
                            </div>
                            <div class="right_btn ml-2 my-0 mr-0">
                                <a href="javascript:;" class="add_card_input" id="add_cash_card">
                                    Add
                                </a>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="talabat_credit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" class="add_talabat_credit_amounts">
                    <div class="model-back">
                        <div id="add_multiple_talabat_credit" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                            <span id="talabat_credit_data_0" class="card-list d-flex align-items-center mt-1">
                                ...
                                <input type="number" step="any" class="TMPtalabat_credit_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="talabat_credit_input_value_0" placeholder="TMP" data-id="0" value="{{number_format($talabat_credit_TMP_list, 3, '.', '')}}">
                                &nbsp;&nbsp;
                                @empty
                                 <input type="number" step="any" class="TMPtalabat_credit_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="talabat_credit_input_value_0" placeholder="TMP" data-id="0">
                                &nbsp;&nbsp;
                                @endforelse


                                @forelse($talabat_credit_TGO as $talabat_credit_TGO_list)
                                <input type="number" step="any" class="TGOtalabat_credit_input_value input_card gross_sum margin-unset" maxlength="100" value="{{number_format($talabat_credit_TGO_list, 3, '.', '')}}" aria-invalid="false" id="talabat_credit_input_value_0" data-id="0" placeholder="TGO">
                                   &nbsp;&nbsp;
                                @empty
                                 <input type="number" step="any" class="TGOtalabat_credit_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="talabat_credit_input_value_0" data-id="0" placeholder="TGO">
                                &nbsp;&nbsp;
                                @endforelse

                              

                                <!-- <a href="javascript:;" class="talabat_credit_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt talabat_credit_remove_btn" style="font-size:16px;cursor:pointer"></i></a> --></span>

                        </div>

                        <div class="modal-footer d-flex align-items-center justify-content-center pb-0 px-0" style="margin-top: 16px;">
                            <div id="talabat_credit_add_btn" class="left_btn m-0">
                                <a href="javascript:;" class="btn btn-success add_talabat_credit_card_total btn_ok_save">Save</a>
                            </div>
                            <!-- <div class="right_btn ml-2">
                                <a href="javascript:;" class="add_card_input" id="add_talabat_credit_card">
                                    Add
                                </a>
                            </div> -->
                        </div>
    ...
    <div class="modal fade" id="deliveroo_credit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" class="add_deliveroo_credit_amounts">
                    <div class="model-back">
                        <div id="add_multiple_deliveroo_credit" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                            ...
                            @forelse($deliveroo_credit_TMP as $deliveroo_credit_TMP_list)
                                <input type="number" step="any" class="TMPdeliveroo_credit_input_value input_card gross_sum margin-unset" maxlength="100" value="{{number_format($deliveroo_credit_TMP_list, 3, '.', '')}}" aria-invalid="false" id="deliveroo_credit_input_value_0" placeholder="TMP" data-id="0">
                                &nbsp;&nbsp;
                            @empty
                              <input type="number" step="any" class="TMPdeliveroo_credit_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="deliveroo_credit_input_value_0" placeholder="TMP" data-id="0">
                                &nbsp;&nbsp;
                            @endforelse

                            @forelse($deliveroo_credit_TGO as $deliveroo_credit_TGO_list)
                              <input type="number" step="any" class="TGOdeliveroo_credit_input_value input_card gross_sum margin-unset" maxlength="100" value="{{number_format($deliveroo_credit_TGO_list, 3, '.', '')}}" aria-invalid="false" id="deliveroo_credit_input_value_0" data-id="0" placeholder="TGO">
                              @empty
                              <input type="number" step="any" class="TGOdeliveroo_credit_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="deliveroo_credit_input_value_0" data-id="0" placeholder="TGO">
                            @endforelse
                                <!-- <a href="javascript:;" class="deliveroo_credit_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt deliveroo_credit_remove_btn" style="font-size:16px;cursor:pointer"></i></a> --></span>

                        </div>

                        <div class="modal-footer d-flex align-items-center justify-content-center pb-0 px-0" style="margin-top: 16px;">
                            <div id="deliveroo_credit_add_btn" class="left_btn m-0">
                                <a href="javascript:;" class="btn btn-success add_deliveroo_credit_card_total btn_ok_save">Save</a>
                            </div>
                            <!-- <div class="right_btn ml-2">
                                <a href="javascript:;" class="add_card_input" id="add_deliveroo_credit_card">
                                    Add
                                </a>
                            </div> -->
                        </div>
    ...
    <div class="modal fade" id="v_thru_credit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" class="add_v_thru_credit_amounts">
                    <div class="model-back">
                        <div id="add_multiple_v_thru_credit" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                            <span id="v_thru_credit_data_0" class="d-flex align-items-center mt-1">
                             ...
                             @forelse($v_thru_credit_TMP as $v_thru_credit_list)
                                <input type="number" step="any" class="TMPv_thru_credit_input_value input_card gross_sum margin-unset" maxlength="100" value="{{number_format($v_thru_credit_list, 3, '.', '')}}" aria-invalid="false" id="v_thru_credit_input_value_0" placeholder="TMP" data-id="0">
                             @empty
                                <input type="number" step="any" class="TMPv_thru_credit_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="v_thru_credit_input_value_0" placeholder="TMP" data-id="0">
                             @endforelse
                             &nbsp;&nbsp;
                            
                             @forelse($v_thru_credit_TGO as $v_thru_credit_TGO_list)
                                 <input type="number" step="any" class="TGOv_thru_credit_input_value input_card gross_sum margin-unset" maxlength="100" value="{{number_format($v_thru_credit_TGO_list, 3, '.', '')}}" aria-invalid="false" id="v_thru_credit_input_value_0" data-id="0" placeholder="TGO">
                              @empty
                                <input type="number" step="any" class="TGOv_thru_credit_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="v_thru_credit_input_value_0" data-id="0" placeholder="TGO">
                              @endforelse
                                <!-- <a href="javascript:;" class="v_thru_credit_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt v_thru_credit_remove_btn" style="font-size:16px;cursor:pointer"></i></a> --></span>

                        </div>

                       <div class="modal-footer d-flex align-items-center justify-content-center pb-0 px-0" style="margin-top: 16px;">
                            <div id="v_thru_credit_add_btn" class="left_btn m-0">
                                <a href="javascript:;" class="btn btn-success add_v_thru_credit_card_total btn_ok_save">Save</a>
                            </div>
                            <!-- <div class="right_btn ml-2">
                                <a href="javascript:;" class="add_card_input" id="add_v_thru_credit_card">
                                    Add
                                </a>
                            </div> -->
                        </div>
    ...
    <div class="modal fade" id="others_credit_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-xl modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" class="add_others_credit_amounts">
                    <div class="model-back">
                        <div id="add_multiple_others_credit" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                            <span id="others_credit_data_0" class="d-flex align-items-center mt-1">
                              ...
                              @forelse($others_credit_TMP as $others_credit_TMP_list)  
                                <input type="number" step="any" class="TMPothers_credit_input_value input_card gross_sum margin-unset" maxlength="100" value="{{number_format($others_credit_TMP_list, 3, '.', '')}}" aria-invalid="false" id="others_credit_input_value_0" placeholder="TMP" data-id="0">
                              @empty
                                <input type="number" step="any" class="TMPothers_credit_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="others_credit_input_value_0" placeholder="TMP" data-id="0">
                              @endforelse
                                &nbsp;&nbsp;
                              
                              @forelse($others_credit_TGO as $others_credit_TGO_list)
                                 <input type="number" step="any" class="TGOothers_credit_input_value input_card gross_sum margin-unset" maxlength="100" value="{{number_format($others_credit_TGO_list, 3, '.', '')}}" aria-invalid="false" id="others_credit_input_value_0" data-id="0" placeholder="TGO">
                              @empty
                                <input type="number" step="any" class="TGOothers_credit_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="others_credit_input_value_0" data-id="0" placeholder="TGO">
                              @endforelse
                                <!-- <a href="javascript:;" class="others_credit_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt others_credit_remove_btn" style="font-size:16px;cursor:pointer"></i></a> --></span>

                        </div>

                        <div class="modal-footer d-flex align-items-center justify-content-center pb-0 px-0" style="margin-top: 16px;">
                            <div id="others_credit_add_btn" class="left_btn m-0">
                                <a href="javascript:;" class="btn btn-success add_others_credit_card_total btn_ok_save">Save</a>
                            </div>
                            <!-- <div class="right_btn ml-2">
                                <a href="javascript:;" class="add_card_input" id="add_others_credit_card">
                                    Add
                                </a>
                            </div> -->
                        </div>
...
<div class="modal fade" id="remarks_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body" class="add_remarks_amounts">
                    <div class="model-back">
                        <div id="add_multiple_remarks" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                          ...
                          @forelse($remarks_list as $remarks_lists)
                            <div class="remarks_content w-100 d-flex align-items-center mt-3" id="remarks_{{$i}}">
                              <input type="text" class="form-control remarks_input_value" name="remarks[{{$i}}]" id="remarks" data-id="{{$i}}" value="{{$remarks_lists}}"><a href="javascript:;" class="remarks_delete_icon delete_input_icon" id="{{$i}}"><i class="text-danger fa fa-trash-alt choice_remove_btn" style="font-size:16px;cursor:pointer"></i></a>
                            </div>
                            @php $i++; @endphp
                          @empty
                            <div class="remarks_content w-100 d-flex align-items-center mt-3" id="remarks_0">
                             <input type="text" class="form-control remarks_input_value" name="remarks[0]" id="remarks" data-id="0"><a href="javascript:;" class="remarks_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt choice_remove_btn" style="font-size:16px;cursor:pointer"></i></a>
                           </div>
                          @endforelse
                        ...
                        <div class="modal-footer d-flex align-items-center justify-content-center pb-0 px-0" style="margin-top: 16px;">
                            <div id="dinner_add_btn" class="left_btn m-0">
                                <a href="javascript:;" class="btn btn-success add_remarks_total btn_ok_save">Save</a>
                            </div>
                            <div class="right_btn ml-2 my-0 mr-0">
                                <a href="javascript:;" class="add_card_input" id="add_remarks">
                                    Add
                                </a>
                            </div>
                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" class="add_amex_amounts">
                    ...
                    @forelse($amex as $amxvalue)
                       ...
                       <span id="amex_data_{{$i}}" class="card-list d-flex align-items-center mt-1"><input type="number" class="amex_input_value input_card gross_sum margin-unset" id="amex_input_value_{{$i}}" data-id="{{$i}}" value="{{number_format($amxvalue,3, '.', '')}}" maxlength="100" aria-invalid="false"><a href="javascript:;" class="amex_delete_icon delete_input_icon" id="{{$i}}"><i class="text-danger fa fa-trash-alt choice_remove_btn" style="font-size:16px;cursor:pointer"></i></a></span>
                    
                       @php $i++; @endphp
                     @empty
                        <span id="amex_data_0" class="card-list d-flex align-items-center mt-1"><input type="number" step="any" class="amex_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="amex_input_value_0" data-id="0"><a href="javascript:;" class="amex_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt choice_remove_btn ml-2" style="font-size:16px;cursor:pointer"></i></a></span>
                     ...
                     @endforelse
                        ...
                        <div class="modal-footer d-flex align-items-center justify-content-center pb-0 px-0" style="margin-top: 16px;">
                            <div id="amex_add_btn" class="left_btn m-0">
                                <a href="javascript:;" class="btn btn-success add_amex_total btn_ok_save">Save</a>
                            </div>
                            <div class="right_btn ml-2 my-0 mr-0">
                                <a href="javascript:;" class="add_card_input" id="add_amex">
                                    Add
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="model-back">
                        <div id="add_multiple_visa" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                            ...
                            <span id="visa_data_{{$i}}" class="card-list d-flex align-items-center mt-1"><input type="number" class="visa_input_value input_card gross_sum margin-unset" id="visa_input_value_{{$i}}" data-id="{{$i}}"  value="{{number_format($visavalue,3, '.', '')}}" maxlength="100" aria-invalid="false"><a href="javascript:;" class="visa_delete_icon delete_input_icon" id="{{$i}}"><i class="text-danger fa fa-trash-alt choice_remove_btn" style="font-size:16px;cursor:pointer"></i></a></span>
                               ...
                               @php $i++; @endphp
                             @empty
                               <span id="visa_data_0" class="card-list d-flex align-items-center mt-1"><input type="number" step="any" class="visa_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="visa_input_value_0" data-id="0"><a href="javascript:;" class="visa_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt choice_remove_btn ml-2" style="font-size:16px;cursor:pointer"></i></a></span>
                             @endforelse
                        ...
                        <div class="modal-footer d-flex align-items-center justify-content-center pb-0 px-0" style="margin-top: 16px;">
                            ...
                            <div id="visa_add_btn" class="left_btn m-0">
                                <a href="javascript:;" class="btn btn-success add_visa_total btn_ok_save">Save</a>
                            </div>
                            <div class="right_btn ml-2 my-0 mr-0">
                                <a href="javascript:;" class="add_card_input" id="add_visa">
                                    Add
                                </a>
                            </div>
                        </div>
                ...
                <div class="modal-body" class="add_master_amounts">
                    <div class="model-back">
                        <div id="add_multiple_master" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                             ...
                             @php $i++; @endphp
                             @empty
                               <span id="master_data_0" class="card-list d-flex align-items-center mt-1"><input type="number" step="any" class="master_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="master_input_value_0" data-id="0"><a href="javascript:;" class="master_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt choice_remove_btn ml-2" style="font-size:16px;cursor:pointer"></i></a></span>
                             @endforelse
                        </div>

                        <div class="modal-footer d-flex align-items-center justify-content-center pb-0 px-0" style="margin-top: 16px;">
                            <div id="master_add_btn" class="left_btn m-0">
                                <a href="javascript:;" class="btn btn-success add_master_total btn_ok_save">Save</a>
                            </div>
                            <div class="right_btn ml-2 my-0 mr-0">
                                <a href="javascript:;" class="add_card_input" id="add_master">
                                    Add
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="model-back">
                        <div id="add_multiple_dinner" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                            ...
                            @forelse($dinner as $dinner_value)
                               ...
                               <span id="dinner_data_{{$i}}" class="card-list d-flex align-items-center mt-1"><input type="number" class="dinner_input_value input_card gross_sum margin-unset" value="{{number_format($dinner_value,3, '.','')}}" id="dinner_input_value_{{$i}}" data-id="{{$i}}" maxlength="100" aria-invalid="false"><a href="javascript:;" class="dinner_delete_icon delete_input_icon" id="{{$i}}"><i class="text-danger fa fa-trash-alt choice_remove_btn ml-2" style="font-size:16px;cursor:pointer"></i></a></span>
                            
                               @php $i++; @endphp
                             @empty
                               <span id="dinner_data_0" class="card-list d-flex align-items-center mt-1"><input type="number" step="any" class="dinner_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="dinner_input_value_0" data-id="0"><a href="javascript:;" class="dinner_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt choice_remove_btn ml-2" style="font-size:16px;cursor:pointer"></i></a></span>
                             @endforelse
                        </div>

                        <div class="modal-footer d-flex align-items-center justify-content-center pb-0 px-0" style="margin-top: 16px;">
                            <div id="dinner_add_btn" class="left_btn m-0">
                                <a href="javascript:;" class="btn btn-success add_dinner_total btn_ok_save">Save</a>
                            </div>
                            <div class="right_btn ml-2 my-0 mr-0">
                                <a href="javascript:;" class="add_card_input" id="add_dinner">
                                    Add
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="model-back">
                        <div id="add_multiple_mm_online_link" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                            ...
                            @forelse($mm_online_link as $mm_online_link_value)
                               ...
                               <span id="mm_online_link_data_{{$i}}" class="card-list d-flex align-items-center mt-1"><input type="number" class="mm_online_link_input_value input_card gross_sum margin-unset" value="{{number_format($mm_online_link_value,3, '.','')}}" id="mm_online_link_input_value_{{$i}}" data-id="{{$i}}" maxlength="100" aria-invalid="false"><a href="javascript:;" class="mm_online_link_delete_icon delete_input_icon" id="{{$i}}"><i class="text-danger fa fa-trash-alt choice_remove_btn ml2" style="font-size:16px;cursor:pointer"></i></a></span>
                           
                               @php $i++; @endphp
                             @empty
                               <span id="mm_online_link_data_0" class="card-list d-flex align-items-center mt-1"><input type="number" step="any" class="mm_online_link_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="mm_online_link_input_value_0" data-id="0"><a href="javascript:;" class="mm_online_link_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt choice_remove_btn ml-2" style="font-size:16px;cursor:pointer"></i></a></span>
                             @endforelse
                        ...
                        <div class="modal-footer d-flex align-items-center justify-content-center pb-0 px-0" style="margin-top: 16px;">
                            <div id="mm_online_link_add_btn" class="left_btn m-0">
                                <a href="javascript:;" class="btn btn-success add_mm_online_link_total btn_ok_save">Save</a>
                            </div>
                            <div class="right_btn ml-2 my-0 mr-0">
                                <a href="javascript:;" class="add_card_input" id="add_mm_online_link">
                                    Add
                                </a>
                            </div>
                        </div>
                ...
                <div class="modal-body" class="add_Complimentary_amounts">
                    <div class="model-back">
                        ...
                        <?php 
                         ...
                         <div id="Complimentary_data_{{$i}}" class="d-flex align-items-center mt-1">
                          <span><input type="text" name="name" placeholder="Name" class="form-control Complimentary_input_name" value="{{@$complimentary_name[$i]}}" ></span>
                          <span><input type="number" name="contact" placeholder="Contact" class="form-control Complimentary_input_contact"  value="{{@$complimentary_contact[$i]}}"></span>
                          <span><input type="text" name="invoice" placeholder="invoce" class="form-control Complimentary_input_invoice"  value="{{@$complimentary_invoice[$i]}}"></span>
                          <span><input type="number" step="any" name="complimentary_amount"  placeholder="Amount" class="form-control Complimentary_input_value"  value="{{ number_format(@$complimentary_det, 3, '.', '') }}"></span>
                          <span><input type="text" name="ref"  value="{{@$complimentary_ref[$i]}}" placeholder="Ref" class="form-control Complimentary_input_ref" ></span>
                          <a href="javascript:;" class="Complimentary_delete_icon delete_input_icon" id="{{$i}}"><i
                         ...
                         @empty
                          ...
                          <span><input type="text" name="name"  placeholder="Name" class="form-control Complimentary_input_name"></span>
                          <span><input type="number" name="contact"  placeholder="Contact" class="form-control Complimentary_input_contact"></span>
                          <span><input type="text" name="invoice"  placeholder="invoce" class="form-control Complimentary_input_invoice"></span>
                          <span><input type="number" step="any"  name="complimentary_amount"  placeholder="Amount" class="form-control Complimentary_input_value"></span>
                          <span><input type="text" name="ref"  placeholder="Ref" class="form-control Complimentary_input_ref"></span>
                        ...
                        <div class="modal-footer d-flex align-items-center justify-content-center pb-0 px-0" style="margin-top: 16px;">
                            <div id="Complimentary_add_btn" class="left_btn m-0">
                    ...
                    <div class="model-back">
                        <div id="add_multiple_knet" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                            ...
                            @forelse($knet as $knet_value)
                               ...
                               <span id="knet_data_{{$i}}" class="card-list d-flex align-items-center mt-1"><input type="number" class="knet_input_value input_card gross_sum margin-unset" id="knet_input_value_{{$i}}" value="{{number_format($knet_value,3, '.','')}}" data-id="{{$i}}" maxlength="100" aria-invalid="false"><a href="javascript:;" class="knet_delete_icon delete_input_icon" id="{{$i}}"><i class="text-danger fa fa-trash-alt choice_remove_btn ml-2" style="font-size:16px;cursor:pointer"></i></a></span>
                            
                               @php $i++; @endphp
                             @empty
                               <span id="knet_data_0" class="card-list d-flex align-items-center mt-1"><input type="number" step="any" class="knet_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="knet_input_value_0" data-id="0"><a href="javascript:;" class="knet_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt choice_remove_btn ml-2" style="font-size:16px;cursor:pointer"></i></a></span>
                             @endforelse

                        </div>

                        <div class="modal-footer d-flex align-items-center justify-content-center pb-0 px-0" style="margin-top: 16px;">
                            <div id="knet_add_btn" class="left_btn m-0">
                                <a href="javascript:;" class="btn btn-success add_knet_total btn_ok_save">Save</a>
                            </div>
                            <div class="right_btn ml-2 my-0 mr-0">
                                <a href="javascript:;" class="add_card_input" id="add_knet">
                                    Add
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="model-back">
                        <div id="add_multiple_other" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                            ...
                            @forelse($other_cards as $other_cards_value)
                                ...
                                <span id="other_cards_data_{{$i}}" class="card-list d-flex align-items-center mt-1"><input type="number" class="other_input_value input_card gross_sum margin-unset" id="other_input_value_{{$i}}" value="{{number_format($other_cards_value,3, '.','')}}" data-id="{{$i}}" maxlength="100" aria-invalid="false"><a href="javascript:;" class="other_cards_delete_icon delete_input_icon" id="{{$i}}"><i class="text-danger fa fa-trash-alt choice_remove_btn ml-2" style="font-size:16px;cursor:pointer"></i></a></span>
                           
                               @php $i++; @endphp
                             @empty
                            <span id="other_cards_data_0" class="card-list d-flex align-items-center mt-1"><input type="number" step="any" class="other_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="other_input_value_0" data-id="0"><a href="javascript:;" class="other_cards_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt choice_remove_btn ml-2" style="font-size:16px;cursor:pointer"></i></a></span>
                             @endforelse
                        </div>

                        <div class="modal-footer d-flex align-items-center justify-content-center pb-0 px-0" style="margin-top: 16px;">
                            <div id="other_add_btn" class="left_btn m-0">
                                <a href="javascript:;" class="btn btn-success add_other_total btn_ok_save">Save</a>
                            </div>
                            <div class="right_btn ml-2 my-0 mr-0">
                                <a href="javascript:;" class="add_card_input" id="add_other">
                                    Add
                                </a>
                            </div>
                        </div>
...
<div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="exampleModalLongTitle">Upload Document</h4>
      ...
      <div class="modal-body">
         <div class="model-back">
            <form id="invoice_document_upload" > 
              <div class="row">
                <div class="col-12 invoice_input mb-3">
                    <div class="form-group mt-0">
                      <label class="form-label" for="upload_daily_sales">Invoice Domain </label>
                      <select class="form-control" name="upload_daily_sales_invoice_domain" id="upload_daily_sales_invoice_domain"> 

                        @forelse ($daily_invoice_types as $daily_invoice_type)
 
                         <option {{$daily_invoice_type->id}}  value="{{$daily_invoice_type->value}}">
                            {{$daily_invoice_type->name}}
                         </option>

                        @empty
                            <option disabled>
                              Please add invoice domain
                         </option>
                        @endforelse
                         <!-- <option value="discount">
                            Discount
                ...
                <div class="col-12 invoice_inputtwo">
                  <div class="form-group mt-0 mb-3">
                     <label class="form-label">Doc Image <span class="text-danger">*</span></label>
                     <input type="file" id="uploadFileInput" name="uploadFile" class="form-control" onchange="readURL(this);"  accept="image/*,application/pdf">
                     <input type="hidden" id="daily_sales_report_id" value="{{$daily_report_sales->id}}" name="daily_sales_report_id">
                      <input type="hidden" id="branch_id" value="{{$daily_report_sales->branch_id}}" name="branch_id">
                  </div>
                    <div class="row">
                        <img src="" id="thumbnail_preview" style="width:300;height:130px;display:none;">
                        <a href=" " id="thumbnail_preview_pdf"  target="_blank"   style="display:none;">
                        <i class="fas fa-file-pdf fa-10x text-danger" style="font-size:120px;"></i>
                        </a>
                    </div>
                </div>
              </div>
              <div class="modal-footer justify-content-end added pt-0 px-0">
                  <button type="submit" class="btn btn-sm btn_clr document_upload_submit btn-success m-0">Save</button>
              </div>
            </form>
            
            <div class="upload_wrapper">
                <form id="invoice_document_edit" class="d-none">          
                <div class="row">
                   <div class="col-12 invoice_input mb-3">
                    <div class="form-group mt-0">
                          <label class="form-label" for="upload_daily_sales">Invoice Domain</label>
                          <select class="form-control" name="upload_daily_sales_invoice_domain" id="update_doc_select"> 
                          <!--    <option value="discount">
                                Discount
                             </option>
                             <option value="complimentary">
                   ...
                   <div class="col-12 invoice_inputtwo">
                      <div class="form-group mt-0">
                         <label class="form-label">Doc Image <span class="text-danger">*</span></label>
                         <input type="file" id="uploadFileInput"  onchange="readURL2(this);"  name="uploadFile" class="form-control" accept="image/*,application/pdf">
                         <input type="hidden" id="invoice_id"   name="invoice_id">
                      </div>
                   </div>
                   <div class="col-12 invoice_inputthree">
                       <div class="invoice_update w-100 d-flex align-items-center justify-content-between">
                           <div id="invoice_document_edit_container"></div>
                            <div class="row">
                              <img src="" id="thumbnail_preview2" style="width:300;height:130px;display:none;">
                                <a href="" id="thumbnail_preview_pdf2"  target="_blank"   style="display:none;">
                                  <i class="fas fa-file-pdf fa-10x text-danger" style="font-size:120px;"></i>
                                </a>
                            </div>
                            <div class="btn-group">
                              <button type="submit" class="update button btn_bg_color text-white">Update</button>
                              <button type="button" class="cancel" id="add_new_invoice">Cancel</button>
                            </div> 
                       </div> 
                   </div>
                </div>
...
<script type="text/javascript">
 ...
 //start date section in input feild
   ...
   $(document).ready(function() {
        ...
        let cash_in_hand_actual = {{$daily_report_sales->cash_in_hand_actual >0 ?number_format($daily_report_sales->cash_in_hand_actual,3, '.', '') :0}};
            ...
            function Complimentary_card_sum()
            {
                sum_40=0;
                sum_41 = 0;
                ...
                gross_sale2=sum_41+sum_40; 
                console.log(gross_sale2)    
                $("#show_gross_sale").text('KD' + ' ' + gross_sale2.toFixed(3));
                $('#gross_sale').val(gross_sale2.toFixed(3));
                $("#show_discount_return").text('KD' + ' ' + Number(sum_41).toFixed(3));
                $('#discount_return').val(Number(sum_41).toFixed(3));
                
                 $('#show_net_sale').text('KD' + ' ' +sum_40.toFixed(
                    3));
                $('#net_sale').val(sum_40.toFixed(3));
        ...
        let Complimentary_sum={{@$complimentary_sum??0}};
        ...
        let Complimentary_array= {!! json_encode($complimentary) !!};
        ...
        let Complimentary_count={{count($complimentary)>0?count($complimentary):1}};
        ...
        // Complimentary //
            ...
            $('#add_Complimentary').click(function(e) {
                
                Complimentary_count++;
                $('#add_multiple_Complimentary').append(
                     
                     '<div id="Complimentary_data_'+Complimentary_count+'" class="d-flex align-items-center mt-1"><span><input type="text" name="name" placeholder="Name" class="form-control Complimentary_input_name"></span> <span><input type="number" name="contact" placeholder="Contact" class="form-control Complimentary_input_contact"></span><span><input type="text" name="invoice" placeholder="invoce" class="form-control Complimentary_input_invoice"></span><span><input type="number" name="complimentary_amount"  placeholder="Amount" class="form-control Complimentary_input_value"></span><span><input type="text" name="ref" placeholder="Ref" class="form-control Complimentary_input_ref"></span><a href="javascript:;" class="Complimentary_delete_icon delete_input_icon" id="'+Complimentary_count+'"><i class="text-danger fa fa-trash-alt choice_remove_btn ml-2" style="font-size:16px;cursor:pointer"></i></a></div>'

                );
                $('#Complimentary_input_value_' + Complimentary_count).focus();
            });

            // add input box on tab click
            // $("#Complimentary_modal").keyup(function(e) {
            ...
            $("#Complimentary_modal").keyup(function(e) {
                ...
                $("input[class *= 'Complimentary_input_ref']").each(function() {
                    if ($(this).val() == '') {
                        flag2 = 1;
                        $(this).focus();
                       }
                ...
                $("input[class *= 'Complimentary_input_value']").each(function() {
                    if ($(this).val() == '') {
                        flag = 1;
                        $(this).focus();
                        }
                ...
                $("input[class *= 'Complimentary_input_invoice']").each(function() {
                    if ($(this).val() == '') {
                        flag3 = 1;
                        $(this).focus();
                       }
                ...
                $("input[class *= 'Complimentary_input_contact']").each(function() {
                    if ($(this).val() == '') {
                         flag4 =1;
                         $(this).focus();
                        }
                ...
                $("input[class *= 'Complimentary_input_name']").each(function() {
                    if ($(this).val() == '') {
                        flag1 = 1;
                        $(this).focus();
                      }
                ...
                if (flag4 == 0 && flag3 == 0 && flag2 == 0 && flag1 == 0 && flag == 0 ) {
                    Complimentary_count++;
                    $('#add_multiple_Complimentary').append(
                         '<div id="Complimentary_data_'+Complimentary_count+'" class="d-flex align-items-center mt-1"><span><input type="text" name="name" placeholder="Name" class="form-control Complimentary_input_name"></span> <span><input type="number" name="contact" placeholder="Contact" class="form-control Complimentary_input_contact"></span><span><input type="text" name="invoice" placeholder="invoce" class="form-control Complimentary_input_invoice"></span><span><input type="number" name="complimentary_amount"  placeholder="Amount" class="form-control Complimentary_input_value"></span><span><input type="text" name="ref" placeholder="Ref" class="form-control Complimentary_input_ref"></span><a href="javascript:;" class="Complimentary_delete_icon delete_input_icon" id="'+Complimentary_count+'"><i class="text-danger fa fa-trash-alt choice_remove_btn ml-2" style="font-size:16px;cursor:pointer"></i></a></div>'
                    );
                    $('.Complimentary_input_name').focus();
                    //$('#Complimentary_input_value_' + Complimentary_count).focus();
                }
              }
            });
            ...
            $(document).on("click", ".Complimentary_delete_icon", function() {
                let id = $(this).attr('id');
                $('#Complimentary_data_' + id).remove();
                ...
                $("input[class *= 'Complimentary_input_value']").each(function() {
                    Complimentary_sum += +$(this).val();
                    Complimentary_array.push($(this).val());
                });

                if (Complimentary_sum != 0) {
                    Complimentary();
                } else {
                    $('#Complimentary_card_show').text('0.000');
                    $('#Complimentary').val(0);
                    $('#total_entries_Complimentary').text('');
                    Complimentary_card_sum();
                    closing_balance();
                }
            ...
            $(document).on("keyup", ".Complimentary_input_value", function() {
            ...
            $(document).on("click", '.add_Complimentary_total', function() {
                ...
                $("input[class *= 'Complimentary_input_invoice']").each(function() {
                    if ($(this).val() == '') {
                        ...
                        $(this).focus();
                        toastr.remove();
                        toastr.error('Invoice is required');
                    }
                });
                ...
                $("input[class *= 'Complimentary_input_contact']").each(function() {
                    ...
                    else
                    {
                        ...
                        if(!regex.test($(this).val())){
                          ...
                          $(this).focus();
                          toastr.remove();
                          toastr.error('Phone number must be 8 digits long starting with 5,6 or 9.');
                        }
                    }
                });
            ...
            function Complimentary() {
                ...
                let complimentary_name=[];
                let complimentary_contact=[];
                let complimentary_invoice=[];
                let complimentary_amount=[];
                let complimentary_ref=[];

                $("input[name = 'Complimentary']").val(Complimentary_array.filter((a) => a));

                $('#Complimentary_card_show').text(Number(Complimentary_sum).toFixed(3));
                $('#Complimentary').val(Number(Complimentary_sum).toFixed(3));
                // $('#add_multiple_knet').html('');
                // $('#knet_add_btn').html('');
                if (Complimentary_array.filter((a) => a).length > 0) {
                    $('#total_entries_Complimentary').text(Complimentary_array.filter((a) => a).length + ' ' + 'SLIPS');
                } else {
                    $('#total_entries_Complimentary').text('');
                }
                ...
                $("input[class *= 'Complimentary_input_ref']").each(function() {
                    if ($(this).val() != ''){
                        complimentary_ref.push($(this).val());
                    }
                ...
                $("input[class *= 'Complimentary_input_value']").each(function() {
                    if ($(this).val()!= ''){
                        complimentary_amount.push($(this).val());
                    }
                });

                $("input[class *= 'Complimentary_input_invoice']").each(function() {
                    if ($(this).val() != ''){
                        complimentary_invoice.push($(this).val());
                    }
                });
                    ...
                    if ($(this).val() != ''){
                        ...
                        if(!regex.test($(this).val())){
                          ...
                          toastr.error('Phone number must be 8 digits long starting with 5,6 or 9.');
                            ...
                            complimentary_contact.push($(this).val());
                        }
                    }
                });
                ...
                $("input[class *= 'Complimentary_input_name']").each(function() {
                    if ($(this).val() != ''){
                        complimentary_name.push($(this).val());
                    }
                });

                $("input[name = 'Complimentary_name']").val(complimentary_name.filter((a) => a));
                $("input[name = 'Complimentary_contact']").val(complimentary_contact.filter((a) => a));
                $("input[name = 'Complimentary_invoice']").val(complimentary_invoice.filter((a) => a));
                $("input[name = 'Complimentary_amount']").val(complimentary_amount.filter((a) => a));
                $("input[name = 'Complimentary_ref']").val(complimentary_ref.filter((a) => a));
         ...
         //remarks
          $(document).on("click", '.add_remarks_total', function() {
           ...
           $('#number_count_remarks').text(remarks_arr.length+' Remarks');
            ...
            if (flag == 0) {
                $('.modal').modal('hide');
                  $('.remark_counts_btn').html( "( "+remarks_arr.length+" )");
            }
 ...
 $(document).on('click','.edit_btn_doc',function(e){  
  ...
  $(document).ready(function(){
     ...
     $(document).on('keypress', '#talabat_credit_modal,#deliveroo_credit_modal,#v_thru_credit_modal,#others_credit_modal,#Complimentary_modal', function(e) {
            var keyCode = e.keyCode || e.which;
            if (keyCode === 13) {
