                                ...
                                <div class="card-main pt-3">
                                    ...
                                    <div class="Branch-statement branch_wrapper">
                                                ...
                                                <tbody class="t_body">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th class="thead_two text-center">Date: <span class="manual_system">
                                                                <input type="text" name="date_range" id="report_date"
                                                                    value=" {{ date('d/m/Y', strtotime($daily_report_sales->report_date)) }}"
                                                                    readonly>
                                        ...
                                        ?>
                                                    ...
                                                    <tr>
                                                       <td> <a href="javascript:;"
                                                                class="btn btn-success open_cheque_modal btn_ok"><i
                                                                    class="fa fa-plus add_input"
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td> 
                                                        <a href="javascript:;"
                                                                class="btn btn-success open_printed_gift_card_modal btn_ok"><i
                                                                    class="fa fa-plus add_input"
                                                                    aria-hidden="true"></i>Printed Gift Card</a>
                                                        ...
                                                        <td>
                                                            <p class="total_entries_printed_gift_card amount-sale field_add_text"
                                                                id="total_entries_printed_gift_card"> {{ count(@$printed_gift_card) }}
                                                                Slip(s) </p>
                                                        </td>
                                                        <td class="last_number sale_content_box">
                                                    ...
                                                    <tr>
                                                       <td> <a href="javascript:;"
                                                                class="btn btn-success open_E_gift_card_modal btn_ok"><i
                                                                    class="fa fa-plus add_input"
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td> <a href="javascript:;"
                                                            class="btn btn-success open_Coupon_gift_card_modal btn_ok"><i
                                                                class="fa fa-plus add_input"
                                                                aria-hidden="true"></i>Gift Coupon/Voucher</a>
                                                    ...
                                                    <tr>
                                                        <td> <a href="javascript:;"
                                                                class="btn btn-success open_cash_card_modal btn_ok"><i
                                                                    class="fa fa-plus add_input"
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td> 
                                                        <a href="javascript:;"
                                                            class="btn btn-success open_talabat_credit_modal btn_ok"><i
                                                                class="fa fa-plus add_input"
                                                        ...
                                                        <td>
                                                            <p class="total_entries_talabat_credit amount-sale field_add_text" 
                                                    ...
                                                    <tr>
                                                      ...
                                                      <td> 
                                                        <a href="javascript:;"
                                                            class="btn btn-success open_deliveroo_credit_modal btn_ok"><i
                                                                class="fa fa-plus add_input"
                                                        ...
                                                        <td>
                                                            <p class="total_entries_deliveroo_credit amount-sale field_add_text"
                                                    ...
                                                    <tr>
                                                        <td> 
                                                        <a href="javascript:;"
                                                            class="btn btn-success open_v_thru_credit_modal btn_ok"><i
                                                                class="fa fa-plus add_input"
                                                        ...
                                                        <td>
                                                            <p class="total_entries_v_thru_credit amount-sale field_add_text"
                                                    ...
                                                    <tr>
                                                       <td> 
                                                        <a href="javascript:;"
                                                            class="btn btn-success open_others_credit_modal btn_ok"><i
                                                                class="fa fa-plus add_input"
                                                        ...
                                                        <td>
                                                            <p class="total_entries_others_credit amount-sale field_add_text"
                                                    ...
                                                    <tr class="table_second_heading sale_content">
                                                        <td >
                                                            ...
                                                            <a href="javascript:;"
                                                                class="btn btn-success open_remarks_modal btn_ok"><i
                                                                    class="fa fa-plus add_input"
                    ...
                    <div class="model-back">
                        <div id="add_multiple_cheque" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                            ...
                            @forelse($cheque as $cheque_list)
                                 <span id="cheque_data_{{$i}}" class="d-flex align-items-center mt-1"><input type="number" step="0.01" class="cheque_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="cheque_input_value_{{$i}}" data-id="{{$i}}" value="{{ number_format($cheque_list, 3, '.', '') }}"><a href="javascript:;" class="cheque_delete_icon delete_input_icon" id="{{$i}}"><i class="text-danger fa fa-trash-alt choice_remove_btn" style="font-size:16px;cursor:pointer"></i></a></span>

                            @php $i++; @endphp
                            @empty
                               <span id="cheque_data_0" class="d-flex align-items-center mt-1"><input type="number" step="0.01" class="cheque_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="cheque_input_value_0" data-id="0"><a href="javascript:;" class="cheque_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt choice_remove_btn" style="font-size:16px;cursor:pointer"></i></a></span>
                            @endforelse

                        </div>

                        <div class="d-flex align-items-center justify-content-center">
                            <div id="amex_add_btn" class="left_btn">
                    ...
                    <div class="model-back">
                        <div id="add_multiple_cash_card" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                            ...
                            @forelse($cash_equivalent_c as $cash_equivalent_lsit)
                               ...
                               <span id="cash_card_data_{{$i}}" class="d-flex align-items-center mt-1"><input type="number" step="0.01"  value="{{number_format($cash_equivalent_lsit, 3, '.', '')}}" class="cash_card_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="cash_card_input_value_{{$i}}" data-id="{{$i}}"><a href="javascript:;" class="cash_card_delete_icon delete_input_icon" id="{{$i}}"><i class="text-danger fa fa-trash-alt cash_card_remove_btn" style="font-size:16px;cursor:pointer"></i></a></span>
                             @php $i++;@endphp
                            @empty
                               <span id="cash_card_data_0" class="d-flex align-items-center mt-1"><input type="number" step="0.01" class="cash_card_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="cash_card_input_value_0" data-id="0"><a href="javascript:;" class="cash_card_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt cash_card_remove_btn" style="font-size:16px;cursor:pointer"></i></a></span>
                            @endforelse

                        </div>

                        <div class="d-flex align-items-center justify-content-center">
                            <div id="cash_add_btn" class="left_btn">
                ...
                <div class="modal-body" class="add_talabat_credit_amounts">
                    <div class="model-back">
                        <div id="add_multiple_talabat_credit" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                            <span id="talabat_credit_data_0" class="d-flex align-items-center mt-1">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <div id="talabat_credit_add_btn" class="left_btn">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" class="add_deliveroo_credit_amounts">
                    <div class="model-back">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <div id="deliveroo_credit_add_btn" class="left_btn">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" class="add_v_thru_credit_amounts">
                    <div class="model-back">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <div id="v_thru_credit_add_btn" class="left_btn">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" class="add_others_credit_amounts">
                    <div class="model-back">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <div id="others_credit_add_btn" class="left_btn">
...
<div class="modal fade" id="remarks_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" class="add_remarks_amounts">
                    <div class="model-back">
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <div id="dinner_add_btn" class="left_btn">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" class="add_amex_amounts">
                    ...
                    @forelse($amex as $amxvalue)
                       ...
                       <span id="amex_data_{{$i}}" class="d-flex align-items-center mt-1"><input type="number" class="amex_input_value input_card gross_sum margin-unset" id="amex_input_value_{{$i}}" data-id="{{$i}}" value="{{number_format($amxvalue,3, '.', '')}}" maxlength="100" aria-invalid="false"><a href="javascript:;" class="amex_delete_icon delete_input_icon" id="{{$i}}"><i class="text-danger fa fa-trash-alt choice_remove_btn" style="font-size:16px;cursor:pointer"></i></a></span>
                    
                       @php $i++; @endphp
                     @empty
                        <span id="amex_data_0" class="d-flex align-items-center mt-1"><input type="number" step="0.01" class="amex_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="amex_input_value_0" data-id="0"><a href="javascript:;" class="amex_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt choice_remove_btn" style="font-size:16px;cursor:pointer"></i></a></span>
                ...
                <div class="modal-body" class="add_visa_amounts">
                    <div class="model-back">
                        <div id="add_multiple_visa" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                            ...
                            <span id="visa_data_{{$i}}" class="d-flex align-items-center mt-1"><input type="number" class="visa_input_value input_card gross_sum margin-unset" id="visa_input_value_{{$i}}" data-id="{{$i}}"  value="{{number_format($visavalue,3, '.', '')}}" maxlength="100" aria-invalid="false"><a href="javascript:;" class="visa_delete_icon delete_input_icon" id="{{$i}}"><i class="text-danger fa fa-trash-alt choice_remove_btn" style="font-size:16px;cursor:pointer"></i></a></span>

                               @php $i++; @endphp
                             @empty
                               <span id="visa_data_0" class="d-flex align-items-center mt-1"><input type="number" step="0.01" class="visa_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="visa_input_value_0" data-id="0"><a href="javascript:;" class="visa_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt choice_remove_btn" style="font-size:16px;cursor:pointer"></i></a></span>
                             @endforelse
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            ...
                            <div id="visa_add_btn" class="left_btn">
                    ...
                    <div class="model-back">
                        <div id="add_multiple_master" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                            ...
                            @forelse($master as $master_value)
                                 ...
                                 <span id="master_data_{{$i}}" class="d-flex align-items-center mt-1"><input type="number" class="master_input_value input_card gross_sum margin-unset" value="{{number_format($master_value,3, '.','')}}" id="master_input_value_{{$i}}" data-id="{{$i}}" maxlength="100" aria-invalid="false"><a href="javascript:;" class="master_delete_icon delete_input_icon" id="{{$i}}" ><i class="text-danger fa fa-trash-alt choice_remove_btn" style="font-size:16px;cursor:pointer"></i></a></span>
                             
                               @php $i++; @endphp
                             @empty
                               <span id="master_data_0" class="d-flex align-items-center mt-1"><input type="number" step="0.01" class="master_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="master_input_value_0" data-id="0"><a href="javascript:;" class="master_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt choice_remove_btn" style="font-size:16px;cursor:pointer"></i></a></span>
                             @endforelse

                        </div>

                        <div class="d-flex align-items-center justify-content-center">
                            <div id="master_add_btn" class="left_btn">
    ...
    <div class="modal fade" id="dinner_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Diner Card</h5>
                    <button type="button" class="close close_thumbnail" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true" class="close_modal">
                            ×
                        </span>
                    ...
                    <div class="model-back">
                        <div id="add_multiple_dinner" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                            ...
                            @forelse($dinner as $dinner_value)
                               ...
                               <span id="dinner_data_{{$i}}" class="d-flex align-items-center mt-1"><input type="number" class="dinner_input_value input_card gross_sum margin-unset" value="{{number_format($dinner_value,3, '.','')}}" id="dinner_input_value_{{$i}}" data-id="{{$i}}" maxlength="100" aria-invalid="false"><a href="javascript:;" class="dinner_delete_icon delete_input_icon" id="{{$i}}"><i class="text-danger fa fa-trash-alt choice_remove_btn" style="font-size:16px;cursor:pointer"></i></a></span>
                            
                               @php $i++; @endphp
                             @empty
                               <span id="dinner_data_0" class="d-flex align-items-center mt-1"><input type="number" step="0.01" class="dinner_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="dinner_input_value_0" data-id="0"><a href="javascript:;" class="dinner_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt choice_remove_btn" style="font-size:16px;cursor:pointer"></i></a></span>
                             @endforelse
                    ...
                    <div class="model-back">
                        <div id="add_multiple_mm_online_link" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                            ...
                            @forelse($mm_online_link as $mm_online_link_value)
                               ...
                               <span id="mm_online_link_data_{{$i}}" class="d-flex align-items-center mt-1"><input type="number" class="mm_online_link_input_value input_card gross_sum margin-unset" value="{{number_format($mm_online_link_value,3, '.','')}}" id="mm_online_link_input_value_{{$i}}" data-id="{{$i}}" maxlength="100" aria-invalid="false"><a href="javascript:;" class="mm_online_link_delete_icon delete_input_icon" id="{{$i}}"><i class="text-danger fa fa-trash-alt choice_remove_btn" style="font-size:16px;cursor:pointer"></i></a></span>
                           
                               @php $i++; @endphp
                             @empty
                               <span id="mm_online_link_data_0" class="d-flex align-items-center mt-1"><input type="number" step="0.01" class="mm_online_link_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="mm_online_link_input_value_0" data-id="0"><a href="javascript:;" class="mm_online_link_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt choice_remove_btn" style="font-size:16px;cursor:pointer"></i></a></span>
                             @endforelse
                        ...
                        <div class="d-flex align-items-center justify-content-center">
                            <div id="mm_online_link_add_btn" class="left_btn">
                    ...
                    <div class="model-back">
                        <div id="add_multiple_knet" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                            ...
                            @forelse($knet as $knet_value)
                               ...
                               <span id="knet_data_{{$i}}" class="d-flex align-items-center mt-1"><input type="number" class="knet_input_value input_card gross_sum margin-unset" id="knet_input_value_{{$i}}" value="{{number_format($knet_value,3, '.','')}}" data-id="{{$i}}" maxlength="100" aria-invalid="false"><a href="javascript:;" class="knet_delete_icon delete_input_icon" id="{{$i}}"><i class="text-danger fa fa-trash-alt choice_remove_btn" style="font-size:16px;cursor:pointer"></i></a></span>
                            
                               @php $i++; @endphp
                             @empty
                               <span id="knet_data_0" class="d-flex align-items-center mt-1"><input type="number" step="0.01" class="knet_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="knet_input_value_0" data-id="0"><a href="javascript:;" class="knet_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt choice_remove_btn" style="font-size:16px;cursor:pointer"></i></a></span>
                             @endforelse

                        </div>

                        <div class="d-flex align-items-center justify-content-center">
                            <div id="knet_add_btn" class="left_btn">
                    ...
                    <div class="model-back">
                        <div id="add_multiple_other" class="add_multiple_wrapper d-flex align-items-center flex-wrap">
                            ...
                            @forelse($other_cards as $other_cards_value)
                                ...
                                <span id="other_cards_data_{{$i}}" class="d-flex align-items-center mt-1"><input type="number" class="other_input_value input_card gross_sum margin-unset" id="other_input_value_{{$i}}" value="{{number_format($other_cards_value,3, '.','')}}" data-id="{{$i}}" maxlength="100" aria-invalid="false"><a href="javascript:;" class="other_cards_delete_icon delete_input_icon" id="{{$i}}"><i class="text-danger fa fa-trash-alt choice_remove_btn" style="font-size:16px;cursor:pointer"></i></a></span>
                           
                               @php $i++; @endphp
                             @empty
                            <span id="other_cards_data_0" class="d-flex align-items-center mt-1"><input type="number" step="0.01" class="other_input_value input_card gross_sum margin-unset" maxlength="100" aria-invalid="false" id="other_input_value_0" data-id="0"><a href="javascript:;" class="other_cards_delete_icon delete_input_icon" id="0"><i class="text-danger fa fa-trash-alt choice_remove_btn" style="font-size:16px;cursor:pointer"></i></a></span>
                             @endforelse
                        </div>

                        <div class="d-flex align-items-center justify-content-center">
                            <div id="other_add_btn" class="left_btn">
...
<div>
  ...
  <div id="invoice_document_edit_container">
...
<div>
 ...
 <div class="btn-group">
  <button type="submit" class="button btn_bg_color common_btn text-white">Update</button>
   <button type="button" id="add_new_invoice">Cancle</button>
  </div>  
       ...
       <div class="alert d-none" role="alert" id="flash-message-2">        
         </div>
          ...
          <table style="width:100%" id="order-online-users-list" class="table table-bordered table-hover yajra-datatable">
                ...
                <td class="text-uppercase">
                     @if($daily_sales_data->invoice_domain == 'discount')
                        Discount
                    @elseif($daily_sales_data->invoice_domain == 'complimentart')
                        Complimentary
                ...
                <!--  <td>  {{pathinfo($daily_sales_data->doc, PATHINFO_EXTENSION) }}</td> -->
                    <td>@if(pathinfo($daily_sales_data->doc, PATHINFO_EXTENSION) == 'pdf')
                            <a href="{{asset('dsr/'.$daily_sales_data->doc)}}" target="_blank"><i class="fas fa-file-pdf fa-10x text-danger" style="font-size:30px;"></i></a> 
                     @else
                        <a href="{{asset('dsr/'.$daily_sales_data->doc)}}" target="_blank"><img src="{{asset('dsr/'.$daily_sales_data->doc)}}"></a> 
                    @endif </td>    
   ...
   $(document).ready(function() {
     ...
     //cash
      ...
      $(document).on("click", '.add_talabat_credit_card_total', function() {
        ...
        $("input[class *= 'talabat_credit_input_value']").each(function() {
            if ($(this).val() == '') {
                flag = 1;
                toastr.error('Fields Should Not Be Empty');
            }
