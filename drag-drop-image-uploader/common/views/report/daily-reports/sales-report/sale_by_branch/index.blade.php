...
<?php
  ...
  $sales_by_branch_start_date = Session::get('sales_by_branch_start_date');
  $sales_by_branch_end_date = Session::get('sales_by_branch_end_date');
                ...
                <div class="card">
                    <div class="card-main">
                        <div class="card-header alert d-flex justify-content-between align-items-center mx-0 pt-0">
                            <h3>Sales By Branch ( Gross Sale )</h3>
                            ...
                            <div class="table-responsive" id="full">
                                <table style="width:100%" id="order-online-users-list"
                                    ...
                                    <tbody class="filter_date_show" id="orders_list">
                                        ...
                                        @include('report.daily-reports.sales-report.sale_by_branch.partial')
...
@section('js')
    ...
    <script>
        ...
        function filter_apply() {
            ...
            $.ajax({
                url: "{{ route('sales-by-branch.filter') }}",
                method: "POST",
                data: {
