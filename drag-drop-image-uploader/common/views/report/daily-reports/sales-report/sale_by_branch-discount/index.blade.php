...
@section('content')
    ...
    $sales_by_branch_discount_year = Session::get('sales_by_branch_discount_year');
                ...
                <div class="card">
                    <div class="card-main">
                        <div class="card-header alert d-flex justify-content-between align-items-center mx-0 pt-0">
                            <h3>Sales By Branch ( Discount Sale)</h3>
                                        ...
                                        <div class="selected_date w-100">
                                            ...
                                            <div class="button_input_wrap">
                                                <div class="date_range_wrapper wrap-align-input"
                                                    ...
                                                    <input type="hidden" id="sales_by_branch_filter" start_year="{{$sales_by_branch_discount_year ==''?'':date('Y',strtotime($sales_by_branch_discount_year))}}">
                                                ...
                                                <div class="apply_reset_btn">
                                                    ...
                                                    <button class="btn btn-primary reset-button mr-1 d-none"
                                                     ...
                                                     @can('download_sales_by_branch_discount_sale_report')  
                                                    <button
                                                        class="action-button download-cashdeposit btn btn-danger downloaded"
                                                        title="Download Report"
                                                        data-url="{{ route('sales-by-branch-discount-sale.download') }}"><i
...
@section('js')
    ...
    <script>
        ...
        function filter_apply(reset = null) {
            ...
            $.ajax({
                url: "{{ route('sales-by-branch-discount-sale.filter') }}",
                method: "POST",
                data: {
                    year: year,
                    reset: reset
        ...
        function header_total() {
            ...
            $.ajax({
                url: "{{ route('sales-by-branch-discount-sale.header-total') }}",
                method: "POST",
                data: {
                    year: year,
                },
