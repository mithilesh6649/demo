        ...
        <div class="card-main">
          <div class="card-header alert d-flex justify-content-between align-items-center mx-0 pt-0">
            ...
            <div class="d-flex align-items-center justify-content-start"> 
              ...
              <a class="action-button" title="Download Report" href="{{route('sales.report.download')}}"><i class="text-warning fa fa-download "></i></a>
            </div>      
          </div>
                     ...
                     <div class="left_inner">
                       ...
                       <div class="button_input_wrap">
                        <div class="date_range_wrapper wrap-align-input">
                         ...
                         <input type="text" class="input-wrap w-100" name="date_range" placeholder="Date" autocomplete="off"/>
                        </div>
                  ...
                  <tr>
                      <th class="table_th">{{ $report->id }}.</th>
                       <td class="table_td">{{ optional($report->branch)->title_en ?? 'N/A' }}</td>
                        ...
                        <td class="table_td"><a class="action-button" title="View" href="{{ route('report.view', ['id' => $report->id]) }}"><i class="text-info fa fa-eye eye_green"></i></a>
                        </td>  
                  </tr>
                  @empty
                  @endforelse        
