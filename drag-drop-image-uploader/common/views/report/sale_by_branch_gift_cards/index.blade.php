...
@section('content')
    ...
    $gift_card_all_branch_start_date = Session::get('gift_card_all_branch_start_dates');
    $gift_card_all_branch_end_date = Session::get('gift_card_all_branch_end_dates');
                                ...
                                <div class="left_option">
                                    <div class="left_inner">
                                        ...
                                        <div class="button_input_wrap">
                                            ...
                                            <input type="hidden" id="gift_card_all_branch_filter"
                                                start_date="{{ $gift_card_all_branch_start_date == '' ? '' : date('d/m/y', strtotime($gift_card_all_branch_start_date)) }}"
                                                end_date="{{ $gift_card_all_branch_end_date == '' ? '' : date('d/m/y', strtotime($gift_card_all_branch_end_date)) }}">
                                            ...
                                            <div class="apply_reset_btn">
                                                ...
                                                <!--  &nbsp;&nbsp; -->
                                                @can('download_gift_cards_all_branch_report')
                                                    <button class="action-button download-cashdeposit btn btn-danger downloaded"
                                                        title="Download Report"
                                                        data-url="{{ route('gift-card-report-by-branch.download') }}"><i
                            ...
                            <div class="table-responsive" id="full">
                                <table style="width:100%" id="order-online-users-list"
                                    ...
                                    <tbody class="filter_date_show" id="orders_list">
                                        ...
                                        @include('report.sale_by_branch_gift_cards.partial')
...
@section('js')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var check_session_value_parent = $('#gift_card_all_branch_filter');
        ...
        function filter_apply() {
            ...
            $.ajax({
                url: "{{ route('gift-card-report-by-branch.filter') }}",
                method: "POST",
                data: {
