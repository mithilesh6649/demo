            ...
            <tr>
                <th>
                    ...
                    margin-top: 0;text-align: left;">
                        Voucher Number : <span
                            style="color: #F43127;font-size: 13px;">{{ $doc_ref_no != '' ? $doc_ref_no : @$datas[0]['doc_ref_no'] }}</span></p>
                </th>
            </tr>
            <tr>
                <th>
    ...
    margin: 0 auto;">
        ...
        @foreach ($datas as $data)
            <tr>
                ...
                text-align: left;
                border-bottom: 1px dotted #000;"><span style="font-weight:600;">{{ @$data['expense_desc'] }}</span></td>
                <td colspan="2"
                style="padding: 12px;
                text-align: center;
