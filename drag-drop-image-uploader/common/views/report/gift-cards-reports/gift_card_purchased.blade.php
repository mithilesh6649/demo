                       ...
                       @php $i=0; 
                            ...
                            @forelse($cardgift as $cardgift_value) 
                              <span id="printed_gift_card_data_{{$i}}" class="d-flex"><input
                                  ...
                                  <a href="javascript:;" class="printed_gift_card_delete_icon_old delete_input_icon_old"
                                    ...
                                    <i class="text-danger fa fa-trash-alt printed_gift_card_remove_btn_old"
                                        style="font-size:16px;cursor:pointer;margin: 0 10px;"></i>
                                    </a> </span>
                              @php $i++; @endphp
                            @empty
					...
					<span><i class="text-danger fa fa-trash-alt printed_gift_card_remove_btn" style="font-size:16px;cursor:pointer;margin:0 10px;"></i></span>
