...
@section('title', 'Super Admin | Gift Cards Report')
...
<?php
  ...
  $gift_cards_report_start_date = Session::get('gift_cards_report_start_date');
  $gift_cards_report_end_date = Session::get('gift_cards_report_end_date');
  $gift_cards_report_branch_id = Session::get('gift_cards_report_branch_id');
                                                    ...
                                                    <div class="d-block text-left">
                                                        ...
                                                        <select
                                                            ...
                                                            @forelse ($all_active_branches as $branch)
                                                                <option {{ $gift_cards_report_branch_id==$branch->id ? 'selected':''}}  value="{{ $branch->id }}">{{ $branch->title_en }}
                                                                </option>
                                                            @empty
                            ...
                            @endif
                                ...
                                <div class="table-responsive" id="full">
                                    <table id="order-online-users-list"
                                        ...
                                        <thead>
                                            <tr>
                                                <th style="white-space:nowrap" class="first align-top sorting_disabled">Card
                                                    Number</th>
                                                ...
                                                <th style="white-space:nowrap" class="first align-top sorting_disabled">
                                                    Guest Name</th>
                                                <th style="white-space:nowrap" class="first align-top sorting_disabled">
                                                    Guest Mobile number</th>
                                                <th style="white-space:nowrap" class="first align-top sorting_disabled">Pos
                                                    Inovice Number</th>
                                                <th style="white-space:nowrap" class="first align-top sorting_disabled">Pos
                                                    Inovice Amount</th>
                                                ...
                                                @if (Gate::check('view_gift_card_report') || Gate::check('edit_gift_card_report') || Gate::check('delete_gift_card_report'))
                                                    <th style="white-space:nowrap" class="first align-top sorting_disabled">
                                                        Actions</th>
                                                @endif
                                            </tr>
                                        ...
                                        <tbody class=" " id="orders_list">
                                            @include('report.gift-cards-reports.gift-cards-partial')
                                        </tbody>
                                    </table>
                                </div>
    ...
    <script>
        $(document).on('click', '.download-report', function() {
            ...
            if (date[0] != null && date[0] != '') {
                var url = "{{ url('reports/gift-card-report/gift-card-report-download') }}";
                url = url + '/' + branch_id + '/' + btoa(date);
                window.location = url;
            } else {
                toastr.options = {
