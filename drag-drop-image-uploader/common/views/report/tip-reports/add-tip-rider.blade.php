...
@section('title', 'Branch | Add Branch Tip Report')
                            ...
                            <div class="order_details">
                                <div class="card-main pt-3">
                                    <div class="order_heading alert d-flex align-items-center justify-content-between mb-4">
                                        <h3 class="mb-0">Add Tip Rider</h3>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane toptab active" id="dailyTabs-1" role="tabpanel">
                                                ...
                                                <form name="tip_report" id="tip_report" method="POST"
                                                    enctype="multipart/form-data" action="{{ route('tip-rider.save') }}">
                                                    @csrf
                                                    ...
                                                    <div class="card-body main_body form p-3">
                                                        ...
                                                        <div class="row mt-3">
                                                            ...
                                                            <div class="card-footer submit_btn"
                                                                ...
                                                                <button
                                                                    class="button btn_bg_color common_btn text-white mt-3">Submit</button>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </form>
