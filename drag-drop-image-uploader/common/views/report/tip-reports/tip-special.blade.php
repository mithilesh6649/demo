...
@section('content')
  ...
  $special_tip_distribution_start_date = Session::get('special_tip_distribution_start_date');
  $special_tip_distribution_end_date = Session::get('special_tip_distribution_end_date');
  $special_tip_distribution_branch_id = Session::get('special_tip_distribution_branch_id');
                                    ...
                                    <div class="collections_tabs d-flex align-items-center">
                                        <div class="left">
                                            <a class="btn btn-sm btn_clr btn-success added_content"
                                                href="{{ route('branch-tip') }}"> Tip Collections</a>
                                        </div>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane toptab active" id="dailyTabs-1" role="tabpanel">
                                                <div
                                                    ...
                                                    <h3>Special Tip Distribution</h3>
                                                    {{-- <a class="btn btn-sm btn_clr btn-success"
                                                        href="{{ route('tip-distribution.add') }}">Add Special Tip
                                                        Distribution</a> --}}
                                                </div>
                                                                            ...
                                                                            <div class="d-block text-left">
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    @forelse ($all_active_branches as $branch)
                                                                                        <option
                                                                                        {{ $special_tip_distribution_branch_id==$branch->id ? 'selected':''}}  value="{{ $branch->id }}">
                                                                                            {{ $branch->title_en }}
                                                                                        </option>
                                                                                    @empty
                                                                                ...
                                                                                <input type="hidden" id="special_tip_distribution_filter" start_date="{{$special_tip_distribution_start_date ==''?'':date('d/m/y',strtotime($special_tip_distribution_start_date))}}" end_date="{{$special_tip_distribution_end_date ==''?'':date('d/m/y',strtotime($special_tip_distribution_end_date))}}">
                                                        ...
                                                        <table id="branch_tip_data"
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th style="white-space:nowrap"
                                                                        class="first align-top sorting_disabled">Staff Name
                                                                    </th>
                                                                    <th style="white-space:nowrap"
                                                            ...
                                                            <tbody id='branch_tip_data_list'>
                                                                @include('report.tip-reports.special')
                                                            </tbody>
                                                        </table>
                                                    </div>
...
@section('js')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            var table = $('#branch_tip_data').DataTable({
                "ordering": false,
                scrollCollapse: true,
                paging: true,
            });
    ...
    <script>
        ...
        function filter_apply() {
            ...
            $.ajax({
                url: "{{ route('tipdistribution.report.filter') }}",
                method: 'post',
                data: {
                    branch_id: branch_id,
                    date: date,
        ...
        $(document).ready(function() {
              ...
              var check_session_value_parent = $('#special_tip_distribution_filter');
        ...
        $(document).on('click', '.delete-button', function(e) {
            ...
            swal({
                ...
                if (willDelete) {
                    $.ajax({
                        type: 'post',
                        url: "{{ route('tipdistribution.report.delete') }}",
                        data: {
                            id: id
                        },
                        dataType: "JSON",
                        ...
                        success: function(response) {
                            ...
                            if (response.success == 1) {
                                ...
                                $('#flash-message').html(
                                    'Tip Special Deleted  Successfully');
