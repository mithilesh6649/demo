...
$tip_rider_report_start_date = Session::get('tip_rider_report_start_date');
$tip_rider_report_end_date = Session::get('tip_rider_report_end_date');
$tip_rider_report_branch_id = Session::get('tip_rider_report_branch_id');
                            ...
                            <div class="card-main">
                                ...
                                <div class="collections_tabs d-flex align-items-center">
                                    ...
                                    <div class="right pl-2">
                                        <a class="btn btn-sm btn_clr btn-success added_content"
                                        href="{{ route('tip-distribution.list') }}">Special Tip
                                    Distribution </a>
                                </div>
                                <div class="right pl-2">
                                    <a class="btn btn-sm btn_clr btn-success added_content"
                                    href="{{ route('tip-distributions.lists') }}">Tip
                                Distribution</a>
                            </div>
                        ...
                        <div class="tabs_header">
                            <div class="tab-content">
                                <div class="tab-pane toptab active" id="dailyTabs-1" role="tabpanel">
                                    ...
                                    <h3>Tip Rider</h3>
                                    {{-- <a class="btn btn-sm btn_clr btn-success"
                                    href="{{ route('tip-rider.add') }}">Add Tip Rider</a> --}}
                                </div>
                                                ...
                                                <div class="date_range_wrapper wrap-align-input">
                                                    <div class="selected_branch mr-2">
                                                        <div class="d-block text-left">
                                                            ...
                                                            <option  {{ $tip_rider_report_branch_id==$branch->id ? 'selected':''}}   value="{{ $branch->id }}">
                                                                {{ $branch->title_en }}
                                                            </option>
                                                            @empty
                                                    ...
                                                    <input type="hidden" id="tip_rider_report_filter" start_date="{{$tip_rider_report_start_date ==''?'':date('d/m/y',strtotime($tip_rider_report_start_date))}}" end_date="{{$tip_rider_report_end_date ==''?'':date('d/m/y',strtotime($tip_rider_report_end_date))}}">
                            ...
                            <div class="table-responsive" id="full">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        class="first align-top sorting_disabled">Year</th>
                                        <th style="white-space:nowrap"
                                        class="first align-top sorting_disabled">Month</th>
                                        <th style="white-space:nowrap" class="first align-top sorting_disabled">Amount</th>
                                    ...
                                    <tbody class=" " id='branch_tip_data_list'>
                                        @include('report.tip-reports.rider-partial')
                                    </tbody>
                                </table>
                            </div>
...
<script>
    ...
    $(document).ready(function() {
       ...
       var check_session_value_parent = $('#tip_rider_report_filter');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success == 1) {
                            ...
                            $('#flash-message').html(
                                'Tip Rider Deleted  Successfully');
