                            ...
                            <div class="order_details">
                                <div class="card-main pt-3">
                                    <div
                                        ...
                                        <h3 class="mb-0">Edit Tip Rider </h3>
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane toptab active" id="dailyTabs-1" role="tabpanel">
                                                ...
                                                <form name="tip_report" id="tip_report" method="POST"
                                                    enctype="multipart/form-data" action="{{ route('tip-rider.update') }}">
                                                    @csrf
                                                            ...
                                                            <div class="col-md-6 col-lg-6 col-xl-6 col-6">
                                                                <div class="form-group mb-0">
                                                                    ...
                                                                    <select class="form-select form-control" name="year">
                                                                        @for ($i = env('YEAR'); $i <= date('Y'); $i++)
                                                                            <option value="{{ $i }}"
                                                                                {{ date('Y', strtotime($branch_tip_report->report_date)) == $i ? 'selected' : '' }}>
                                                                                {{ $i }}</option>
                                                                        @endfor
                                                                    </select>
                                                                ...
                                                                <div class="form-group mb-0">
                                                                    ...
                                                                    <select class="form-select form-control" name="month">
                                                                        ...
                                                                        @foreach ($month_names as $key => $month)
                                                                            <option value="{{ $key }}"
                                                                                {{ date('m', strtotime($branch_tip_report->report_date)) == $key ? 'selected' : '' }}>
                                                                                {{ $month }}</option>
                                                                        @endforeach
                                                            ...
                                                            <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                                                                <div class="form-group mb-0">
                                                                    ...
                                                                    <input type="number" name="amount"
                                                                        ...
                                                                        value="{{ number_format($branch_tip_report->amount, 3, '.', '') }}">
                                                                </div>
                                                            </div>

                                                            <input type="hidden" name="id" id="id"
                                                                value="{{ $branch_tip_report->id }}">
