...
<?php 
  ...
  $tip_distribution_report_start_date = Session::get('tip_distribution_report_start_date');
  $tip_distribution_report_end_date = Session::get('tip_distribution_report_end_date');
  $tip_distribution_report_branch_id = Session::get('tip_distribution_report_branch_id');
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane toptab active" id="dailyTabs-1" role="tabpanel">
                                                <div
                                                    ...
                                                    <h3 class="mb-0">Tip Distribution</h3>
                                                </div>
                                                                ...
                                                                <div class="button_input_wrap">
                                                                    <div class="date_range_wrapper wrap-align-input">
                                                                        <div class="selected_branch mr-2">
                                                                            <div class="d-block text-left">
                                                                                ...
                                                                                <select
                                                                                    ...
                                                                                    @forelse ($all_active_branches as $branch)
                                                                                        <option {{ $tip_distribution_report_branch_id==$branch->id ? 'selected':''}}  value="{{ $branch->id }}">
                                                                                            {{ $branch->title_en }}
                                                                                        </option>
                                                                                    @empty
                                                                           ...
                                                                           <input type="hidden" id="tip_distribution_report_filter" start_date="{{$tip_distribution_report_start_date ==''?'':date('d/m/y',strtotime($tip_distribution_report_start_date))}}" end_date="{{$tip_distribution_report_end_date ==''?'':date('d/m/y',strtotime($tip_distribution_report_end_date))}}">
...
@section('js')
    ...
    <script>
        ...
        function filter_apply() {
            ...
            $.ajax({
                url: "{{ route('distributiontips.report.filter') }}",
                method: 'post',
                data: {
                    branch_id: branch_id,
                    date: date,
        ...
        $(document).ready(function() {
                 ...
                 //Check sessions.........
      var check_session_value_parent = $('#tip_distribution_report_filter');
