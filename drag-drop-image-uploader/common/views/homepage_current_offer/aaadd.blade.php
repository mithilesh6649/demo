               ...
               <form id="addOfferForm" method="post" action="{{route('checkout.offers.save')}}" enctype="multipart/form-data">
                  ...
                  <div class="card-body">
                     ...
                     <div class="row">
                        <!-- show thumbnail -->
                        <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                           <div class="form-group mt-3"> <label for="start_date">Start Date/ Time<span class="text-danger"> *</span></label> <input type="text" name="start_date" class="form-control checkoutoffers_date" id="start_date" maxlength="100"> </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                           <div class="form-group mt-3"> <label for="end_date">End Date/ Time<span class="text-danger"> *</span></label> <input type="text" name="end_date" class="form-control checkoutoffers_date" id="end_date" maxlength="100"> </div>
                        </div>
                     </div>
                        ...
                        <div class="modal-dialog ">
                           ...
                           <div class="modal-content menu">
                              ...
                              <div class="modal-body categories-content">
                               ...
                               <div class="btn-group">
                             <button type="button" class="btn btn-success" id="category_unselect_all">Unselect all  </button>
