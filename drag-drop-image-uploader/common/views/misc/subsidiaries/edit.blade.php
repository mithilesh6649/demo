...
@section('title', 'Super Admin | Edit Subsidiaries')
        ...
        <div class="col-md-12">
            <div class="card">
              <div class="card-main">
                ...
                <div class="card-body table form mb-0"> @if (session('status')) <div class="alert alert-success" role="alert"> {{ session('status') }} </div> @endif <form id="editContentManagementForm" method="post" action="{{ route('update.subsidiaries')}}" enctype="multipart/form-data"> @csrf <div class="card-body"> <input type="hidden" name="subsidiaries_id" class="form-control" value="{{ $Subsidiaries->id}}">
                          <div class="row">
                            <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                              <div class="form-group"> 
                                <label>Title(en) <span class="text-danger"> *</span> </label>
                                <input type="text" name="title_en" class="form-control" id="title_en" maxlength="100" value="{{ $Subsidiaries->title_en}}">
                              </div>
                            </div>
                            <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                              <div class="form-group">
                                <label>Title(ar)<span class="text-danger"> *</span></label>
                                <input type="text" name="title_ar" class="form-control" id="title_ar" maxlength="100" value="{{ $Subsidiaries->title_ar}}">
                              </div>
                            </div>
                            </div> <!-- show thumbnail -->
                            ...
                            <div class="form-group mt-3"> 
                              ...
                              <textarea id="content_en" name="description_en">{{ $Subsidiaries->description_en}}</textarea>
                            </div>
                            <div class="form-group mt-3"> 
                            ...
                            <textarea id="content_ar" name="description_ar">{{ $Subsidiaries->description_ar}}</textarea>
