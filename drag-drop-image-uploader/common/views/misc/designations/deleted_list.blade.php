          ...
          <div class="card-body table p-0 mb-0">
            ...
            <table style="width:100%" id="users-list" class="table table-bordered table-hover yajra-datatable">
              <thead>
                ...
                @if(Gate::check('restore_designations') || Gate::check('permanent_deleted_designations'))
                  <th>Actions</th> 
               @endif
                    ...
                    @if(Gate::check('restore_designations') || Gate::check('permanent_deleted_designations'))
                        ...
                        <td>
                            ...
                            @endcan
                             ...
                             @can('permanent_deleted_designations')
...
swal({
title: "Are you sure?",
text: "Are you sure you want to restore this Designation ?",
type: "warning",
showCancelButton: true,
}, function(willDelete) {
if (willDelete) {
  $.ajax({
    url: "{{ route('restore.designations') }}",
    type: 'post',
    data: {
      id: id
    },
    success: function(response) {
      ...
      if(response.trim() == 'success') {
         ...
         $('#flash-message').html('Designation Restore Successfully');
...
if (willDelete) {
  $.ajax({
    url: "{{ route('permanent.delete.designations') }}",
    type: 'post',
    data: {
      id: id
    }, 
