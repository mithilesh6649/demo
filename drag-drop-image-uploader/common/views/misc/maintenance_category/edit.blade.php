        ...
        <div class="card">
          <div class="card-main">
            ...
            <div class="card-body table p-0 mb-0">
              ...
              <form id="editCityForm" method="post" action="{{ route('update_maintenance_category') }}">
                @csrf
                <div class="card-body">
                  @if ($errors->any())
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="form-group">
                          ...
                          <input type="hidden" name="id" value="{{ $MaintenanceCategory->id }}">
                          <input type="text" name="cat_name" class="form-control" id="city" value="{{ $MaintenanceCategory->cat_name }}" maxlength="100">
