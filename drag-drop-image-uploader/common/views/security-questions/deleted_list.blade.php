...
@section('title', ' Super Admin | Deleted Security questions')
         ...
         <div class="card">
            <div class="card-main">
              <div class="card-header alert d-flex justify-content-between align-items-center mx-0 pt-0">
                 <h3> Deleted Security Questions</h3>
              </div>
...
swal({
title: "Are you sure?",
text: "Are you sure you want to restore this  Security Question ?",
type: "warning",
showCancelButton: true,
}, function(willDelete) {
if (willDelete) {
  $.ajax({
    url: "{{ route('restore_question') }}",
    type: 'post',
    data: {
      id: id
    },
    success: function(response) {
      ...
      if(response.trim() == 'success') {
         ...
         $('#flash-message').html(' Security Question Restore Successfully');
