            ...
            <div class="card">
              <div class="card-main">
                <div class="card-header alert d-flex justify-content-between align-items-center mx-0 pt-0"> 
                  ...
                  <h3>Edit Management Details</h3>
                </div>
                <div class="card-body table form mb-0"> @if (session('status')) <div class="alert alert-success" role="alert"> {{ session('status') }} </div> @endif <form id="editContentManagementForm" method="post" action="{{ route('management.update')}}" enctype="multipart/form-data"> @csrf <div class="card-body"> <input type="hidden" name="id" class="form-control" value="{{ $managementedit->id}}">
                          <div class="row">
                            <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                              <div class="form-group"> 
                                <label>Name(en)</label>
                                <input type="text" name="name_en" class="form-control" id="name" maxlength="100" value="{{ $managementedit->name_en}}">
                              </div>
                            </div>
                            <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                              <div class="form-group"> 
                                <label>Name(ar)</label>
                                <input type="text" name="name_ar" class="form-control" id="name" maxlength="100" value="{{ $managementedit->name_ar}}">
                              </div>
                            </div>
                          </div>
                          <div class="row mt-3">
                            <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                              <div class="form-group">
                                ...
                                <input type="text" name="organization_en" class="form-control" id="Organization" maxlength="100" value="{{$managementedit->organization_en}}">
                              </div>
                            </div>
                            <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                              <div class="form-group">
                                <label>Organization(ar)</label>
                                <input type="text" name="organization_ar" class="form-control" id="Organization" maxlength="100" value="{{$managementedit->organization_ar}}">
                              </div>
                            </div>
                           </div>
                              ...
                              <div class="col-md-12">
                                 <div class="form-group">
                                  ...
                                  <div class="upload-img {{$managementedit->image_name != null ? '':'d-none'}}" style="position:relative;width: 250px;">                              
                                   <a href="javascript:;" class="remove-pro-img delete_pdf delete_cate_image" pdf_name="{{$managementedit->image_name ?? ' '}}" current_id="{{$managementedit->id}}"  style="display:block;position: absolute;right:-10px;top:16px;">
                            ...
                            <div class="form-group mt-3"> 
                              ...
                              <textarea id="content_en" name="content_en">{{ $managementedit->content_en}}</textarea>
                            </div>

                            <div class="form-group mt-3"> 
                              <label>Content(ar)</label>
                              <textarea id="content_an" name="content_ar">{{ $managementedit->content_ar}}</textarea>
                            </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <select class="form-control" name="designation">
                                    @foreach($role as $role_del)
                                      <option value="{{$role_del->id}}" {{$role_del->id==$managementedit->management_role_id?'selected':''}}> {{$role_del->name_en}}</option>
                                    @endforeach
                                  </select>
                                </div>
                             </div>
            ...
            image.onload = function () {
                ...
                if (height == 104 && width == 104) {
                  ...
                  $('#thumbnail_preview').attr('src', e.target.result);
                     ...
                     $('#thumbnail').val('');
                     toastr.error('Please upload an image with 104 x 104   pixels dimension');
                    return false;             
               }
            };
