...
@section('title', 'Super Admin | Edit Coupon Code  ')
         ...
         <div class="card">
          <div class="card-main">
            ...
            <div class="card-body table form mb-0">
               ...
               @endif
                  <form id="addOfferForm" method="post" action="{{route('coupon.code.update')}}" enctype="multipart/form-data">
                  @csrf 
                  <div class="card-body">
                 ...
                 <input type="hidden" name="coupon_id" value="{{$offer->id}}">
                     <div class="row">
                        <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                           <div class="form-group"> <label> Coupon  Name<span class="text-danger"> *</span></label>
                              <input type="text" name="coupon_name" class="form-control" id="coupon_name" maxlength="100"  value="{{ $offer->coupon_name ?? ''}}"> 
                           </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                           <label for="description" style="font-size:14px;color: #343d49;margin-bottom: 5px;">Description<span class="text-danger"> *</span></label> 
                           <div>
                              <input type="text" name="description" class="form-control" id="description" maxlength="500" value="{{ $offer->description ?? ''}}">
                           </div>
                        </div>
                     </div>
                ...
                <div class="form-group mt-3">
                  ...
                  <input type="number" class="form-control" name="minimum_order_amount" maxlength="100" value="{{ $offer->minimum_order_amount ?? '' }}">
                           ...
                           <div class="form-group mt-3"> <label for="title_en">Percentage/Amount <span class="text-danger"> *</span></label> <input type="number" name="discount_amount" class="form-control" id="discount_amount" maxlength="100" value="{{ $offer->discount_amount ?? '' }}"> </div>
                     ...
                     <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 col-6   {{ $offer->discount_type == "2" ? '':'d-none' }}" id="discount_item">
                      <div class="form-group branches mt-3">
                       <label for="password">Select Item<span class="text-danger"> *</span></label>
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                           <div class="form-group mt-3"> <label for="start_date">Start Date/Time<span class="text-danger"> *</span></label> 
                              <input type="text" name="start_date" class="form-control dicount_date" id="start_date" maxlength="100" value="{{date('d/m/Y h:00 A',strtotime($offer->start_date))}}"> 
                           </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                           <div class="form-group mt-3"> <label for="end_date">End Date/Time<span class="text-danger"> *</span></label> <input type="text" name="end_date" class="form-control dicount_date" id="end_date" maxlength="100" value="{{date('d/m/Y h:00 A',strtotime($offer->end_date))}}"> </div>
                        </div>
                     </div>
                        ...
                        <div class="col-md-12 col-lg-12 col-xl-12 col-12">
                            <div class="form-group mt-3">
                              ...
                              <div class="upload-img"  style="position:relative;">
                                ...
                                <img src="{{asset('offers/coupon_code/'.$offer->thumbnail)}}" id="thumbnail_preview">
                              </div>
                            </div>
                        </div>
                    <div class="col-md-12 col-lg-12 col-xl-12 col-12">
                          ...
                          <div class="border mt-3 edit" id="all_selected_categories_container">
                           <div class="show_all_selected_categories accordion" id="selectedaccordionExample">
                                @foreach ($selected_menuItem as $key=>$selectitem)
                                     @php
                                      $flg31=\App\Models\CouponCodeItem::getcatName($key); 
                                     @endphp
                                            ...
                                            <div class="items-container">
                                              @foreach($selectitem as $value)
                                               <!-- <div class="col-md-12">
                                                 ...
                                                 <ul class="mb-0">
                                                   @php  
                                                 $flg2=\App\Models\CouponCodeItem::getMenuItem($value->menu_item_id); 
                     ...
                     <div id="cat-modal" class="modal  fade  " role="dialog">
                      <div class="modal-dialog ">
                         ...
                         <div class="modal-content menu">
                                   ...
                                   <div class="accordion" id="accordionExample">
                                       ...
                                       <div class="all-content d-flex align-items-center w-100">
                                        ...
                                        <div class="main_container">
                                           ...
                                           @php
                                              $flg1=\App\Models\CouponCode::checkedcategory($offer->id,$categorie->id);
                                                 ...
                                                 <div class="card-body ">
                                                    <div class="items-container menu_item_container_for_out_of">
                                                       @forelse ($categorie->menuItems as $items)
                                                         @php
                                                         $flg2=\App\Models\CouponCode::checkedmenuitem($offer->id,$items->id);
                                                     @endphp
                                                       <div class="col-md-12">
                           ...
                           <button type="button" class="btn btn-success d-none" id="category_unselect_all" >Close</button>
                           <button type="button" class="btn btn-danger" id="category_save_countinue" style="width:fit-content;">Save and Continue</button>
           ...
           <!-- Modal -->
            ...
            <div class="custom-check">
               @php 
                 $flg22=\App\Models\CouponCode::checkallbranch($offer->id);
            ...
            @forelse ($branches as $branch)
              @php 
                $flag21=\App\Models\CouponCode::checksinglebranch($branch->id,$offer->id);
              @endphp
           ...
           <div class="card-footer pt-0 pb-4 " align="center"> 
                             ...
                             <button type="button" class="btn btn-success d-none"  data-dismiss="modal">Close</button>
