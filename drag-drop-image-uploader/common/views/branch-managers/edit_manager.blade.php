...
@section('title',  ' Super Admin | Edit Branch Manager')
      ...
      <div class="card">
        <div class="card-main">
          ...
          <div class="card-body table p-0 mb-0">
            ...
            @endif
            <form id="editUserForm" method="post" action="{{ route('update_manager')}}" enctype="multipart/form-data">
              @csrf
                ...
                <div class="row">
                  <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-12">
                    <div class="profile-image-show mt-3">
                      <a href="javascript:;" class="remove-pro-img {{ $user->image!=null && file_exists(public_path('branch_managers_profile/'.$user->image)) ? '':'d-none' }}" id="{{ $user->id ?? '' }}" style="display:block">
                      ...
                      <div class="thumb_nails {{ $user->image!=null && file_exists(public_path('branch_managers_profile/'.$user->image)) ? 'd-none':'' }}">
                        ...
                        <input type="file"  accept="image/*" name="image" id="profile_picture" class="{{ $user->image!=null && file_exists(public_path('branch_managers_profile/'.$user->image)) ? 'd-none':'' }}">  
                    </div>
                  </div>
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="first_name" class="form-control" placeholder=" " id="first_name" value="{{$user->first_name ?? ' ' }}" maxlength="100">  
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="last_name" class="form-control" placeholder=" " id="last_name" value="{{$user->last_name ?? ' ' }}" maxlength="100">
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-12">               
                    <div class="form-group mt-3">
                     <label for="branch_role_id">{{ __('adminlte::adminlte.role') }}<span class="text-danger"> *</span></label>
                      <select name="branch_role_id" class="form-control" placeholder=" " id="branch_role_id">
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                    <div class="form-group mt-3">
                     <label for="email">{{ __('adminlte::adminlte.email') }} </label>
                      <input type="text" name="email" class="form-control" placeholder=" " id="email" value="{{$user->email ?? '' }}"   maxlength="100">
                      @if($errors->has('email'))
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                    <div class="form-group mt-3">
                     <label for="password">Contact Number </label>
                      <input type="tel"  name="phone_number" class="form-control" placeholder=" " id="txtPhone" autocomplete="false" value="{{ $user->phone_number ?? '' }}">
                    </div>
                  </div>
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                    <div class="form-group mt-3">
                      ...
                      <select class="form-control" placeholder="Block" name="is_user_locked">
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-12 ">
                    <div class="form-group mt-3">
                      ...
                      <div style="position:relative;"> 
                       <input id="password_confirmation" type="password" name="password_confirmation" class="form-control" placeholder=" " id="password_confirmation" value="">
                        <div style="position:absolute;top:18px;right:15px;">
        ...
        $(".remove-pro-img").removeClass("d-none");
            ...
            $(".remove-pro-img").click(function(evt){
                    ...
                    if (typeof attr !== 'undefined' && attr !== false) {
                       $.ajax({
                             url:"{{ route('manager.delete.profileImage') }}",
                             method:"POST",
                             data:{
                                'manager_id':attr,
                                "_token": "{{csrf_token()}}"
