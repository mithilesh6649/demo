...
@section('title', 'Super Admin | Deleted Branch Managers')
          ...
          <div class="card-body table p-0 mb-0">
            ...
            <table style="width:100%" id="users-list" class="table table-bordered table-hover yajra-datatable">
              <thead>
                ...
                @if(Gate::check('restore_branch_manager') || Gate::check('permanent_deleted_branch_manager'))
                  <th>Actions</th> 
               @endif
                     ...
                     @if(Gate::check('restore_branch_manager') || Gate::check('permanent_deleted_branch_manager'))
                        ...
                        <td>
                            ...
                            @endcan
                             ...
                             @can('permanent_deleted_branch_manager')
...
swal({
title: "Are you sure?",
text: "Are you sure you want to restore this Branch Manager ?",
type: "warning",
showCancelButton: true,
}, function(willDelete) {
if (willDelete) {
  $.ajax({
    url: "{{ route('restore_manager') }}",
    type: 'post',
    data: {
      id: id
    },
    success: function(response) {
      ...
      if(response.trim() == 'success') {
         ...
         $('#flash-message').html(' Branch Manager Restore Successfully');
...
if (willDelete) {
  $.ajax({
    url: "{{ route('permanent_delete_manager') }}",
    type: 'post',
    data: {
      id: id
    }, 
