...
@section('title', ' Super Admin | Add Branch  Manager')
        ...
        <div class="card">
          <div class="card-main">
            ...
            <div class="card-body table p-0 mb-0">
              ...
              @endif
              <form id="addbranchManager" method="post" action="{{ url('branch-managers/save')}}" enctype="multipart/form-data">
                @csrf
                <div class="card-body">
                  <div class="row"> 
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-12 col-12">
                      <div class="profile-image-show mt-3">
                        ...
                        <input type="file"  accept="image/*" name="image" id="profile_picture" class="">  
                      </div>
                    </div>

                    <!-- add image coding end -->
                    <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                      <div class="form-group">
                      <label for="first_name">First Name<span class="text-danger"> *</span></label>
                         
                        <input type="text" name="first_name" class="form-control" placeholder=" " id="first_name" value="" maxlength="100">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                      <div class="form-group">
                        ...
                        <input type="text" name="last_name" class="form-control" placeholder=" " id="last_name" value="" maxlength="100">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                      <div class="form-group mt-3">
                        ...
                        <select name="branch_role_id" class="form-control"   id="role_id">
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                      <div class="form-group mt-3">
                        ...
                        <input type="text" name="email" class="form-control" placeholder=" " id="email" value="" maxlength="100">
                        @if($errors->has('email'))
                    ...
                    <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                      <div class="form-group mt-3">
                       <label for="password">Contact Number </label>
                        <input type="tel"  name="phone_number" class="form-control" placeholder=" " id="contact_number" />
                      </div>
                    </div>
         ...
         //  required: true,
          ...
          phone_number: {
           ...
           // phone_valid:true,
             remote:{
                    type:"get",
                     url:"{{route('check_user_phone_number')}}",
                    data: {
                          "number": function() { return $("#contact_number").val(); },
                          "_token": "{{ csrf_token() }}",
