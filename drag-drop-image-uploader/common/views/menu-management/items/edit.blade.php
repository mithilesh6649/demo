                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="tab_wrapper">
                            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link nav_link {{ Request::segment(3) == 'edit' && Request::segment(2) == 'items' ? 'active' : '' }}"
                                        id="pills-home-tab"
                                        href="{{ route('menu.item.edit', ['id' => $menuItem->id]) }}"
                                        aria-controls="pills-home" aria-selected="true">Item</a>
                                </li>
                                <li class="nav-item"> <a
                                        class="nav-link nav_link {{ Request::segment(3) == 'choice' && Request::segment(2) == 'items' ? 'active' : '' }}"
                                        id="pills-transactions-tab" aria-controls="pills-transactions"
                                        href="{{ route('menu.item.edit.choice.group', ['id' => $menuItem->id]) }}"
                                        aria-selected="false">Choice Groups </a> </li>
                                <li class="nav-item d-none"> <a
                                        class="nav-link nav_link {{ Request::segment(2) == 'current_offers' ? 'active' : '' }}"
                                        id="pills-transactions-tab" aria-controls="pills-transactions"
                                        href="{{ route('current_offers.edit', $menuItem->id) }}"
                                        aria-selected="false">Current Offers</a> </li>
                                <!--   <li class="nav-item">
                           ...
                           <a class="nav-link nav_link {{ Request::segment(2) == 'permission' && Request::segment(1) == 'branch' ? 'active' : '' }}" id="pills-persmissions-tab" href="{{ route('branch.permission') }}" aria-controls="pills-permissions" aria-selected="false"><i class="fas fa-time mr-2"></i>Persmission</a>
                            ...
                            <div class="tab-content" id="pills-tabContent">
                                <div class="tab-pane fade  {{ Request::segment(3) == 'edit' && Request::segment(2) == 'items' ? 'show active' : '' }}"
                                    id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    <!-- item tab content -->
                                    <form id="editMenuItemForm" method="post" action="{{ route('menu.item.update') }}"
                                                ...
                                                <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" name="item_name_en" class="form-control"
                                                            id="item_name_en" maxlength="100"
                                                            style="background-color:white;border:1px solid #ced4da;"
                                                            value="{{ $menuItem->item_name_en }}">
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <input type="text" name="item_name_ar" class="form-control"
                                                            id="item_name_ar" maxlength="100"
                                                            style="background-color:white;border:1px solid #ced4da;"
                                                            value="{{ $menuItem->item_name_ar }}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                    ...
                                                    <div class="form-group branch-city mb-3">
                                                        ...
                                                        <select class="form-control catselect" name="cat_id"
                                                            ...
                                                            @forelse ($menuCategories as $category)
                                                                @if ($category->category_type == 'loyality')
                                                                    <option value="loyalty"
                                                                        {{ $category->id == $menuItem->cat_id ? 'selected' : ' ' }}>
                                                ...
                                                <div class="first_content d-flex align-items-center">
                                                    <div class="custom-check">
                                                        <input type="checkbox" id="regular_checkbox"
                                                            ...
                                                            @if ($menuItem->price >= 0 && !is_null($menuItem->price)) checked data-id="1" @else data-id="0" @endif>
                                                        <span></span>
                                                    </div>
                                                    ...
                                                    <div class="second_content">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number"
                                                                ...
                                                                id="price" maxlength="100"
                                                                style="@if ($menuItem->price >= 0 && !is_null($menuItem->price)) @else display:none; @endif"
                                                                value="{{ $price }}">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="first_content d-flex align-items-center">
                                                    <div class="custom-check">
                                                        <input type="checkbox" id="loyality_checkbox"
                                                            ...
                                                            @if (@$menuItem->loyalty_item->loyalty_points && @$menuItem->loyalty_item->loyalty_points >= 0) checked data-id="1" @else data-id="0" @endif>
                                                        <span></span>
                                                    </div>
                                                    ...
                                                    <div class="second_content">
                                                        <div class="form-group">
                                                            <input type="number"
                                                                ...
                                                                id="loyality_item_points" name="loyality_item_points"
                                                                ...
                                                                data-id="{{ @$menuItem->loyalty_item->id }}">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="third_content switch_container"
                                                        ...
                                                        <div class="form-group">
                                                            <select class="form-control" name="loyalty_status"
                                                                ...
                                                                @foreach ($status as $status_data)
                                                                    <option value="{{ $status_data->value }}"
                                                                        {{ @$menuItem->loyalty_item->status == $status_data->value ? 'selected' : '' }}>
                                                                        {{ $status_data->name }}</option>
                                                                @endforeach
                                                            </select>
                                                        </div>
                                        ...
                                        <div class="col-md-12 col-lg-12 col-xl-12 col-12">
                                            ...
                                            <div class="upload-img  {{ $menuItem->thumbnail != null ? '' : 'd-none' }}"
                                                style="position:relative;width:250px;">
                                                <a href="javascript:;"
                                                    class="remove-pro-imgdelete_pdf delete_cate_image  {{ $menuItem->thumbnail == null ? '' : 'd-none' }}"
                                                    pdf_name="{{ $menuItem->thumbnail ?? '  ' }}"
                                                    current_id="{{ $menuItem->id }}"
                                                ...
                                                @if ($menuItem->thumbnail != '')
                                                    <img src="{{ asset('menuItem/thumbnail/' . $menuItem->thumbnail) }}"
                                                        class="thumbnail_preview" id="thumbnail_preview"
                                                        style="width: 250px;"
                                                        class="{{ $menuItem->thumbnail != null ? '' : 'd-none' }} ">
                                                @else
                                                    <img src="" class="thumbnail_preview"
                                                        id="thumbnail_preview" style="width: 250px;" alt="image">
                                                @endif
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12 col-lg-12 col-xl-12 col-12 mt-3">
                                                <div class="form-group rating tagline">
                                                    <label>Tagline <span class="text-danger">*</span></label>
                                                    <input type="text" id="rating"
                                                        value="{{ $menuItem->tagline ?? '' }}" class="form-control"
                                                        name="tagline">
                            ...
                            <div class="tab-pane fade {{ Request::segment(2) == 'current_offers' ? 'show active' : '' }}"
                                id="pills-transactions" role="tabpanel" aria-labelledby="pills-transactions-tab">
                                <div class="card-body table items">
                                    ...
                                    @endif
                                    <form method="post" action="{{ route('current_offers.updates') }}"
                                        id="editformcurrentoffer" enctype="multipart/form-data">
                                        @csrf
                                        <div class="card-body form">
                                            <div class="row">
                                                <input type="hidden" name="menuitem_id"
                                                    value="{{ Request::segment(4) }}">
                                                <input type="hidden" name="current_offers_id"
                                                    value="@if (count($current_offers) > 0) {{ $current_offers[0]->id }} @endif">
                                                <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                                                    <div class="form-group">
                                                        <label for="current_offer_amount">Offer Name<span
                                                                class="text-danger">*</span> </label>
                                                ...
                                                <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                                                    <div class="form-group">
                                                        <label for="current_offer_amount"> Description <span
                                                                class="text-danger">*</span></label>
                                                        <input type="text" name="current_offer_description"
                                                            id="current_offer_description" class="form-control subs"
                                                            @if (count($current_offers) > 0) value="{{ $current_offers[0]->offer_description }}" @endif>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                                                    <div class="form-group mt-3">
                                                        <label for="offers_type ">Offer Type <span
                                                                class="text-danger">*</span></label>
                                                        <select class="form-select" id="offers_type"
                                                            name="offers_type">
                                                ...
                                                <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                                                    <div class="form-group mt-3">
                                                        <label for="current_offer_amount">Percentage/Amount <span
                                                                class="text-danger">*</span></label>
                                                        <input type="number" maxlength="9"
                                                            name="current_offer_amount" id="current_offer_amount"
                                                            class="form-control subs"
                                                            @if (count($current_offers) > 0) value="{{ $current_offers[0]->amount }}" @endif>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                                                    <div class="form-group mt-3">
                                                        <label for="current_offer_startdate">Start Date/ Time <span
                                                                class="text-danger">*</span> </label>
                                                        <input type="text"
                                                            value="@if (count($current_offers) > 0) {{ date('d/m/Y h:00 A', strtotime($current_offers[0]->start_date)) }} @endif"
                                                            name="current_offer_startdate"
                                                            id="current_offer_startdate"
                                                ...
                                                <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                                                    <div class="form-group mt-3">
                                                        <label for="current_offer_enddate">End Date/ Time <span
                                                                class="text-danger">*</span></label>
                                                        <input type="text"
                                                            value="@if (count($current_offers) > 0) {{ date('d/m/Y h:00 A', strtotime($current_offers[0]->end_date)) }} @endif"
                                                            name="current_offer_enddate" autocomplete="off"
                                                            id="current_offer_enddate"
                                                            class="form-control current__offerdatepicker">
                                                    </div>
                                                </div>
                                                <div class="col-md-12 col-lg-12 col-xl-12 col-12">
                                                    <div class="form-group mt-3">
                                                        <label>Image</label>
                                                        <input type="file" name="c_offerimage"
                                                            class="thumbnail_pic input-border-auto"
                                                            onchange="readURLL(this);" accept=".png, .jpg, .jpeg"
                                                            class="form-control">
                                                        @if ($errors->has('thumbnail'))
                                                        ...
                                                        <div class="upload-img mb-3 pt-0"
                                                            style="position:relative;width:250px;">
                                                            ...
                                                            @if (count($current_offers) > 0)
                                                                <img src="{{ asset('CMS/banner/' . $current_offers[0]->image) }}"
                                                                    id="current_thumbnail_preview" alt="Image"
                                                                    style="width:250px;display:block;border-radius: 10px;">
                                                            @else
...
@endif
                                             ...
                                             <button type="button" class="btn btn-warning w-100" id="branch-modal"> Branch</button>
                                                    ...
                                                    <div class=" btn-group mt-2 mb-0" style="width: 49.333%;">
...
@endif
                                            ...
                                            <div class="card-footer" style="padding-top: 25px;">
                                                <button type="submit"
                                                    class="button btn_bg_color common_btn text-white w-auto">Update</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                    ...
                    <form id="addChoiceGroupForm" enctype="multipart/form-data" class="model-back p-0">
                        ...
                        <div class="card-body form">
                            <div class="row">
                                <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name_en" class="form-control "
                                            id="choice_name_en" maxlength="100"
                                            style="background-color:white;border:1px solid #ced4da;"> <small
                                ...
                                <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name_ar" class="form-control"
                                            id="choice_name_ar" maxlength="100"
                                            style="background-color:white;border:1px solid #ced4da;"> <small
                                ...
                                <div class="choices_parent w-100" id="choices">
                                    <div class="col-md-12 col-lg-12 col-xl-12 col-12">
                                            ...
                                            <div class="col-md-4  col-lg-4  col-xl-4 col-12">
                                                <div class="mainEnglisChoiceContainer">
                                                    ...
                                                    <div class="border-lg englishChoiceSuggestionBox d-none"
                                                        style="overflow-x:auto;height:180px;width:100%;position:absolute;z-index:1;background-color:#ffcdca;cursor:pointer;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name_en" class="form-control" id="edit_name_en"
                                            maxlength="100" style="background-color:white;border:1px solid #ced4da;">
                                        @if ($errors->has('name_en'))
                                            <div class="error">{{ $errors->first('name_en') }}</div>
                                        @endif
                                    </div>
                                ...
                                <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                                    <div class="form-group mt-3">
                                        ...
                                        <select class="form-control" name="total_choice_count"
                                            id="ttotal_choice_countd">
                                        </select>
                                        <input type="hidden" name="" class="form-control"
                                            id="edit_total_choice_count" value="1">
                                        @if ($errors->has('total_choice_count '))
                                            <div class="error">{{ $errors->first('total_choice_count ') }}</div>
                                        @endif
                                    </div>
                                    ...
                                    <div class="col-md-12 col-lg-12 col-xl-12 col-12">
                                        <div class="row choices_child mt-3">
                                                ...
                                                <div class="mainEnglisChoiceContainer">
                                                    <div class="form-group mt-3">
                                                        <label for="choice_name_en">Choice Name(en)<span
                                                                class="text-danger"> *</span></label>
                                                        <input type="text" name="choice_name_en[]"
                                                            class="form-control englishChoiceInput" maxlength="100">
                                                    </div>
                                                    <div class="border-lg englishChoiceSuggestionBox  "
                                                        style="overflow-x:auto;height:180px;width:100%;position:absolute;z-index: 1000;background-color:#ffcdca;cursor: pointer;">
                                            ...
                                            <div class="col-md-2 col-lg-2 col-xl-2 col-2">
                                                <div class="form-group mt-3">
                                                    <label for="choice_price">Price<span class="text-danger">
                                                            *</span></label>
                                                    <input type="number" name="choice_price[]" class="form-control"
                                                        value="" maxlength="100">
                                                </div>
                                            ...
                                            <div class="col-md-1 col-lg-1 col-xl-1 col-1 delete">
                                                <i
                                                    class="text-success"style="font-size:14px; margin-top:20px;">Default</i>
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    $(document).ready(function() {
        ...
        $(document).on('change', '.imagefile', function() {
            ...
            $(this).next().children('img').onload = function() {
                URL.revokeObjectURL($(this).next().children('img').attr('src', URL.createObjectURL(
                    event.target.files[0]))) // free memory
            }
        });
...
<script>
    $(document).ready(function() {
        ...
        $('.add_new_choice').click(function() {
           ...
           <input type="text" name="choice_name_en[]" class="form-control dynamic_name_en englishChoiceInput"  autocomplete="off"    maxlength="100">
           </div>
           ...
           <input type="text" name="choice_name_ar[]" class="form-control dynamic_name_ar arabicChoiceInput"     maxlength="100" autocomplete="off">
           </div>
           ...
           <div class="col-md-1 col-lg-1 col-xl-1 col-1 delete">
           <i class="text-danger fa fa-trash-alt choice_remove_btn" style="font-size:14px;margin-top:20px;cursor:pointer;"></i>
           </div>
           </div></div>
           `;
            $('.choices_parent').append(html);

            //remove choices after dynamically created......
    ...
    $('#addChoiceGroupForm').submit(function(e) {
        ...
        $('.addimage').each(function() {
            if ($(this).val().trim() == '') {
                // $(this).addClass('border border-danger');
                $(this).next().remove();
                $("<span class='text-danger compare'>Choice Image is required </span>").insertAfter(
                    this);
            }
        });
        $('.dynamic_name_ar').each(function() {
    ...
    $(document).on('click', '.edit-button', function(e) {
        ...
        $.ajax({
           ...
           <div class="row choices_child mt-2 pl-1">
                  ...
                  <i class="text-success" style="font-size:14px;margin-top:20px;cursor:pointer;">Default</i>
                   ...
                   <div class="row choices_child mt-2 pl-1">
                       ...
                       <div class="form-group">
                       <label for="choice_price">Price(KD) </label>
                       <input type="number" name="choice_price[]" class="form-control"   step="any" value="` + data
                            .price +
                            `">
                       </div>
                       </div>
                       ...
                       <i class="text-danger fa fa-trash-alt choice_remove_btnpre" style="font-size:14px;margin-top:20px;cursor:pointer;" data-id="` +
                            data.id + `"></i>
                       </div>
                       </div></div>`;
                        var option = `<option value="` + index_selected + `" ` + selected +
        ...
        $('.englishChoiceInput').each(function() {
            ...
            $(this).on('input', function() {
                ...
                var CurrentInputArabic = mainEnglisArabicChoiceContainer.getElementsByTagName(
                    'INPUT')[1];
                var psd_2 = mainEnglisArabicChoiceContainer.getElementsByTagName('INPUT')[2];
                console.log(CurrentInputArabic);
