...
@section('title', 'Super Admin | Edit Sub Category')
          ...
          <div class="card-body">
            ...
            <form id="editUserForm" method="post", action="">
              ...
              <div class="card-body form">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="name" class="form-control" id="name" value="Menu Sub Category" maxlength="100">
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                    <div class="form-group">
                      ...
                      <select class="form-control" name="category">
                        ...
                        <option value="1" selected>Menu Category</option>
                      </select>
                  ...
                  <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                    <div class="form-group">
                      ...
                      <input type="file" name="thumbnail" id="thumbnail" class="form-control" onchange="readURL(this);">
                ...
                <!-- show thumbnail -->
                <div class="row">
                  <img src="{{asset('background_images/back7.jpg')}}" id="thumbnail_preview" style="width:300;height:130px;">
                </div>
                <!-- show thumbnail -->
