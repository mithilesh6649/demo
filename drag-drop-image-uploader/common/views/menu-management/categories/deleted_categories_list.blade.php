...
@section('title', 'Super Admin | Deleted Categories')
                            ...
                            <table style="width:100%" id="users-list"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        @if (Gate::check('restore_menu_categories') || Gate::check('permanent_deleted_menu_categories'))
                                            <th>Actions</th>
                                        @endif
                                ...
                                <tbody>
                                    @foreach ($CategoryList as $key => $data)
                                        <tr>
                                            <td> {{ $data->name_en ?? 'N/A' }}</td>
                                            <td>{{ $data->name_ar ?? 'N/A' }}</td>


                                            @if (Gate::check('restore_menu_categories') || Gate::check('permanent_deleted_menu_categories'))
                                                <td>

                                                    @can('restore_menu_categories')
                                                    ...
                                                    @can('permanent_deleted_menu_categories')
