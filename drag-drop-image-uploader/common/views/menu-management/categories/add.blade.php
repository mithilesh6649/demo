...
@section('title', 'Super Admin |  Add  Category')
...
<div class="row justify-content-center">
    <div class="col-md-12">
        <div class="card">
          <div class="card-main"> 
            ...
            <div class="card-body p-0">
                ...
                @endif
                <form id="addCategoryForm" method="post" action="{{ route('categories.save') }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="name_en" class="form-control" id="name_en" value="" maxlength="100">
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                                <div class="form-group mb-3">
                                     <label for="name_ar">Name{{ labelArabic() }}<span class="text-danger"> *</span></label>
                                    <input type="text" name="name_ar" class="form-control" id="name_ar" value="" maxlength="100">
                                </div>
                            </div>
                          </div>
      ...
      <img src="" id="profileImage" class="default-image"  style="width:300px;">    
          <div class="row">
                    <div class="col-md-12 col-lg-12 col-xl-12 col-12">
                     <div class="upload-img  d-none" style="position:relative;width:250px;">
                       ...
                       <img src="" id="thumbnail_preview" style="display:none;">
                     </div>
                    </div>
 -->
     ...
     <!--copper image upload -->
                            ...
                            <div class="col-md-12 col-lg-12 col-xl-12 col-12">
                              <div class="form-group ">
                                  <label>Image (500x300)</label>
                                  <input type="file" name="thumbnail" class="thumbnail_pic" onchange="readURL(this);" id="thumbnail" accept=".png, .jpg, .jpeg"  class="form-control">
                              ...
                              <div class="upload-img d-none " style="position:relative;width:250px;">
                                ...
                                <img src="" id="thumbnail_preview" style="width:250px;display:none;">
                               </div>
                              </div>
                            </div>
