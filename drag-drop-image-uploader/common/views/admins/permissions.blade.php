...
@section('title', 'Super Admin | Admin Permissions')
            ...
            <form id="addRoleForm" method="post", action="">
               ...
               <div class="card-body">
                     ...
                     <div class="row">
                        <div class="col-sm-12">
                           <div class="form-group">
                              <label for="role_name">Admins</label>
                  ...
                  <div class="role-permissions" id="role-permissions">
                     ...
                     <div class="permissions-section">
                        ...
                        <div class="row ">
                           ...
                           <div class="col-4">
                              <div class="form-group">
                                 <div class="permissions-section-inner-sec">
                                    <p class="headings"><strong class="list-text">Total Branches</strong></p>
                                    <div class="custom_check_wrap">
                                       <div class="custom-check">
                                          <input type="checkbox" id="pending_customer_permissions" class="ckbCheckAll"> 
                                          <span></span>                             
                           ...
                           <div class="col-4">
                              <div class="form-group">
                                 <div class="permissions-section-inner-sec">
                                    <p class="headings"><strong class="list-text">Total Earnings</strong></p>
                                    <div class="custom_check_wrap">
                                       <div class="custom-check">
                                          <input type="checkbox" id="pending_customer_permissions" class="ckbCheckAll"> 
                                          <span></span>                             
                     ...
                     <!-- admin management -->
                     <div class="title">
                        <h5>Admin | Sub-Admin Management</h5>
                        <hr/>
                     </div>
                     <div class="permissions-section">
                        <div class="row ">
                           ...
                           <div class="col-4">
                              <div class="form-group">
                                 <div class="permissions-section-inner-sec">
                                    <p class="headings"><strong class="list-text">Admin | Sub-Admin</strong></p>
                                    <div class="custom_check_wrap">
                                       <div class="custom-check">
                                          <input type="checkbox" id="pending_customer_permissions" class="ckbCheckAll"> 
                                          <span></span>                             
                     ...
                     <div class="permissions-section">
                        <div class="row ">
                           ...
                           <div class="col-4">
                              <div class="form-group">
                                 <div class="permissions-section-inner-sec">
                                    <p class="headings"><strong class="list-text">Branch</strong></p>
                                    <div class="custom_check_wrap">
                                       <div class="custom-check">
                                          <input type="checkbox" id="pending_customer_permissions" class="ckbCheckAll"> 
                                          <span></span>                             
                     ...
                     <div class="permissions-section">
                        <div class="row ">
                           ...
                           <div class="col-4">
                              <div class="form-group">
                                 <div class="permissions-section-inner-sec">
                                    <p class="headings"><strong class="list-text">New Staff Inquiries</strong></p>
                                    <div class="custom_check_wrap">
                                       <div class="custom-check">
                                          <input type="checkbox" id="pending_customer_permissions" class="ckbCheckAll"> 
                                          <span></span>                             
                           ...
                           <div class="col-4">
                              <div class="form-group">
                                 <div class="permissions-section-inner-sec">
                                    <p class="headings"><strong class="list-text">Catering Service Inquiries</strong></p>
                                    <div class="custom_check_wrap">
                                       <div class="custom-check">
                                          <input type="checkbox" id="pending_customer_permissions" class="ckbCheckAll"> 
                                          <span></span>                             
                           ...
                           <div class="col-4">
                              <div class="form-group">
                                 <div class="permissions-section-inner-sec">
                                    <p class="headings"><strong class="list-text">Advertisement Inquiries</strong></p>
                                    <div class="custom_check_wrap">
                                       <div class="custom-check">
                                          <input type="checkbox" id="pending_customer_permissions" class="ckbCheckAll"> 
                                          <span></span>                             
                     ...
                     <div class="title">
                        <h5>Loyalty Points Management</h5>
                        <hr/>
                     </div>
                     <div class="permissions-section">
                        <div class="row ">
                           ...
                           <div class="col-4">
                              <div class="form-group">
                                 <div class="permissions-section-inner-sec">
                                    <p class="headings"><strong class="list-text">Criteria</strong></p>
                                    <div class="custom_check_wrap">
                                       <div class="custom-check">
                                          <input type="checkbox" id="pending_customer_permissions" class="ckbCheckAll"> 
                                          <span></span>                             
                           ...
                           <!-- default templates and offer -->
                           <div class="col-4">
                              <div class="form-group">
                                 <div class="permissions-section-inner-sec">
                                    <p class="headings"><strong class="list-text">Default Templates for Offer</strong></p>
                                    <div class="custom_check_wrap">
                                       <div class="custom-check">
                                          <input type="checkbox" id="pending_customer_permissions" class="ckbCheckAll"> 
                                          <span></span>                             
                           ...
                           <div class="col-4">
                              <div class="form-group">
                                 <div class="permissions-section-inner-sec">
                                    <p class="headings"><strong class="list-text">Offer</strong></p>
                                    <div class="custom_check_wrap">
                                       <div class="custom-check">
                                          <input type="checkbox" id="pending_customer_permissions" class="ckbCheckAll"> 
                                          <span></span>                             
                                    ...
                                    <div id="checkBoxes">
                                       <div class="custom_check_wrap">
                                          ...
                                          <label class="mb-0">Activate/Deactive</label>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                     ...
                     <div class="permissions-section">
                        <div class="row ">
                           ...
                           <div class="col-4">
                              <div class="form-group">
                                 <div class="permissions-section-inner-sec">
                                    <p class="headings"><strong class="list-text">Referrals</strong></p>
                                    <div class="custom_check_wrap">
                                       <div class="custom-check">
                                          <input type="checkbox" id="pending_customer_permissions" class="ckbCheckAll"> 
                                          <span></span>                             
                     ...
                     <!-- advertisement and game management -->
                     <div class="title">
                        <h5>Advertisement & Game Management</h5>
                        <hr/>
                     </div>
                     <div class="permissions-section">
                        <div class="row ">
                           ...
                           <div class="col-4">
                              <div class="form-group">
                                 <div class="permissions-section-inner-sec">
                                    <p class="headings"><strong class="list-text">Advertisement & Game</strong></p>
                                    <div class="custom_check_wrap">
                                       <div class="custom-check">
                                          <input type="checkbox" id="pending_customer_permissions" class="ckbCheckAll"> 
                                          <span></span>                             
                     ...
                     <div class="permissions-section">
                        <div class="row ">
                           ...
                           <div class="col-4">
                              <div class="form-group">
                                 <div class="permissions-section-inner-sec">
                                    <p class="headings"><strong class="list-text">Branch wise Payouts</strong></p>
                                    <div class="custom_check_wrap">
                                       <div class="custom-check">
                                          <input type="checkbox" id="pending_customer_permissions" class="ckbCheckAll"> 
                                          <span></span>                             
                     ...
                     <div class="permissions-section">
                        <div class="row ">
                           ...
                           <div class="col-4">
                              <div class="form-group">
                                 <div class="permissions-section-inner-sec">
                                    <p class="headings"><strong class="list-text">Total Clicks</strong></p>
                                    <div class="custom_check_wrap">
                                       <div class="custom-check">
                                          <input type="checkbox" id="pending_customer_permissions" class="ckbCheckAll"> 
                                          <span></span>                             
                     ...
                     <div class="permissions-section">
                        <div class="row ">
                           ...
                           <div class="col-4">
                              <div class="form-group">
                                 <div class="permissions-section-inner-sec">
                                    <p class="headings"><strong class="list-text">Total Income of each Branch</strong></p>
                                    <div class="custom_check_wrap">
                                       <div class="custom-check">
                                          <input type="checkbox" id="pending_customer_permissions" class="ckbCheckAll"> 
                                          <span></span>                             
                           ...
                           <!-- menu items of each branch -->
                           <div class="col-4">
                              <div class="form-group">
                                 <div class="permissions-section-inner-sec">
                                    <p class="headings"><strong class="list-text">Menu Items of each Branch</strong></p>
                                    <div class="custom_check_wrap">
                                       <div class="custom-check">
                                          <input type="checkbox" id="pending_customer_permissions" class="ckbCheckAll"> 
                                          <span></span>                             
                           ...
                           <!-- Least and highest earning branch -->
                           <div class="col-4">
                              <div class="form-group">
                                 <div class="permissions-section-inner-sec">
                                    <p class="headings"><strong class="list-text">Least Earning Branch</strong></p>
                                    <div class="custom_check_wrap">
                                       <div class="custom-check">
                                          <input type="checkbox" id="pending_customer_permissions" class="ckbCheckAll"> 
                                          <span></span>                             
                           ...
                           <div class="col-4">
                              <div class="form-group">
                                 <div class="permissions-section-inner-sec">
                                    <p class="headings"><strong class="list-text">Highest Earning Branch</strong></p>
                                    <div class="custom_check_wrap">
                                       <div class="custom-check">
                                          <input type="checkbox" id="pending_customer_permissions" class="ckbCheckAll"> 
                                          <span></span>                             
                     ...
                     <div class="title">
                        <h5>Content Pages Management</h5>
                        <hr/>
                     </div>
                     <div class="permissions-section">
                        <div class="row">
                           ...
                           <div class="col-4">
                              <div class="form-group">
                                 <div class="permissions-section-inner-sec">
                                    <p class="headings"><strong class="list-text">Our Vision</strong></p>
                                    <div class="custom_check_wrap">
                                       <div class="custom-check">
                                          <input type="checkbox" id="pending_customer_permissions" class="ckbCheckAll"> 
                                          <span></span>                             
                           ...
                           <div class="col-4">
                              <div class="form-group">
                                 <div class="permissions-section-inner-sec">
                                    <p class="headings"><strong class="list-text">Live Kitchen</strong></p>
                                    <div class="custom_check_wrap">
                                       <div class="custom-check">
                                          <input type="checkbox" id="pending_customer_permissions" class="ckbCheckAll"> 
                                          <span></span>                             
