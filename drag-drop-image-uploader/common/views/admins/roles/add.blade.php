      ...
      <div class="card">
        <div class="card-main">
          ...
          <div class="card-body table p-0 mb-0">
            ...
            @endif
            <form id="addRoleForm" method="post", action="{{ route('admins.role.save') }}">
              @csrf
              <div class="card-body">
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      <label>Name</label>
                      <input type="text" name="role_name" class="form-control" placeholder="{{ __('adminlte::adminlte.name') }}" id="role_name" maxlength="100">
                    </div>
                  </div>
                </div>
              </div>
