      ...
      <div class="card">
        <div class="card-main">
          ...
          <div class="card-body table p-0 mb-0">
            ...
            @endif
            <form id="addRoleForm" method="post", action="{{ route('admins.role.update') }}">
              @csrf
              <div class="card-body">
                <div class="row">
                  <div class="col-sm-12">
                    <div class="form-group">
                      ...
                      <input type="text" name="name" class="form-control" placeholder="{{ __('adminlte::adminlte.name') }}" id="name" value="{{ $role->name }}" maxlength="100">
                      @if($errors->has('name'))
