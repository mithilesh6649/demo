...
@section('title', ' Super Admin | Deleted Customers')
          ...
          <div class="card-body table p-0 mb-0">
            ...
            <table style="width:100%" id="users-list" class="table table-bordered table-hover yajra-datatable">
              <thead>
                ...
                @if(Gate::check('restore_customer') || Gate::check('permanent_deleted_customer'))
                  <th>Actions</th> 
               @endif
                     ...
                     @if(Gate::check('restore_customer') || Gate::check('permanent_deleted_customer'))
                        ...
                        <td>
                            ...
                            @endcan
                             ...
                             @can('permanent_deleted_customer')
  ...
  $.ajax({
    ...
    success: function(response) {
      ...
      if(response.trim() == 'success') {
         ...
         $('#flash-message').html('Customer Restore Successfully');
