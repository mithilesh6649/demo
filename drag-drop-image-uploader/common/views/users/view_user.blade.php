...
@section('title', 'Super Admin | Customer Details')
                            ...
                            <div class="row">
                                  ...
                                  <div class="col-6">
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <input type="tel"  name="phone_number" class="form-control"  id="txtPhone" value="{{ $user->phone_number ?? '' }}" / readonly>
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-6 col-12  mb-3">
                                <div class="form-group">
                                    <label for="email">{{ __('adminlte::adminlte.email') }} </label>
                                     <input type="text" name="email" class="form-control" id="email" value="{{$user->email ?? ' ' }}" readonly maxlength="100" readonly>
                                    @if($errors->has('email'))
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-6 col-12  mb-3">
                                ...
                                <div class="form-group">
                                    <label for="first_name">First Name </label>
                                     <input type="text" name="first_name" class="form-control" id="first_name" value="{{$user->first_name ?? ' ' }}" maxlength="100" readonly>
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-6 col-12  mb-3">
                                <div class="form-group">
                                    <label for="last_name">Last Name  </label>
                                     <input type="text" name="last_name" class="form-control" id="last_name" value="{{$user->last_name ?? ' ' }}" maxlength="100" readonly>
                    ...
                    <input class="form-control" placeholder="{{ date('d/m/Y H:i A',strtotime($user->updated_at))}}" readonly>
                     ...
                     <div class="col-md-6 col-lg-6 col-xl-6 col-6">
                      <div class="form-group  ">
                        ...
                        <select class="form-control" name="is_user_locked" disabled>
