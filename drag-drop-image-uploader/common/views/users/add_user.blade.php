        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body table p-0 mb-0">
                    ...
                    @endif
                    <form id="editUserForm" method="post" action="{{ route('save_user') }}">
                        @csrf
                            ...
                            <div class="row">
                               ...
                               <!--  <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3" >
                                    <div class="form-group  ">
                                        <label for="password">{{ __('adminlte::adminlte.contact_number') }}<span class="text-danger"> *</span></label>
                                        <br>
                                        <input style="width:100%"   type="number"  name="phones_number" class="form-control">
                                    </div>
                                </div> 
 -->
                                  <div class="col-6">
...
<!-- 
                            ...
                            <div class="col-md-6 col-lg-6 col-xl-6 col-12  mb-3">
                                <div class="form-group">
                                    ...
                                    <input id="password_confirmation" type="password" name="password_confirmation" class="form-control" id="password_confirmation"  >
        ...
        <!-- /.card-body -->
                <div class="card-footer">
                  <button type="submit" class="button btn_bg_color common_btn text-white">{{ __('adminlte::adminlte.save') }}</button>
                </div>
    </form>
</div>
</div>
...
password_confirmation: {
  ...
  $(function () {
      var code = "+974 "; // Assigning value from model.
      $('#txtPhone').val(code);
