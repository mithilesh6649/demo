            ...
            <div class="tab_wrapper">
              <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                  <form id="addbanner" method="post" class="dropzone" enctype="multipart/form-data" name="demoform" style="border:none;">
                      @csrf
                            ...
                            <div class="form-group">
                              <label>Page Name</label>
                               ...
                               <!-- 	 <option value="">Page Name</option> -->
                                    ...
                                    <option {{ $page_name->value == $banner[0]->page_name ? 'selected':''  }}>{{$page_name->name}}</option>
                                @empty
                                ...
                                @endforelse
                                 ...
                                 <!-- <option @if($banner[0]->page_name=='home_page') selected @endif>Home Page</option>
                               	 ...
                               	 <option @if($banner[0]->page_name=='loyality_point') selected @endif >Loyality</option>
                  ...
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body" class="image_preview">
                        <div class="w3-content w3-display-container" style='height:400px;width:100%;'>
...
.dropzone .dz-preview.dz-image-preview:hover .dz-filename {
    width: 250px;
    margin: 0 auto;
    white-space: inherit;
}
...
.dropzone .dz-preview.dz-image-preview .btn-danger, 
.dropzone .dz-preview.dz-image-preview:hover .btn-danger {
    height: 26px;
    width: 80%;
    margin: 0px auto;
    line-height: 15px;
...
.dz-preview.dz-complete.dz-image-preview select.select-status {
    margin: 0px 0 10px;
    width: 100% !important;
    text-align: center;
          ...
          if(key=='banner')
            {
              ...
              html+="<img class='mySlides' src='"+src+"/"+val+"' style='width:100%;height:100%;' />";
