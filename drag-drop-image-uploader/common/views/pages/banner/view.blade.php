            ...
            <div class="tab_wrapper">  
              <div class="tab-content" id="pills-tabContent">
                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                  <form id="addbanner" method="post" autocomplete="off" enctype="multipart/form-data" name="demoform" style="border:none;">
                      @csrf
                          ...
                          <div class="col-md-6 col-lg-6 col-xl-6 col-12">
                            <div class="form-group">
                              <label>Image Type</label>
                               <select disabled name="image_type" id="image_type" class="form-control">
                            ...
                            <div class="form-group mt-3">
                              ...
                              <div class="dropzone-previews">
                               @foreach($banner as $image)
                                 <div>
                                    <div class="list-img">
                                  		<img src="{{asset('CMS/banner/'.$image->banner)}}" alt="banner image" class="img" style="width: 250px;height: 130px;">
                                    </div>
                                	@if($image->status == 1)
                	                   <span class="badge badge-pill badge-success p-0 mt-2">Active</span>
                	                  @else
                	                   <span class="badge badge-pill badge-danger p-0 mt-2">Deactive</span>
                	                  @endif
                                 </div>
                               @endforeach
                              </div>
          ...
          if(key=='banner')
            {
              ...
              html+="<img class='mySlides' src='"+src+"/"+val+"' style='width:100%;height:400px;' />";
