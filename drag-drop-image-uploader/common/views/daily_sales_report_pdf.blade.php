...
<div class="rightside_content" >
         ...
         <div class="col-md-12" >
            <div class="card order_outer rounded_circle">
               ...
               <img src="https://server3.rvtechnologies.in/MMMission22/Branch/public/images/report_logo.png" alt="" style="width:100%;">
                           ...
                           <center>
                           <h4 class="mb-0">Daily Sales Reports Details</h4>
                           </center>
                        </div>
                        <div class="Branch-statement branch_wrapper mt-1">
                           <form id="addReportForm" method="post"
                              ...
                              <table class="table border Responsive-table m-0">
                                 ...
                                 <tbody class="t_body" >
                                    <tr >
                                       <th style="padding:1px 1px;" colspan="3" class="text-center body_head">BRANCH-STATEMENT OF
                                          DALIY
                                          SALES &
                                          CASH IN
                                          HAND
 ...
 <tr style="pointer-events: none;">
                               ...
                               <div  style="width: 100%;border: 1px solid white;display: flex;align-items: center;justify-content:center;margin-top: 5px;">
                                  @if(@$daily_report_sales['verified_by']==null || @$daily_report_sales['verified_by']=="") 
                               
                                  <div style="width:45%; border: 1px solid white;float: left;">
                                 ...
                                 <div class="form-group mb-0">
                                    <label>Verified by</label>
                                    <div class="wrapper">
                                       <img width="100%" src="{{@$daily_report_sales['verified_by']}}" class="signature_image" alt="">
                                    </div>
                                 </div>
                                 ...
                                 <div class="form-group mb-0">
                                    <label>Approved by</label>
                                    <div class="wrapper">
                                       <img width="100%" src="{{@$daily_report_sales['approved_by']}}" class="signature_image" alt="">
                                    </div>
                                 </div>
