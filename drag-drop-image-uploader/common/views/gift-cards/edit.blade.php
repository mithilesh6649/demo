      ...
      <div class="card">
         <div class="card-main">
            ...
            <div class="card-body p-0">
               ...
               @endif
               <form id="addGiftCard" method="post" action="{{ route('gift.card.update') }}" enctype="multipart/form-data">
                  @csrf
                  <input type="hidden" name="git_card_id" value="{{ $GiftCard->id}}">
                  <div class="card-body table form mb-0">
                     <div class="row">
                        <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-3">
                           <div class="form-group">
                              <label for="title">Title<span class="text-danger"> *</span></label>
                              <input type="text" name="title" class="form-control" id="tilte"   maxlength="100" value="{{$GiftCard->title ?? ''}}">
                           </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-2">
                           <div class="form-group">
                              <label for="description">Description<span class="text-danger"> *</span></label>
                              <textarea name="description" style="height:60px;" maxlength="500" >{{$GiftCard->description??''}}</textarea>
                           </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-2">
                           <div class="form-group ">
                              ...
                              <select class="form-control" name="card_type" id="card_type">
                                 ...
                                 <option value="{{$card_type->value}}" {{ $card_type->value == $GiftCard->card_type ? 'selected':'' }}>{{$card_type->name}} KD</option>
                                 @endforeach
                              </select>
                           </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-2">
                           <div class="form-group">
                              ...
                              <input type="text" name="price" class="form-control" id="price" min="0" value="{{$GiftCard->price?? ''}}">
                           </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-2">
                           <div class="form-group  "> <label for="start_date">Start Date/ Time<span class="text-danger"> *</span></label> <input type="text" name="start_date" class="form-control checkoutoffers_date" id="start_date" maxlength="100" value="{{date('d/m/Y h:00 A',strtotime($GiftCard->start_date))}}"> </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-2">
                           <div class="form-group  "> <label for="end_date">End Date/ Time<span class="text-danger"> *</span></label> <input type="text" name="end_date" class="form-control checkoutoffers_date" id="end_date" maxlength="100" value="{{date('d/m/Y h:00 A',strtotime($GiftCard->start_date))}}"> </div>
                        </div>
                        <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-2">
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6 col-12 mb-2">
                           <div class="form-group ">
                              ...
                              <select class="form-control" name="status" id="status">
                                 ...
                                 <option value="{{$status_data->value}}" {{ $status_data->value == $GiftCard->value ? 'selected':'' }} >{{$status_data->name}}</option>
                                 @endforeach
                              </select>
                           </div>
                        </div>
                        <!-- start show thumbnail coding -->
                        <!-- show thumbnail -->
                        <div class="row m-1"  style="position:relative;">
                           <a href="javascript:;" class="remove-pro-img d-none "  style="display:block;position: absolute;right:-10px;top:-9px;">
                           ...
                           <img src="{{asset('offers/gift_card/'.$GiftCard->thumbnail)}}" id="thumbnail_preview" style="width:300;height:130px; ">
                        </div>
                        <!-- end show thumbnail coding -->
                     </div>
