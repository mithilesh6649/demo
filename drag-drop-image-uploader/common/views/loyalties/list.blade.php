              ...
              <thead> 
               ...
               <tbody>
                ...
                @foreach($loyalties as $loyalty)
                  ...
                  <td>
                      <a class="action-button" title="View" href="{{route('loyalty.view',['id' => $loyalty->id])}}"><i class="text-info fa fa-eye"></i></a>
                    
                      <a class="action-button" title="Edit" href="{{route('loyalty.edit',['id' => $loyalty->id])}}"><i class="text-warning fa fa-edit"></i></a>
